...
export const HorizontalMedium = builderDivider(
  'm',
  'Horizontal Divider Medium',
);
export const HorizontalLarge = builderDivider('l', 'Horizontal Divider Large');

export const VerticalSmall = builderDivider(
  's',
  'Vertical Divider Small',
  'vertical',
);
export const VerticalMedium = builderDivider(
  'm',
  'Vertical Divider Medium',
  'vertical',
);
export const VerticalLarge = builderDivider(
  'l',

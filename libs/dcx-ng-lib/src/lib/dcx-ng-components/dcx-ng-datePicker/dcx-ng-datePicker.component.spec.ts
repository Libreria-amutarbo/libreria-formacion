...
describe('DcxNgDatePickerComponent', () => {
    ...
    describe('clear button', () => {
        ...
        it('should render clear button in DOM when visible', () => {
            componentRef.setInput('selectedDate', new Date(2025, 0, 15));
            fixture.detectChanges();
            const clearEl = fixture.nativeElement.querySelector('.dcx-datepicker__clear');
    ...
    describe('calendar days', () => {
        ...
        it('should mark today correctly', () => {
            ...
            const todayDay = component.calendarDays().find(d => d.date.getTime() === today.getTime());
        ...
        it('should mark selected date correctly', () => {
            ...
            fixture.detectChanges();
            const day = component.calendarDays().find(d => d.date.getTime() === sel.getTime());
        ...
        it('should disable dates before minDate', () => {
            ...
            fixture.detectChanges();
            const day = component.calendarDays().find(d => d.date.getTime() === test.getTime());
        ...
        it('should flag isCurrentMonth correctly', () => {
            ...
            const jan15 = days.find(d => d.date.getDate() === 15 && d.date.getMonth() === 0);
    ...
    describe('navigation', () => {
        it('should navigate to previous month', () => {
            ...
            fixture.detectChanges();
            expect(component.currentMonth().getMonth()).toBe(initial === 0 ? 11 : initial - 1);
        });
        ...
        it('should navigate to next month', () => {
            ...
            component.nextMonth();
            fixture.detectChanges();
            expect(component.currentMonth().getMonth()).toBe(initial === 11 ? 0 : initial + 1);
        });
    ...
    describe('range selection', () => {
        ...
        it('should mark range start/end as selected in calendarDays', () => {
            ...
            fixture.detectChanges();
            const days = component.calendarDays();
            expect(days.find(d => d.date.getTime() === start.getTime())?.isSelected).toBe(true);
            expect(days.find(d => d.date.getTime() === end.getTime())?.isSelected).toBe(true);
        });
        ...
        it('should mark in-range dates between start and end', () => {
            ...
            componentRef.setInput('endDate', end);
            fixture.detectChanges();
            const midDay = component.calendarDays().find(d => d.date.getTime() === mid.getTime());
        ...
        it('should NOT mark dates outside range as isInRange', () => {
            ...
            componentRef.setInput('endDate', end);
            fixture.detectChanges();
            const outsideDay = component.calendarDays().find(d => d.date.getTime() === outside.getTime());
    ...
    describe('multi selection', () => {
        ...
        it('should remove existing date (toggle off)', () => {
            ...
            fixture.detectChanges();
            const spy = jest.spyOn(component.selectedDatesChange, 'emit');
            component.selectDate(makeDay({ date: new Date(existing), isSelected: true }));
            expect(spy).toHaveBeenCalled();
        ...
        it('should format multiple dates with dash separator', () => {
            componentRef.setInput('selectedDates', [new Date(2025, 0, 10), new Date(2025, 0, 15)]);
            fixture.detectChanges();
        ...
        it('should mark multi-selected dates in calendarDays', () => {
            ...
            fixture.detectChanges();
            const day = component.calendarDays().find(dd => dd.date.getTime() === d.getTime());
            expect(day?.isSelected).toBe(true);
        });
        ...
        it('should NOT set isInRange for multi-select', () => {
            ...
            const mid = new Date(2025, 0, 12);
            mid.setHours(0, 0, 0, 0);
            const midDay = component.calendarDays().find(dd => dd.date.getTime() === mid.getTime());
    ...
    describe('document click', () => {
        ...
        it('should close calendar on mousedown outside when open', () => {
            ...
            fixture.detectChanges();
            expect(component.isOpen()).toBe(true);
            // Create and append an outside element to click

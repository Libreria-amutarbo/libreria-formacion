import{a as e,l as t,n,t as r}from"./lit-LoFRC6vp.js";import{C as i,S as a,_ as o,a as s,b as c,g as ee,n as te,r as l,t as ne,v as u,x as d,y as re}from"./defaults-DnuI9sVo.js";var ie=[`vertical`,`horizontal`],f=[`start`,`center`,`end`],ae=[`s`,`m`,`l`,`xl`,`auto`],oe=`vertical`,se=`center`,ce=[`xs`,`s`,`m`,`l`,`xl`],p=`info-circle`,m={showLabel:!0,textLabel:`Value`,value:0,step:1,vertical:!1,min:0,max:50,disabled:!1,valueSuffix:``},le=`Select`,h=[{value:`one`,label:`Uno`},{value:`two`,label:`Dos`},{value:`three`,label:`Tres`}],g=`Seleccione una opción`,ue=t`
  :host {
    display: inline-flex;
  }

import{a as e}from"./lit-C11zoK0j.js";import{s as t,u as n}from"./src-C8W-Yn-o.js";import{d as r,f as i}from"./defaults-DBXV-fV-.js";import"./dcx-web-picklist.component-B2R037-M.js";var a={title:`DCXLibrary/WebComponents/Input`,component:`dcx-web-input`,tags:[`autodocs`],parameters:{controls:{expanded:!0}},argTypes:{id:{control:`text`,description:`Id único del input. Label, hint y error derivan de este identificador.`,table:{category:`Atributos`}},value:{control:`text`,description:`Valor del input.`,table:{category:`Atributos`}},label:{control:`text`,description:`Texto visible asociado al input.`,table:{category:`Atributos`}},hint:{control:`text`,description:`Texto de ayuda asociado mediante aria-describedby.`,table:{category:`Atributos`}},placeholder:{control:`text`,description:`Placeholder del input.`,table:{category:`Atributos`}},type:{control:`select`,options:r,description:`Tipo de input.`,table:{category:`Atributos`}},spacing:{control:`select`,options:n,description:`Padding interno.`,table:{category:`Atributos`}},disabled:{control:`boolean`,table:{category:`Atributos`}},readonly:{control:`boolean`,table:{category:`Atributos`}},required:{control:`boolean`,table:{category:`Atributos`}},isInvalid:{control:`boolean`,table:{category:`Atributos`}},errorMessage:{control:`text`,table:{category:`Atributos`}},requiredMessage:{control:`text`,table:{category:`Atributos`}},orientation:{control:`select`,options:[t[0],t[1]],table:{category:`Atributos`}},valueChange:{action:`valueChange`,description:`Emitido cuando cambia el valor del input.`,table:{category:`Eventos`}},focusEvent:{action:`focusEvent`,description:`Emitido cuando el input recibe foco.`,table:{category:`Eventos`}},blurEvent:{action:`blurEvent`,description:`Emitido cuando el input pierde foco.`,table:{category:`Eventos`}},enterPressed:{action:`enterPressed`,description:`Emitido al pulsar Enter.`,table:{category:`Eventos`}}},args:{value:``,label:`Nombre completo`,hint:``,placeholder:`Ej: Jean Dupont`,type:i.TEXT,spacing:`m`,disabled:!1,readonly:!1,required:!1,isInvalid:!1,errorMessage:``,requiredMessage:`Este campo es requerido`,orientation:`horizontal`},render:t=>e`
    <dcx-web-input
      .value=${t.value}
      label=${t.label}
      hint=${t.hint}

import{a as e,l as t,n,t as r}from"./lit-C11zoK0j.js";import{C as i,S as a,_ as o,a as s,b as c,g as ee,n as te,r as l,t as ne,v as u,x as d,y as f}from"./defaults-DEzK3jDE.js";var p=[`vertical`,`horizontal`],re=[`start`,`center`,`end`],ie=[`s`,`m`,`l`,`xl`,`auto`],ae=[`top`,`bottom`,`left`,`right`],oe=`vertical`,se=`center`,ce=[`xs`,`s`,`m`,`l`,`xl`],m=`info-circle`,h={showLabel:!0,textLabel:`Value`,value:0,step:1,vertical:!1,min:0,max:50,disabled:!1,valueSuffix:``},le=`Select`,ue=[{value:`one`,label:`Uno`},{value:`two`,label:`Dos`},{value:`three`,label:`Tres`}],g=`Seleccione una opción`,de=`160px`,_=[`bold`,`italic`,`underline`,`orderedList`,`unorderedList`,`removeFormat`],fe=t`
  :host {
    display: inline-flex;
  }
...
`,Oe=t=>{let r=`dcx-chip dcx-chip--${t.color}`,i=t.label?`Remover ${t.label}`:`Remover chip`;return e`
    <span
      class=${r}
  ...
  `},R=class extends r{#e=``;get label(){return this.#e}set label(e){this.#e=e}#t=`primary`;get color(){return this.#t}set color(e){this.#t=e}#n=!1;get removable(){return this.#n}set removable(e){this.#n=e}#r=``;get icon(){return this.#r}set icon(e){this.#r=e}#i=``;get image(){return this.#i}set image(e){this.#i=e}#a=`choice`;get variant(){return this.#a}set variant(e){this.#a=e}static styles=De;get chipType(){return this.image.trim()?`with-image`:this.icon.trim()?`with-icon`:`label-only`}get showRemove(){return this.variant===`filter`||this.removable}renderIcon(){let t=[`house`,`person`,`gear`,`star`,`code-slash`,`terminal`,`palette`,`book`,`bug`].includes(this.icon)?this.icon:`question-circle`;return e`<dcx-web-icon name=${t}></dcx-web-icon>`}handleRemove(e){e.stopPropagation(),this.showRemove&&this.dispatchEvent(new CustomEvent(`dcx-chip-remove`,{bubbles:!0,composed:!0}))}render(){return Oe(this)}};o([a({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`label`,null),o([a({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`color`,null),o([a({type:Boolean,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`removable`,null),o([a({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`icon`,null),o([a({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`image`,null),o([a({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`variant`,null),R=o([i(`dcx-web-chip`)],R);var ke=t`
  :host {
    display: block;
    width: 100%;
    box-sizing: border-box;
...
`,Me=t=>{let r={"dcx-datepicker__input-wrapper":!0,"dcx-datepicker__input-wrapper--disabled":t.disabled,"dcx-datepicker__input-wrapper--open":t.isOpen};return e`
...
`,q=class extends r{#e=``;get body(){return this.#e}set body(e){this.#e=e}#t=`notification`;get type(){return this.#t}set type(e){this.#t=e}#n=``;get title(){return this.#n}set title(e){this.#n=e}#r=``;get link(){return this.#r}set link(e){this.#r=e}#i=!1;get icon(){return this.#i}set icon(e){this.#i=e}#a=``;get iconName(){return this.#a}set iconName(e){this.#a=e}#o=!1;get showClose(){return this.#o}set showClose(e){this.#o=e}#s=!0;get announce(){return this.#s}set announce(e){this.#s=e}#c=!1;get dismissed(){return this.#c}set dismissed(e){this.#c=e}static styles=Ye;get messageData(){return{notification:{icon:`info-circle`,role:`status`,ariaLive:`polite`},success:{icon:`check-circle`,role:`status`,ariaLive:`polite`},warning:{icon:`exclamation-triangle`,role:`alert`,ariaLive:`assertive`},error:{icon:`x-circle`,role:`alert`,ariaLive:`assertive`}}[this.type]}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}onClose=()=>{this.dismissed=!0,this.emit(`closed`)};render(){return Je(this)}};o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],q.prototype,`body`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],q.prototype,`type`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],q.prototype,`title`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],q.prototype,`link`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],q.prototype,`icon`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],q.prototype,`iconName`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],q.prototype,`showClose`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],q.prototype,`announce`,null),o([d(),u(`design:type`,Object),u(`design:paramtypes`,[])],q.prototype,`dismissed`,null),q=o([i(`dcx-web-message`)],q);var Xe=t`
  :host {
    display: inline-flex;
  }
...
`,Ze=t=>e`
  ...
  `,J=class extends r{#e=!1;get checked(){return this.#e}set checked(e){this.#e=e}#t=!1;get disabled(){return this.#t}set disabled(e){this.#t=e}#n=null;get label(){return this.#n}set label(e){this.#n=e}#r=`m`;get size(){return this.#r}set size(e){this.#r=e}#i=null;get ariaLabel(){return this.#i}set ariaLabel(e){this.#i=e}#a=`right`;get textPosition(){return this.#a}set textPosition(e){this.#a=e}static styles=Xe;get effectiveAriaLabel(){return this.ariaLabel||this.label||`Toggle`}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}toggle(){if(this.disabled)return;let e=!this.checked;this.checked=e,this.emit(`toggled`,e)}getToggleClasses(){let e=[`dcx-toggle`,this.size?`dcx-toggle--${this.size}`:``,`dcx-toggle--${this.textPosition}`];return this.disabled&&e.push(`dcx-toggle--disabled`),e.filter(Boolean).join(` `)}render(){return Ze(this)}};o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],J.prototype,`checked`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],J.prototype,`disabled`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],J.prototype,`label`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],J.prototype,`size`,null),o([a({type:String,attribute:`aria-label`}),u(`design:type`,Object),u(`design:paramtypes`,[])],J.prototype,`ariaLabel`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],J.prototype,`textPosition`,null),J=o([i(`dcx-web-toggle`)],J);var Y=t`
  :host {
    display: block;
    width: 100%;
  }
...
`,X=class extends r{#e=`dcx-progressbar-${Math.random().toString(36).substring(2,9)}`;get id(){return this.#e}set id(e){this.#e=e}#t=`default`;get variant(){return this.#t}set variant(e){this.#t=e}#n=0;get value(){return this.#n}set value(e){this.#n=e}#r=``;get label(){return this.#r}set label(e){this.#r=e}#i=``;get ariaLabel(){return this.#i}set ariaLabel(e){this.#i=e}#a=!1;get showTooltip(){return this.#a}set showTooltip(e){this.#a=e}#o=!1;get showLabel(){return this.#o}set showLabel(e){this.#o=e}#s=[];get steps(){return this.#s}set steps(e){this.#s=e}#c=0;get currentStep(){return this.#c}set currentStep(e){this.#c=e}#l=!1;get showCheckmarks(){return this.#l}set showCheckmarks(e){this.#l=e}#u=5;get segments(){return this.#u}set segments(e){this.#u=e}static styles=Y;get labelId(){return`${this.id}-label`}get progressPercentage(){return Math.min(Math.max(this.value,0),100)}get isStepperVariant(){return this.variant===`stepper`}get isSegmentedVariant(){return this.variant===`segmented`}get isDefaultVariant(){return this.variant==="default"}get segmentArray(){return Array(this.segments).fill(0).map((e,t)=>t)}get stepProgress(){let e=this.steps.length;return e===0?0:this.currentStep/e*100}get stepValueText(){return`Paso ${this.currentStep} de ${this.steps.length}`}isStepCompleted(e){return e<this.currentStep-1}isStepActive(e){return e===this.currentStep-1}render(){return Qe(this)}};o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`id`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`variant`,null),o([a({type:Number}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`value`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`label`,null),o([a({type:String,attribute:`aria-label`}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`ariaLabel`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`showTooltip`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`showLabel`,null),o([a({attribute:!1}),u(`design:type`,Array),u(`design:paramtypes`,[])],X.prototype,`steps`,null),o([a({type:Number}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`currentStep`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`showCheckmarks`,null),o([a({type:Number}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`segments`,null),X=o([i(`dcx-web-progressbar`)],X);var $e=t`
  :host {
    display: inline-block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,et=t=>e`
  ...
  `,Z=class extends r{static styles=$e;#e=[];get options(){return this.#e}set options(e){this.#e=e}#t=`dcx-radio-${Math.random().toString(36).substring(2,9)}`;get name(){return this.#t}set name(e){this.#t=e}#n=``;get label(){return this.#n}set label(e){this.#n=e}#r=``;get ariaLabel(){return this.#r}set ariaLabel(e){this.#r=e}#i=`l`;get size(){return this.#i}set size(e){this.#i=e}#a=!1;get disabled(){return this.#a}set disabled(e){this.#a=e}#o=!1;get error(){return this.#o}set error(e){this.#o=e}#s=``;get hint(){return this.#s}set hint(e){this.#s=e}#c=``;get errorMessage(){return this.#c}set errorMessage(e){this.#c=e}#l=null;get value(){return this.#l}set value(e){this.#l=e}groupId=`dcx-radio-group-${Math.random().toString(36).substring(2,9)}`;get hintId(){return`${this.groupId}-hint`}get errorId(){return`${this.groupId}-error`}get isGroupDisabled(){return this.disabled}get showError(){return this.error&&!!this.errorMessage}get showHint(){return!!this.hint&&!this.showError}get describedBy(){return this.showError?this.errorId:this.showHint?this.hintId:null}isChecked(e){return this.value===e}isOptionDisabled(e){return this.isGroupDisabled||!!e.disabled}radioClasses(e){let t=`dcx-radio`;return[t,`${t}--${this.size}`,this.error?`${t}--error`:``,this.isOptionDisabled(e)?`${t}--disabled`:``,this.isChecked(e.value)?`${t}--checked`:``].filter(Boolean).join(` `)}onOptionChange(e){this.isOptionDisabled(e)||(this.value=e.value,this.dispatchEvent(new CustomEvent(`valueChange`,{detail:e.value,bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`change`,{bubbles:!0,composed:!0})))}onBlur(){this.dispatchEvent(new CustomEvent(`blurEvent`,{bubbles:!0,composed:!0}))}render(){return et(this)}};o([a({type:Array}),u(`design:type`,Array),u(`design:paramtypes`,[])],Z.prototype,`options`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`name`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`label`,null),o([a({type:String,attribute:`aria-label`}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`ariaLabel`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`size`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`disabled`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`error`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`hint`,null),o([a({type:String,attribute:`error-message`}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`errorMessage`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`value`,null),Z=o([i(`dcx-web-radio`)],Z);var tt=t=>e`
  <ul
    id="${t.id||``}"

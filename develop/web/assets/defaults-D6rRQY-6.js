...
`)}],N=[{id:`1`,title:`Información general`,description:`Datos básicos del servicio`,content:`Aquí encontrarás los datos generales del servicio contratado.`,icon:`info-circle-fill`},{id:`2`,title:`Configuración`,description:`Ajustes y preferences`,content:`Modifica los parámetros del servicio según tus necesidades.`,icon:`gear-fill`},{id:`3`,title:`Historial de cambios`,description:`Registro de actividad reciente`,content:`Consulta todos los cambios realizados durante el último mes.`,icon:`clock-history`}],P=[`Item 1`,`Item 2`,`Item 3`,`Item 4`],F=function(e){return e.TEXT=`text`,e.NUMBER=`number`,e.EMAIL=`email`,e.PASSWORD=`password`,e.SEARCH=`search`,e.TEL=`tel`,e.URL=`url`,e.FILE=`file`,e.RADIO=`radio`,e.RANGE=`range`,e}({}),I=Object.values(F),L=F.TEXT,R=`Este campo es requerido`,z={min:0,max:1e3,step:1},B=[{id:`tab1`,label:`Tab 1`},{id:`tab2`,label:`Tab 2`},{id:`tab3`,label:`Tab 3`}],V=[{id:`tab1`,label:`Tab 1`},{id:`tab2`,label:`Tab 2`,disabled:!0},{id:`tab3`,label:`Tab 3`}],H=[{id:`tab1`,label:`Tab 1`,icon:`check`},{id:`tab2`,label:`Tab 2`,icon:`house`},{id:`tab3`,label:`Tab 3`,icon:`search`}],U=Array.from({length:23},(e,t)=>({id:`tab${t+1}`,label:`Tab ${t+1}`})),W=[{id:`button`,label:`Button`,icon:`check`},{id:`select`,label:`Select`,icon:`house`},{id:`card`,label:`Card`,icon:`search`}],G=[{id:`tab1`,label:`Dashboard`,badge:3},{id:`tab2`,label:`Proyectos`,badge:12},{id:`tab3`,label:`Equipo`},{id:`tab4`,label:`Reportes`},{id:`tab5`,label:`Archivados`,disabled:!0}],K=[`line`,`pill`,`brand`,`subtle`];export{y as C,P as S,k as _,V as a,T as b,R as c,I as d,F as f,N as g,A as h,W as i,L as l,j as m,U as n,H as o,D as p,G as r,K as s,B as t,z as u,O as v,_ as w,E as x,M as y};
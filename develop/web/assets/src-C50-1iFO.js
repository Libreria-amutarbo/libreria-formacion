...
`,ye=t=>e`
    ...
    >
      <div class="${t.innerClasses}" style="${f(t.innerStyles)}">
        ${t.image?e`
...
`,X=t=>e`
  <div class="${t.getWrapperClasses()}">
    ...
    <textarea
      ...
      ?disabled=${t.disabled}
      ?readonly=${t.readonly}
      style=${f({resize:t.computedResize,height:t._autoHeight||``})}

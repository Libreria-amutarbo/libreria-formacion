import{a as e,l as t,n,t as r}from"./lit-LoFRC6vp.js";import{C as i,S as a,_ as o,a as s,b as c,g as ee,n as te,r as l,t as ne,v as u,x as d,y as re}from"./defaults-CXgNBldx.js";var ie=[`vertical`,`horizontal`],ae=[`start`,`center`,`end`],oe=[`s`,`m`,`l`,`xl`,`auto`],se=[`top`,`bottom`,`left`,`right`],ce=`vertical`,f=`center`,p=[`xs`,`s`,`m`,`l`,`xl`],m=`info-circle`,h={showLabel:!0,textLabel:`Value`,value:0,step:1,vertical:!1,min:0,max:50,disabled:!1,valueSuffix:``},le=`Select`,ue=[{value:`one`,label:`Uno`},{value:`two`,label:`Dos`},{value:`three`,label:`Tres`}],g=`Seleccione una opción`,de=`160px`,_=[`bold`,`italic`,`underline`,`orderedList`,`unorderedList`,`removeFormat`],fe=t`
  :host {
    display: inline-flex;
  }
...
`,pe=t=>{let n=`dcx-badge dcx-badge--${t.severity} dcx-badge--${t.size}`;return e`
    ...
    >${t.value}</span>
  `},v=class extends r{#e=``;get value(){return this.#e}set value(e){this.#e=e}#t=`primary`;get severity(){return this.#t}set severity(e){this.#t=e}#n=`md`;get size(){return this.#n}set size(e){this.#n=e}#r=null;get ariaLabel(){return this.#r}set ariaLabel(e){this.#r=e}#i=!1;get ariaHiddenAttr(){return this.#i}set ariaHiddenAttr(e){this.#i=e}#a=null;get roleAttr(){return this.#a}set roleAttr(e){this.#a=e}static styles=fe;getComputedAriaLabel(){if(this.ariaHiddenAttr)return null;if(this.ariaLabel!==null)return this.ariaLabel;let e=this.value;return e?`${e}, ${this.severity}`:this.severity}render(){return pe(this)}};o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],v.prototype,`value`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],v.prototype,`severity`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],v.prototype,`size`,null),o([a({type:String,attribute:`aria-label`}),u(`design:type`,Object),u(`design:paramtypes`,[])],v.prototype,`ariaLabel`,null),o([a({type:Boolean,attribute:`aria-hidden`}),u(`design:type`,Object),u(`design:paramtypes`,[])],v.prototype,`ariaHiddenAttr`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],v.prototype,`roleAttr`,null),v=o([i(`dcx-web-badge`)],v);var me=t`
  :host {
    display: block;
  }
...
`,he=t=>t.visible?e`
  ...
  `:e``,y=class extends r{#e=`center`;get position(){return this.#e}set position(e){this.#e=e}#t=``;get title(){return this.#t}set title(e){this.#t=e}#n=``;get dialogId(){return this.#n}set dialogId(e){this.#n=e}#r=!0;get showClose(){return this.#r}set showClose(e){this.#r=e}#i=!0;get closeOnBackdrop(){return this.#i}set closeOnBackdrop(e){this.#i=e}#a=!1;get visible(){return this.#a}set visible(e){this.#a=e}static styles=me;get dialogTitleId(){return`dialog-title-${this.dialogId||`default`}`}get dialogClasses(){return`dcx-dialog dcx-dialog--pos-${this.position}`}close(){this.dispatchEvent(new CustomEvent(`closeDialog`,{bubbles:!0,composed:!0}))}onBackdropClick(e){e.stopPropagation(),this.closeOnBackdrop&&this.close()}onKeyDown=e=>{e.key===`Escape`&&this.visible&&this.close()};connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this.onKeyDown)}disconnectedCallback(){document.removeEventListener(`keydown`,this.onKeyDown),super.disconnectedCallback()}render(){return he(this)}};o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],y.prototype,`position`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],y.prototype,`title`,null),o([a({type:String,attribute:`dialog-id`}),u(`design:type`,Object),u(`design:paramtypes`,[])],y.prototype,`dialogId`,null),o([a({type:Boolean,attribute:`show-close`}),u(`design:type`,Object),u(`design:paramtypes`,[])],y.prototype,`showClose`,null),o([a({type:Boolean,attribute:`close-on-backdrop`}),u(`design:type`,Object),u(`design:paramtypes`,[])],y.prototype,`closeOnBackdrop`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],y.prototype,`visible`,null),y=o([i(`dcx-web-dialog`)],y);var ge=t`
  :host {
    display: block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,_e=t=>e`
    ...
    >
      <div class="${t.innerClasses}" style="${re(t.innerStyles)}">
        ${t.image?e`
...
`,ye=t=>e`
  ...
  `,x=class extends r{static styles=ve;#e=[];get options(){return this.#e}set options(e){this.#e=e}errorIcon=`exclamation-circle-fill`;_getValue(e){return e===!0?!1:e!==!1||null}_normalizeValue(e){return e===!0||e!==!1&&null}getVariant(e){return this._normalizeValue(e.value)===null?`secondary`:`primary`}getIconName(e){let t=this._normalizeValue(e.value);return t===!0?`check`:t===!1?`dash`:``}getAriaChecked(e){let t=this._normalizeValue(e.value);return t===!0?`true`:t===!1?`mixed`:`false`}changeValue(e){let t=this.options.map(t=>t.id===e?{...t,value:this._getValue(t.value)}:t);this.dispatchEvent(new CustomEvent(`changeOptions`,{detail:t,bubbles:!0,composed:!0}))}renderLabel(t){return e`
      ...
      ${t.required?e`
          ...
          `:``}
    `}render(){return ye(this)}};o([a({attribute:!1}),u(`design:type`,Array),u(`design:paramtypes`,[])],x.prototype,`options`,null),x=o([i(`dcx-web-checkbox`)],x);var be=t`
  :host {
    display: block;
  }
...
`,w=t=>{let n=t.items.length,r=n>t.maxVisibleItems,i=[],a=[];r?(i=t.items.slice(0,n-t.maxVisibleItems),a=t.items.slice(-t.maxVisibleItems)):a=t.items;let o=a[a.length-1]||null;return e`
...
`,D=t=>{if(!t.isOpen)return e``;let n=`dcx-context-menu ${t.positionMode===`absolute`?`dcx-context-menu--absolute`:``}`,r=`top: ${t.top}; left: ${t.left}; opacity: ${t.isPositioned?`1`:`0`};`;return e`
    <div
      class="${n}"
      style="${r}"
  ...
  `},O=class extends r{#e=[];get items(){return this.#e}set items(e){this.#e=e}#t={x:0,y:0};get position(){return this.#t}set position(e){this.#t=e}#n=`fixed`;get positionMode(){return this.#n}set positionMode(e){this.#n=e}#r=!1;get isOpen(){return this.#r}set isOpen(e){this.#r=e}#i=!1;get isPositioned(){return this.#i}set isPositioned(e){this.#i=e}#a=`-9999px`;get top(){return this.#a}set top(e){this.#a=e}#o=`-9999px`;get left(){return this.#o}set left(e){this.#o=e}_openPosition=null;static styles=E;connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this._handleDocumentKeyDown),document.addEventListener(`click`,this._handleDocumentClick),window.addEventListener(`resize`,this._handleWindowResize)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`keydown`,this._handleDocumentKeyDown),document.removeEventListener(`click`,this._handleDocumentClick),window.removeEventListener(`resize`,this._handleWindowResize)}_handleDocumentKeyDown=e=>{e.key===`Escape`&&this.isOpen&&this.close()};_handleDocumentClick=e=>{if(!this.isOpen)return;let t=e.composedPath(),n=this.shadowRoot?.querySelector(`.dcx-context-menu`);n&&t.includes(n)||this.close()};_handleWindowResize=()=>{this.isOpen&&this.calculatePosition()};async open(e){e&&(this._openPosition=e),this.isOpen=!0,await this.updateComplete,this.calculatePosition()}close(){this._openPosition=null,this.isOpen=!1,this.isPositioned=!1,this.dispatchEvent(new CustomEvent(`menu-closed`))}calculatePosition(){let e=this._openPosition??this.position;if(this.positionMode===`absolute`){this.left=`${e.x}px`,this.top=`${e.y}px`,this.isPositioned=!0;return}let t=e.x,n=e.y,r=this.shadowRoot?.querySelector(`.dcx-context-menu`);if(r){let e=r.getBoundingClientRect();if(t+e.width>window.innerWidth-10&&(t=window.innerWidth-10-e.width,t<0&&(t=0)),n+e.height>window.innerHeight-10){let t=n-e.height;n=t>=0?t:10}}let i=0,a=0;if(this.shadowRoot){let e=document.createElement(`div`);e.style.position=`fixed`,e.style.left=`0px`,e.style.top=`0px`,e.style.width=`0px`,e.style.height=`0px`,e.style.visibility=`hidden`,this.shadowRoot.appendChild(e);let t=e.getBoundingClientRect();i=t.left,a=t.top,this.shadowRoot.removeChild(e)}this.left=`${t-i}px`,this.top=`${n-a}px`,this.isPositioned=!0}onItemClick(e,t){t?.stopPropagation(),!(e.disabled||e.divider)&&(e.action&&e.action(),this.dispatchEvent(new CustomEvent(`item-selected`,{detail:e,bubbles:!0,composed:!0})),(!e.children||e.children.length===0)&&this.close())}onItemKeydown(e,t,n){let r=e.children||[];n.key===`ArrowRight`&&r.length>0?(n.preventDefault(),n.currentTarget.querySelector(`.dcx-context-menu__nested [tabindex="0"]`)?.focus()):n.key===`ArrowLeft`?(n.preventDefault(),(n.currentTarget.closest(`.dcx-context-menu__nested`)?.closest(`li`))?.focus()):(n.key===`Enter`||n.key===` `)&&(n.preventDefault(),this.onItemClick(e,n))}renderItem(t,n){if(t.divider)return e`<li class="dcx-context-menu__divider" role="separator"></li>`;let r=t.children&&t.children.length>0,i=[`dcx-context-menu__item`,`dcx-context-menu__item--selectable`,t.disabled?`dcx-context-menu__item--disabled`:``,r?`dcx-context-menu__item--has-children`:``,t.variant===`danger`?`dcx-context-menu__item--danger`:``].filter(Boolean).join(` `);return e`
    ...
    `}render(){return D(this)}};o([a({type:Array}),u(`design:type`,Array),u(`design:paramtypes`,[])],O.prototype,`items`,null),o([a({type:Object}),u(`design:type`,Object),u(`design:paramtypes`,[])],O.prototype,`position`,null),o([a({type:String}),u(`design:type`,String),u(`design:paramtypes`,[])],O.prototype,`positionMode`,null),o([d(),u(`design:type`,Object),u(`design:paramtypes`,[])],O.prototype,`isOpen`,null),o([d(),u(`design:type`,Object),u(`design:paramtypes`,[])],O.prototype,`isPositioned`,null),o([d(),u(`design:type`,Object),u(`design:paramtypes`,[])],O.prototype,`top`,null),o([d(),u(`design:type`,Object),u(`design:paramtypes`,[])],O.prototype,`left`,null),O=o([i(`dcx-web-context-menu`)],O);var k=t`
  :host {
    display: contents;
  }
...
`,A=t=>{if(!t.rendered)return n;let r=[`dcx-drawer`,`dcx-drawer--${t.position}`,t.fullScreen?`dcx-drawer--fullscreen`:``].filter(Boolean),i=[`dcx-drawer-root`,t.closing?`dcx-drawer-root--closing`:``],a=t.modal;return e`
  ...
  `},j=[`s`,`m`,`l`,`xl`,`auto`],M=[`top`,`bottom`,`left`,`right`],Se=[`vertical`,`horizontal`],Ce=[`xs`,`s`,`m`,`l`,`xl`],N=`right`,we=M,P=`22rem`,F=1e3,I=`Drawer`,Te={open:!1,position:N,modal:!0,dismissible:!0,showCloseIcon:!0,closeOnEscape:!0,blockScroll:!1,fullScreen:!1,size:P,baseZIndex:F,autoZIndex:!0,header:I,footer:``},L,R=class extends r{static{L=this}#e=!1;get open(){return this.#e}set open(e){this.#e=e}#t=N;get position(){return this.#t}set position(e){this.#t=e}#n=!0;get modal(){return this.#n}set modal(e){this.#n=e}#r=!0;get dismissible(){return this.#r}set dismissible(e){this.#r=e}#i=!0;get showCloseIcon(){return this.#i}set showCloseIcon(e){this.#i=e}#a=!0;get closeOnEscape(){return this.#a}set closeOnEscape(e){this.#a=e}#o=!1;get blockScroll(){return this.#o}set blockScroll(e){this.#o=e}#s=!1;get fullScreen(){return this.#s}set fullScreen(e){this.#s=e}#c=P;get size(){return this.#c}set size(e){this.#c=e}#l=F;get baseZIndex(){return this.#l}set baseZIndex(e){this.#l=e}#u=!0;get autoZIndex(){return this.#u}set autoZIndex(e){this.#u=e}#d=I;get header(){return this.#d}set header(e){this.#d=e}#f=``;get footer(){return this.#f}set footer(e){this.#f=e}static styles=k;static _instanceCount=0;static _globalZIndex=0;#p=F;get _currentZIndex(){return this.#p}set _currentZIndex(e){this.#p=e}#m=!1;get rendered(){return this.#m}set rendered(e){this.#m=e}#h=!1;get closing(){return this.#h}set closing(e){this.#h=e}_closeTimer;_scrollBlocked=!1;_previousOverflow=``;_hideAlreadyEmitted=!1;_drawerId=`dcx-drawer-${++L._instanceCount}`;_keydownHandler=e=>{!this.open||!this.closeOnEscape||e.key!==`Escape`||this.closeDrawer()};get drawerTitleId(){return`${this._drawerId}-title`}get hasHeader(){return!!(this.header||this.showCloseIcon||this.querySelector(`[slot="drawerHeader"]`))}get hasFooter(){return!!(this.footer||this.querySelector(`[slot="drawerFooter"]`))}get resolvedZIndex(){return this._currentZIndex}get panelWidth(){return this.fullScreen?`100%`:this.position===`left`||this.position===`right`?this.size:null}get panelHeight(){return this.fullScreen?`100%`:this.position===`top`||this.position===`bottom`?this.size:null}connectedCallback(){super.connectedCallback(),this._syncKeydownListener(),this._syncBodyScroll()}disconnectedCallback(){document.removeEventListener(`keydown`,this._keydownHandler),this._scrollBlocked&&=(document.body.style.overflow=this._previousOverflow,document.body.style.paddingRight=``,!1),window.clearTimeout(this._closeTimer),super.disconnectedCallback()}willUpdate(e){e.has(`open`)&&(this.open?(this.closing=!1,this.rendered=!0):this.closing=!0),(e.has(`open`)||e.has(`baseZIndex`)||e.has(`autoZIndex`))&&(this.open&&this.autoZIndex?(L._globalZIndex=Math.max(L._globalZIndex,this.baseZIndex),L._globalZIndex+=2,this._currentZIndex=L._globalZIndex):this._currentZIndex=this.baseZIndex)}updated(e){e.has(`open`)&&(this.open?this.dispatchEvent(new CustomEvent(`dcx-drawer-show`,{bubbles:!0,composed:!0})):(this._hideAlreadyEmitted?this._hideAlreadyEmitted=!1:this.dispatchEvent(new CustomEvent(`dcx-drawer-hide`,{bubbles:!0,composed:!0})),window.clearTimeout(this._closeTimer),this._closeTimer=window.setTimeout(()=>{this.rendered=!1,this.closing=!1,this.requestUpdate()},220))),(e.has(`open`)||e.has(`blockScroll`)||e.has(`modal`))&&this._syncBodyScroll(),(e.has(`open`)||e.has(`closeOnEscape`))&&this._syncKeydownListener()}render(){return A(this)}close(){this.closeDrawer()}handleMaskPointerDown=e=>{e.stopPropagation(),this.dismissible&&this.closeDrawer()};closeDrawer=()=>{this.open&&(this._hideAlreadyEmitted=!0,this.dispatchEvent(new CustomEvent(`dcx-drawer-hide`,{bubbles:!0,composed:!0})),this.open=!1,this.dispatchEvent(new CustomEvent(`dcx-drawer-visible-change`,{detail:!1,bubbles:!0,composed:!0})))};_syncBodyScroll(){let e=this.open&&this.modal&&this.blockScroll;if(e&&!this._scrollBlocked){let e=window.innerWidth-document.documentElement.clientWidth;this._previousOverflow=document.body.style.overflow,document.body.style.overflow=`hidden`,e>0&&(document.body.style.paddingRight=`${e}px`),this._scrollBlocked=!0}else!e&&this._scrollBlocked&&(document.body.style.overflow=this._previousOverflow,document.body.style.paddingRight=``,this._scrollBlocked=!1)}_syncKeydownListener(){this.open&&this.closeOnEscape?document.addEventListener(`keydown`,this._keydownHandler):document.removeEventListener(`keydown`,this._keydownHandler)}};o([a({type:Boolean,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`open`,null),o([a({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`position`,null),o([a({type:Boolean,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`modal`,null),o([a({type:Boolean,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`dismissible`,null),o([a({type:Boolean,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`showCloseIcon`,null),o([a({type:Boolean,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`closeOnEscape`,null),o([a({type:Boolean,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`blockScroll`,null),o([a({type:Boolean,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`fullScreen`,null),o([a({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`size`,null),o([a({type:Number,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`baseZIndex`,null),o([a({type:Boolean,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`autoZIndex`,null),o([a({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`header`,null),o([a({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`footer`,null),o([d(),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`_currentZIndex`,null),o([d(),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`rendered`,null),o([d(),u(`design:type`,Object),u(`design:paramtypes`,[])],R.prototype,`closing`,null),R=L=o([i(`dcx-web-drawer`)],R);var Ee=t`
    :host {
      display: inline-flex;
    }
...
`,De=t=>{let r=`dcx-chip dcx-chip--${t.color}`,i=t.label?`Remover ${t.label}`:`Remover chip`;return e`
    <span
      class=${r}
  ...
  `},z=class extends r{#e=``;get label(){return this.#e}set label(e){this.#e=e}#t=`primary`;get color(){return this.#t}set color(e){this.#t=e}#n=!1;get removable(){return this.#n}set removable(e){this.#n=e}#r=``;get icon(){return this.#r}set icon(e){this.#r=e}#i=``;get image(){return this.#i}set image(e){this.#i=e}#a=`choice`;get variant(){return this.#a}set variant(e){this.#a=e}static styles=Ee;get chipType(){return this.image.trim()?`with-image`:this.icon.trim()?`with-icon`:`label-only`}get showRemove(){return this.variant===`filter`||this.removable}renderIcon(){let t=[`house`,`person`,`gear`,`star`,`code-slash`,`terminal`,`palette`,`book`,`bug`].includes(this.icon)?this.icon:`question-circle`;return e`<dcx-web-icon name=${t}></dcx-web-icon>`}handleRemove(e){e.stopPropagation(),this.showRemove&&this.dispatchEvent(new CustomEvent(`dcx-chip-remove`,{bubbles:!0,composed:!0}))}render(){return De(this)}};o([a({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`label`,null),o([a({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`color`,null),o([a({type:Boolean,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`removable`,null),o([a({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`icon`,null),o([a({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`image`,null),o([a({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`variant`,null),z=o([i(`dcx-web-chip`)],z);var Oe=t`
  :host {
    display: block;
    width: 100%;
    box-sizing: border-box;
...
`,je=t=>{let r={"dcx-datepicker__input-wrapper":!0,"dcx-datepicker__input-wrapper--disabled":t.disabled,"dcx-datepicker__input-wrapper--open":t.isOpen};return e`
...
`,ze=t=>e`
  ...
  `,H=class extends r{#e=`dcx-input-${Math.random().toString(36).substring(2,9)}`;get id(){return this.#e}set id(e){this.#e=e}#t=``;get value(){return this.#t}set value(e){this.#t=e}#n=!1;get disabled(){return this.#n}set disabled(e){this.#n=e}#r=!1;get readonly(){return this.#r}set readonly(e){this.#r=e}#i=``;get placeholder(){return this.#i}set placeholder(e){this.#i=e}#a=te;get type(){return this.#a}set type(e){this.#a=e}#o=``;get name(){return this.#o}set name(e){this.#o=e}#s=!1;get required(){return this.#s}set required(e){this.#s=e}#c=!1;get checked(){return this.#c}set checked(e){this.#c=e}#l=``;get autocomplete(){return this.#l}set autocomplete(e){this.#l=e}#u=``;get inputMode(){return this.#u}set inputMode(e){this.#u=e}#d=!1;get isInvalid(){return this.#d}set isInvalid(e){this.#d=e}#f=``;get label(){return this.#f}set label(e){this.#f=e}#p=``;get hint(){return this.#p}set hint(e){this.#p=e}#m=null;get ariaLabel(){return this.#m}set ariaLabel(e){this.#m=e}#h=null;get ariaDescribedBy(){return this.#h}set ariaDescribedBy(e){this.#h=e}#g=``;get errorMessage(){return this.#g}set errorMessage(e){this.#g=e}#_=ne;get requiredMessage(){return this.#_}set requiredMessage(e){this.#_=e}#v=[];get errorMessages(){return this.#v}set errorMessages(e){this.#v=e}#y=m;get errorIcon(){return this.#y}set errorIcon(e){this.#y=e}#b=`xs`;get spacing(){return this.#b}set spacing(e){this.#b=e}#x=`horizontal`;get orientation(){return this.#x}set orientation(e){this.#x=e}#S=!1;get multiple(){return this.#S}set multiple(e){this.#S=e}#C=l.min;get min(){return this.#C}set min(e){this.#C=e}#w=l.max;get max(){return this.#w}set max(e){this.#w=e}#T=l.step;get step(){return this.#T}set step(e){this.#T=e}#E=!1;get showPassword(){return this.#E}set showPassword(e){this.#E=e}#D=!1;get touched(){return this.#D}set touched(e){this.#D=e}static styles=Re;get labelId(){return`${this.id}-label`}get errorId(){return`${this.id}-error`}get hintId(){return`${this.id}-hint`}get isPasswordType(){return this.type===s.PASSWORD}get isSearchType(){return this.type===s.SEARCH}get isFileType(){return this.type===s.FILE}get isRadioType(){return this.type===s.RADIO}get isRangeType(){return this.type===s.RANGE}get displayType(){return this.isPasswordType?this.showPassword?`text`:`password`:this.isRangeType?`range`:this.type}get showActionIcon(){return(this.isPasswordType||this.isSearchType)&&!this.readonly}get getInputIcon(){return{[s.TEXT]:null,[s.NUMBER]:`pin`,[s.EMAIL]:`mail`,[s.PASSWORD]:null,[s.SEARCH]:`search`,[s.TEL]:`phone`,[s.URL]:`link`,[s.FILE]:null,[s.RADIO]:null,[s.RANGE]:null}[this.type]??null}get describedBy(){let e=[this.ariaDescribedBy,this.hint&&!this.isInvalid?this.hintId:null,this.isInvalid?this.errorId:null].filter(Boolean).join(` `).trim();return e.length?e:null}get showRequiredWarning(){return this.required&&[``,null,void 0].includes(this.value)&&this.touched}get getActionButtonAriaLabel(){return this.isPasswordType?this.showPassword?`Ocultar contraseña`:`Mostrar contraseña`:this.isSearchType?`Buscar`:``}get getActionButtonIcon(){return this.isPasswordType?this.showPassword?`eye-slash-fill`:`eye-fill`:this.isSearchType?`search`:``}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}formatValueByType(e){switch(this.type){case`number`:return e.replace(/[^0-9.-]/g,``)===``?``:parseFloat(e.replace(/[^0-9.-]/g,``));case`email`:return e.toLowerCase();case`tel`:return e.replace(/[^0-9\s\-()]/g,``);case`search`:return e.trim();case`url`:return e.toLowerCase();default:return e}}onInputChange(e){if(this.isRadioType||this.isFileType)return;let t=e.target,n=this.formatValueByType(t.value);this.value=n,this.emit(`valueChange`,n)}onChangeEvent(e){this.isFileType||this.isRadioType&&e.target.checked&&this.emit(`valueChange`,this.value)}onFocusEvent(){this.touched=!1,this.emit(`focusEvent`)}onBlurEvent(){this.touched=!0,this.emit(`blurEvent`)}togglePasswordVisibility(){this.showPassword=!this.showPassword}onActionButtonClick(){if(this.isPasswordType){this.togglePasswordVisibility();return}this.isSearchType&&this.emit(`valueChange`,this.value)}getInputClasses(){let e=[`dcx-input__control`,`dcx-input__control--${this.spacing}`];return this.disabled&&e.push(`is-disabled`,`dcx-input__control--disabled`),this.isInvalid&&e.push(`is-invalid`,`dcx-input__control--invalid`),this.getInputIcon&&e.push(`has-icon`,`dcx-input__control--has-icon`),this.showActionIcon&&e.push(`has-action`,`dcx-input__control--has-action`),e.join(` `)}render(){return ze(this)}};o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`id`,null),o([a({attribute:!1}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`value`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`disabled`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`readonly`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`placeholder`,null),o([a({type:String}),u(`design:type`,s===void 0?Object:s),u(`design:paramtypes`,[])],H.prototype,`type`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`name`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`required`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`checked`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`autocomplete`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`inputMode`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`isInvalid`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`label`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`hint`,null),o([a({type:String,attribute:`aria-label`}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`ariaLabel`,null),o([a({type:String,attribute:`aria-describedby`}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`ariaDescribedBy`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`errorMessage`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`requiredMessage`,null),o([a({attribute:!1}),u(`design:type`,Array),u(`design:paramtypes`,[])],H.prototype,`errorMessages`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`errorIcon`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`spacing`,null),o([a({type:String,reflect:!0}),u(`design:type`,String),u(`design:paramtypes`,[])],H.prototype,`orientation`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`multiple`,null),o([a({type:Number}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`min`,null),o([a({type:Number}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`max`,null),o([a({type:Number}),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`step`,null),o([d(),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`showPassword`,null),o([d(),u(`design:type`,Object),u(`design:paramtypes`,[])],H.prototype,`touched`,null),H=o([i(`dcx-web-input`)],H);var Be=t=>e`
    <div
...
`,J=class extends r{#e=``;get body(){return this.#e}set body(e){this.#e=e}#t=`notification`;get type(){return this.#t}set type(e){this.#t=e}#n=``;get title(){return this.#n}set title(e){this.#n=e}#r=``;get link(){return this.#r}set link(e){this.#r=e}#i=!1;get icon(){return this.#i}set icon(e){this.#i=e}#a=``;get iconName(){return this.#a}set iconName(e){this.#a=e}#o=!1;get showClose(){return this.#o}set showClose(e){this.#o=e}#s=!0;get announce(){return this.#s}set announce(e){this.#s=e}#c=!1;get dismissed(){return this.#c}set dismissed(e){this.#c=e}static styles=Je;get messageData(){return{notification:{icon:`info-circle`,role:`status`,ariaLive:`polite`},success:{icon:`check-circle`,role:`status`,ariaLive:`polite`},warning:{icon:`exclamation-triangle`,role:`alert`,ariaLive:`assertive`},error:{icon:`x-circle`,role:`alert`,ariaLive:`assertive`}}[this.type]}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}onClose=()=>{this.dismissed=!0,this.emit(`closed`)};render(){return qe(this)}};o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],J.prototype,`body`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],J.prototype,`type`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],J.prototype,`title`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],J.prototype,`link`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],J.prototype,`icon`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],J.prototype,`iconName`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],J.prototype,`showClose`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],J.prototype,`announce`,null),o([d(),u(`design:type`,Object),u(`design:paramtypes`,[])],J.prototype,`dismissed`,null),J=o([i(`dcx-web-message`)],J);var Y=t`
  :host {
    display: inline-flex;
  }
...
`,Ye=t=>e`
  ...
  `,X=class extends r{#e=!1;get checked(){return this.#e}set checked(e){this.#e=e}#t=!1;get disabled(){return this.#t}set disabled(e){this.#t=e}#n=null;get label(){return this.#n}set label(e){this.#n=e}#r=`m`;get size(){return this.#r}set size(e){this.#r=e}#i=null;get ariaLabel(){return this.#i}set ariaLabel(e){this.#i=e}#a=`right`;get textPosition(){return this.#a}set textPosition(e){this.#a=e}static styles=Y;get effectiveAriaLabel(){return this.ariaLabel||this.label||`Toggle`}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}toggle(){if(this.disabled)return;let e=!this.checked;this.checked=e,this.emit(`toggled`,e)}getToggleClasses(){let e=[`dcx-toggle`,this.size?`dcx-toggle--${this.size}`:``,`dcx-toggle--${this.textPosition}`];return this.disabled&&e.push(`dcx-toggle--disabled`),e.filter(Boolean).join(` `)}render(){return Ye(this)}};o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`checked`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`disabled`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`label`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`size`,null),o([a({type:String,attribute:`aria-label`}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`ariaLabel`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`textPosition`,null),X=o([i(`dcx-web-toggle`)],X);var Xe=t`
  :host {
    display: block;
    width: 100%;
  }
...
`,Z=class extends r{#e=`dcx-progressbar-${Math.random().toString(36).substring(2,9)}`;get id(){return this.#e}set id(e){this.#e=e}#t=`default`;get variant(){return this.#t}set variant(e){this.#t=e}#n=0;get value(){return this.#n}set value(e){this.#n=e}#r=``;get label(){return this.#r}set label(e){this.#r=e}#i=``;get ariaLabel(){return this.#i}set ariaLabel(e){this.#i=e}#a=!1;get showTooltip(){return this.#a}set showTooltip(e){this.#a=e}#o=!1;get showLabel(){return this.#o}set showLabel(e){this.#o=e}#s=[];get steps(){return this.#s}set steps(e){this.#s=e}#c=0;get currentStep(){return this.#c}set currentStep(e){this.#c=e}#l=!1;get showCheckmarks(){return this.#l}set showCheckmarks(e){this.#l=e}#u=5;get segments(){return this.#u}set segments(e){this.#u=e}static styles=Xe;get labelId(){return`${this.id}-label`}get progressPercentage(){return Math.min(Math.max(this.value,0),100)}get isStepperVariant(){return this.variant===`stepper`}get isSegmentedVariant(){return this.variant===`segmented`}get isDefaultVariant(){return this.variant==="default"}get segmentArray(){return Array(this.segments).fill(0).map((e,t)=>t)}get stepProgress(){let e=this.steps.length;return e===0?0:this.currentStep/e*100}get stepValueText(){return`Paso ${this.currentStep} de ${this.steps.length}`}isStepCompleted(e){return e<this.currentStep-1}isStepActive(e){return e===this.currentStep-1}render(){return Ze(this)}};o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`id`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`variant`,null),o([a({type:Number}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`value`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`label`,null),o([a({type:String,attribute:`aria-label`}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`ariaLabel`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`showTooltip`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`showLabel`,null),o([a({attribute:!1}),u(`design:type`,Array),u(`design:paramtypes`,[])],Z.prototype,`steps`,null),o([a({type:Number}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`currentStep`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`showCheckmarks`,null),o([a({type:Number}),u(`design:type`,Object),u(`design:paramtypes`,[])],Z.prototype,`segments`,null),Z=o([i(`dcx-web-progressbar`)],Z);var Qe=t`
  :host {
    display: inline-block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,$e=t=>e`
  ...
  `,Q=class extends r{static styles=Qe;#e=[];get options(){return this.#e}set options(e){this.#e=e}#t=`dcx-radio-${Math.random().toString(36).substring(2,9)}`;get name(){return this.#t}set name(e){this.#t=e}#n=``;get label(){return this.#n}set label(e){this.#n=e}#r=``;get ariaLabel(){return this.#r}set ariaLabel(e){this.#r=e}#i=`l`;get size(){return this.#i}set size(e){this.#i=e}#a=!1;get disabled(){return this.#a}set disabled(e){this.#a=e}#o=!1;get error(){return this.#o}set error(e){this.#o=e}#s=``;get hint(){return this.#s}set hint(e){this.#s=e}#c=``;get errorMessage(){return this.#c}set errorMessage(e){this.#c=e}#l=null;get value(){return this.#l}set value(e){this.#l=e}groupId=`dcx-radio-group-${Math.random().toString(36).substring(2,9)}`;get hintId(){return`${this.groupId}-hint`}get errorId(){return`${this.groupId}-error`}get isGroupDisabled(){return this.disabled}get showError(){return this.error&&!!this.errorMessage}get showHint(){return!!this.hint&&!this.showError}get describedBy(){return this.showError?this.errorId:this.showHint?this.hintId:null}isChecked(e){return this.value===e}isOptionDisabled(e){return this.isGroupDisabled||!!e.disabled}radioClasses(e){let t=`dcx-radio`;return[t,`${t}--${this.size}`,this.error?`${t}--error`:``,this.isOptionDisabled(e)?`${t}--disabled`:``,this.isChecked(e.value)?`${t}--checked`:``].filter(Boolean).join(` `)}onOptionChange(e){this.isOptionDisabled(e)||(this.value=e.value,this.dispatchEvent(new CustomEvent(`valueChange`,{detail:e.value,bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`change`,{bubbles:!0,composed:!0})))}onBlur(){this.dispatchEvent(new CustomEvent(`blurEvent`,{bubbles:!0,composed:!0}))}render(){return $e(this)}};o([a({type:Array}),u(`design:type`,Array),u(`design:paramtypes`,[])],Q.prototype,`options`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],Q.prototype,`name`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],Q.prototype,`label`,null),o([a({type:String,attribute:`aria-label`}),u(`design:type`,Object),u(`design:paramtypes`,[])],Q.prototype,`ariaLabel`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],Q.prototype,`size`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],Q.prototype,`disabled`,null),o([a({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],Q.prototype,`error`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],Q.prototype,`hint`,null),o([a({type:String,attribute:`error-message`}),u(`design:type`,Object),u(`design:paramtypes`,[])],Q.prototype,`errorMessage`,null),o([a({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],Q.prototype,`value`,null),Q=o([i(`dcx-web-radio`)],Q);var et=t`
  :host {
    display: block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }

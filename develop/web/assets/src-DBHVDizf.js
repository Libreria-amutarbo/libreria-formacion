import{a as e,i as t,l as n,n as r,t as i}from"./lit-C11zoK0j.js";import{a,c as o,i as s,l as c,n as l,o as u,r as d,s as f,t as p,u as m}from"./dcx-web-button.component-D3Abov5f.js";import{C as h,c as ee,f as g,l as te,u as _,w as ne}from"./defaults-D6rRQY-6.js";import{a as v,i as re,n as y,o as b,t as ie}from"./directive-helpers-Be5gynPs.js";var ae=(e,t,n)=>(n.configurable=!0,n.enumerable=!0,Reflect.decorate&&typeof t!=`object`&&Object.defineProperty(e,t,n),n);function oe(e,t){return(n,r,i)=>{let a=t=>t.renderRoot?.querySelector(e)??null;if(t){let{get:e,set:t}=typeof r==`object`?n:i??(()=>{let e=Symbol();return{get(){return this[e]},set(t){this[e]=t}}})();return ae(n,r,{get(){let n=e.call(this);return n===void 0&&(n=a(this),(n!==null||this.hasUpdated)&&t.call(this,n)),n}})}return ae(n,r,{get(){return a(this)}})}}var se=[`vertical`,`horizontal`],ce=[`start`,`center`,`end`],le=[`s`,`m`,`l`,`xl`,`auto`],ue=[`top`,`bottom`,`left`,`right`],de=`vertical`,fe=`center`,pe=[`xs`,`s`,`m`,`l`,`xl`],x=`info-circle`,S={showLabel:!0,textLabel:`Value`,value:0,step:1,vertical:!1,min:0,max:50,disabled:!1,valueSuffix:``},me=`Select`,he=[{value:`one`,label:`Uno`},{value:`two`,label:`Dos`},{value:`three`,label:`Tres`}],ge=`Seleccione una opción`,_e=`160px`,ve=[`bold`,`italic`,`underline`,`orderedList`,`unorderedList`,`removeFormat`],ye=n`
  :host {
    display: inline-flex;
  }
...
`,be=t=>{let n=`dcx-badge dcx-badge--${t.severity} dcx-badge--${t.size}`;return e`
    <span
      class="${n}"
      role="${t.roleAttr||``}"
    ...
    >${t.value}</span>
  `},C=class extends i{#e=``;get value(){return this.#e}set value(e){this.#e=e}#t=`primary`;get severity(){return this.#t}set severity(e){this.#t=e}#n=`md`;get size(){return this.#n}set size(e){this.#n=e}#r=null;get ariaLabel(){return this.#r}set ariaLabel(e){this.#r=e}#i=!1;get ariaHiddenAttr(){return this.#i}set ariaHiddenAttr(e){this.#i=e}#a=null;get roleAttr(){return this.#a}set roleAttr(e){this.#a=e}static styles=ye;getComputedAriaLabel(){if(this.ariaHiddenAttr)return null;if(this.ariaLabel!==null)return this.ariaLabel;let e=this.value;return e?`${e}, ${this.severity}`:this.severity}render(){return be(this)}};l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],C.prototype,`value`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],C.prototype,`severity`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],C.prototype,`size`,null),l([c({type:String,attribute:`aria-label`}),d(`design:type`,Object),d(`design:paramtypes`,[])],C.prototype,`ariaLabel`,null),l([c({type:Boolean,attribute:`aria-hidden`}),d(`design:type`,Object),d(`design:paramtypes`,[])],C.prototype,`ariaHiddenAttr`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],C.prototype,`roleAttr`,null),C=l([m(`dcx-web-badge`)],C);var xe=n`
  :host {
    display: block;
  }
...
`,Se=t=>t.visible?e`
    <div class="dcx-dialog-root">
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="${p(t.title?t.dialogTitleId:void 0)}"
      >
  ...
  `:e``,w=class extends i{#e=`center`;get position(){return this.#e}set position(e){this.#e=e}#t=``;get title(){return this.#t}set title(e){this.#t=e}#n=``;get dialogId(){return this.#n}set dialogId(e){this.#n=e}#r=!0;get showClose(){return this.#r}set showClose(e){this.#r=e}#i=!0;get closeOnBackdrop(){return this.#i}set closeOnBackdrop(e){this.#i=e}#a=!1;get visible(){return this.#a}set visible(e){this.#a=e}static styles=xe;get dialogTitleId(){return`dialog-title-${this.dialogId||`default`}`}get dialogClasses(){return`dcx-dialog dcx-dialog--pos-${this.position}`}close(){this.dispatchEvent(new CustomEvent(`closeDialog`,{bubbles:!0,composed:!0}))}onBackdropClick(e){e.stopPropagation(),this.closeOnBackdrop&&this.close()}onKeyDown=e=>{e.key===`Escape`&&this.visible&&this.close()};connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this.onKeyDown)}disconnectedCallback(){document.removeEventListener(`keydown`,this.onKeyDown),super.disconnectedCallback()}render(){return Se(this)}};l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],w.prototype,`position`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],w.prototype,`title`,null),l([c({type:String,attribute:`dialog-id`}),d(`design:type`,Object),d(`design:paramtypes`,[])],w.prototype,`dialogId`,null),l([c({type:Boolean,attribute:`show-close`}),d(`design:type`,Object),d(`design:paramtypes`,[])],w.prototype,`showClose`,null),l([c({type:Boolean,attribute:`close-on-backdrop`}),d(`design:type`,Object),d(`design:paramtypes`,[])],w.prototype,`closeOnBackdrop`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],w.prototype,`visible`,null),w=l([m(`dcx-web-dialog`)],w);var Ce=n`
  :host {
    display: block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,we=t=>e`
    <div
      class="${t.cardClasses}"
      tabindex="${t.cardTabIndex??r}"
      role="${t.cardRole}"
      aria-disabled="${t.disabled}"
      aria-label="${t.effectiveAriaLabel??r}"
        ...
        <div class="dcx-card__body">
          ...
          ${t.hasHeader?e`
              ...
              `:t.title||t.subtitle?e`
                <div class="dcx-card__header">
                  ${t.title?e`<h3 class="dcx-card__title">${t.title}</h3>`:r}
                  ${t.subtitle?e`<p class="dcx-card__subtitle">${t.subtitle}</p>`:r}
                </div>
              `:r}
  ...
  `,T=class extends i{#e=`https://picsum.photos/360/240`;get image(){return this.#e}set image(e){this.#e=e}#t=``;get imageAlt(){return this.#t}set imageAlt(e){this.#t=e}#n=`Título de la carta`;get title(){return this.#n}set title(e){this.#n=e}#r=`Subtítulo de la carta`;get subtitle(){return this.#r}set subtitle(e){this.#r=e}#i=`vertical`;get layout(){return this.#i}set layout(e){this.#i=e}#a=`center`;get align(){return this.#a}set align(e){this.#a=e}#o=`s`;get size(){return this.#o}set size(e){this.#o=e}#s=`560px`;get maxContentWidth(){return this.#s}set maxContentWidth(e){this.#s=e}#c=`100%`;get maxImageWidth(){return this.#c}set maxImageWidth(e){this.#c=e}#l=!1;get accent(){return this.#l}set accent(e){this.#l=e}#u=!1;get bordered(){return this.#u}set bordered(e){this.#u=e}#d=1;get borderWidth(){return this.#d}set borderWidth(e){this.#d=e}#f=`solid`;get borderStyle(){return this.#f}set borderStyle(e){this.#f=e}#p=1;get shadow(){return this.#p}set shadow(e){this.#p=e}#m=!0;get interactive(){return this.#m}set interactive(e){this.#m=e}#h=!1;get disabled(){return this.#h}set disabled(e){this.#h=e}static styles=Ce;get cardClasses(){return`dcx-card ${this.interactive?`dcx-card--interactive`:``} ${this.disabled?`dcx-card--disabled`:``}`.trim().replace(/\s+/g,` `)}get innerClasses(){let e=this.accent?`dcx-card__inner--accent-top`:``;return`dcx-card__inner dcx-card__inner--layout-${this.layout} dcx-card__inner--align-${this.align} dcx-card__inner--size-${this.size} ${e}`.trim().replace(/\s+/g,` `)}get innerStyles(){return{"--card-max-content-width":this.maxContentWidth,"--card-max-image-width":this.maxImageWidth,"--card-border-style":this.bordered?this.borderStyle:`solid`,"--card-border-width":this.bordered?`${this.borderWidth}px`:`0`,"--card-shadow":this.shadowCSS}}get cardRole(){return this.disabled?`region`:this.interactive?`button`:`region`}get cardTabIndex(){if(this.disabled)return-1;if(this.cardRole===`button`)return 0}get hasHeader(){return this.querySelector(`[slot="header"]`)!==null}get hasContent(){return this.querySelector(`[slot="content"]`)!==null||Array.from(this.childNodes).some(e=>e.nodeType===Node.ELEMENT_NODE&&!e.hasAttribute(`slot`)||e.nodeType===Node.TEXT_NODE&&(e.textContent??``).trim().length>0)}get hasFooter(){return this.querySelector(`[slot="footer"]`)!==null}get effectiveAriaLabel(){return this.cardRole===`region`&&!this.hasHeader&&this.title?this.title:null}get shadowCSS(){switch(this.shadow){case 1:return`var(--shadow-sm, 0 1px 2px rgba(0, 0, 0, 0.06))`;case 2:return`var(--shadow-md, 0 4px 12px rgba(0, 0, 0, 0.08))`;case 3:return`var(--shadow-lg, 0 8px 24px rgba(0, 0, 0, 0.12))`;default:return`var(--shadow-0, none)`}}_handleCardClick(e){if(!this.disabled){if(e instanceof KeyboardEvent){let t=e.key.toLowerCase();this.interactive&&(t===`enter`||t===` `)&&(e.preventDefault(),this.dispatchEvent(new CustomEvent(`dcx-card-click`,{detail:e,bubbles:!0,composed:!0})))}else this.dispatchEvent(new CustomEvent(`dcx-card-click`,{detail:e,bubbles:!0,composed:!0}))}}render(){return we(this)}};l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],T.prototype,`image`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],T.prototype,`imageAlt`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],T.prototype,`title`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],T.prototype,`subtitle`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],T.prototype,`layout`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],T.prototype,`align`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],T.prototype,`size`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],T.prototype,`maxContentWidth`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],T.prototype,`maxImageWidth`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],T.prototype,`accent`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],T.prototype,`bordered`,null),l([c({type:Number}),d(`design:type`,Object),d(`design:paramtypes`,[])],T.prototype,`borderWidth`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],T.prototype,`borderStyle`,null),l([c({type:Number}),d(`design:type`,Object),d(`design:paramtypes`,[])],T.prototype,`shadow`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],T.prototype,`interactive`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],T.prototype,`disabled`,null),T=l([m(`dcx-web-card`)],T);var Te=n`
  :host {
    display: block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,Ee=t=>e`
  ...
  `,E=class extends i{static styles=Te;#e=[];get options(){return this.#e}set options(e){this.#e=e}errorIcon=`exclamation-circle-fill`;_getValue(e){return e===!0?!1:e!==!1||null}_normalizeValue(e){return e===!0||e!==!1&&null}getVariant(e){return this._normalizeValue(e.value)===null?`secondary`:`primary`}getIconName(e){let t=this._normalizeValue(e.value);return t===!0?`check`:t===!1?`dash`:``}getAriaChecked(e){let t=this._normalizeValue(e.value);return t===!0?`true`:t===!1?`mixed`:`false`}changeValue(e){let t=this.options.map(t=>t.id===e?{...t,value:this._getValue(t.value)}:t);this.dispatchEvent(new CustomEvent(`changeOptions`,{detail:t,bubbles:!0,composed:!0}))}renderLabel(t){return e`
      ...
      ${t.required?e`
          ...
          `:``}
    `}render(){return Ee(this)}};l([c({attribute:!1}),d(`design:type`,Array),d(`design:paramtypes`,[])],E.prototype,`options`,null),E=l([m(`dcx-web-checkbox`)],E);var De=n`
  :host {
    display: block;
  }
...
`,Oe=t=>{let n=t.getComputedAriaLabel(),r=t.isHidden();return t.label?e`
      <div
    ...
    <span
      ...
      aria-hidden="${r?`true`:`false`}"
    ></span>
  `},D=class extends i{#e=`horizontal`;get orientation(){return this.#e}set orientation(e){this.#e=e}#t=`default`;get type(){return this.#t}set type(e){this.#t=e}#n=`auto`;get size(){return this.#n}set size(e){this.#n=e}#r=.25;get thickness(){return this.#r}set thickness(e){this.#r=e}#i=`#d1d5db`;get color(){return this.#i}set color(e){this.#i=e}#a=``;get label(){return this.#a}set label(e){this.#a=e}#o=null;get ariaLabel(){return this.#o}set ariaLabel(e){this.#o=e}static styles=De;_getDividerStyle(){switch(this.type){case`dot`:return`dotted`;case`dash`:return`dashed`;default:return`solid`}}_getDividerSize(){switch(this.size){case`s`:return`5rem`;case`m`:return`15rem`;case`l`:return`30rem`;case`xl`:return`35rem`;default:return`100%`}}getComputedAriaLabel(){return this.ariaLabel&&this.ariaLabel.trim().length>0?this.ariaLabel:this.label&&this.label.trim().length>0?this.label:``}isHidden(){return!this.label&&!this.ariaLabel}updated(){this.classList.toggle(`horizontal`,this.orientation===`horizontal`),this.classList.toggle(`vertical`,this.orientation===`vertical`),this.classList.toggle(`has-label`,!!this.label),this.style.setProperty(`--_dcx-divider-size`,this._getDividerSize()),this.style.setProperty(`--_dcx-divider-style`,this._getDividerStyle()),this.style.setProperty(`--_dcx-divider-thickness`,`${this.thickness}rem`),this.style.setProperty(`--_dcx-divider-color`,this.color)}render(){return Oe(this)}};l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],D.prototype,`orientation`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],D.prototype,`type`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],D.prototype,`size`,null),l([c({type:Number}),d(`design:type`,Object),d(`design:paramtypes`,[])],D.prototype,`thickness`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],D.prototype,`color`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],D.prototype,`label`,null),l([c({type:String,attribute:`aria-label`}),d(`design:type`,Object),d(`design:paramtypes`,[])],D.prototype,`ariaLabel`,null),D=l([m(`dcx-web-divider`)],D);var ke=n`
  :host {
    display: block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,Ae=t=>{let n=t.items.length,r=n>t.maxVisibleItems,i=[],a=[];r?(i=t.items.slice(0,n-t.maxVisibleItems),a=t.items.slice(-t.maxVisibleItems)):a=t.items;let o=a[a.length-1]||null;return e`
...
`,Me=t=>{if(!t.isOpen)return e``;let n=`dcx-context-menu ${t.positionMode===`absolute`?`dcx-context-menu--absolute`:``}`,r=`top: ${t.top}; left: ${t.left}; opacity: ${t.isPositioned?`1`:`0`};`;return e`
    <div
      class="${n}"
      style="${r}"
  ...
  `},k=class extends i{#e=[];get items(){return this.#e}set items(e){this.#e=e}#t={x:0,y:0};get position(){return this.#t}set position(e){this.#t=e}#n=`fixed`;get positionMode(){return this.#n}set positionMode(e){this.#n=e}#r=!1;get isOpen(){return this.#r}set isOpen(e){this.#r=e}#i=!1;get isPositioned(){return this.#i}set isPositioned(e){this.#i=e}#a=`-9999px`;get top(){return this.#a}set top(e){this.#a=e}#o=`-9999px`;get left(){return this.#o}set left(e){this.#o=e}_openPosition=null;static styles=je;connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this._handleDocumentKeyDown),document.addEventListener(`click`,this._handleDocumentClick),window.addEventListener(`resize`,this._handleWindowResize)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`keydown`,this._handleDocumentKeyDown),document.removeEventListener(`click`,this._handleDocumentClick),window.removeEventListener(`resize`,this._handleWindowResize)}_handleDocumentKeyDown=e=>{e.key===`Escape`&&this.isOpen&&this.close()};_handleDocumentClick=e=>{if(!this.isOpen)return;let t=e.composedPath(),n=this.shadowRoot?.querySelector(`.dcx-context-menu`);n&&t.includes(n)||this.close()};_handleWindowResize=()=>{this.isOpen&&this.calculatePosition()};async open(e){e&&(this._openPosition=e),this.isOpen=!0,await this.updateComplete,this.calculatePosition()}close(){this._openPosition=null,this.isOpen=!1,this.isPositioned=!1,this.dispatchEvent(new CustomEvent(`menu-closed`))}calculatePosition(){let e=this._openPosition??this.position;if(this.positionMode===`absolute`){this.left=`${e.x}px`,this.top=`${e.y}px`,this.isPositioned=!0;return}let t=e.x,n=e.y,r=this.shadowRoot?.querySelector(`.dcx-context-menu`);if(r){let e=r.getBoundingClientRect();if(t+e.width>window.innerWidth-10&&(t=window.innerWidth-10-e.width,t<0&&(t=0)),n+e.height>window.innerHeight-10){let t=n-e.height;n=t>=0?t:10}}let i=0,a=0;if(this.shadowRoot){let e=document.createElement(`div`);e.style.position=`fixed`,e.style.left=`0px`,e.style.top=`0px`,e.style.width=`0px`,e.style.height=`0px`,e.style.visibility=`hidden`,this.shadowRoot.appendChild(e);let t=e.getBoundingClientRect();i=t.left,a=t.top,this.shadowRoot.removeChild(e)}this.left=`${t-i}px`,this.top=`${n-a}px`,this.isPositioned=!0}onItemClick(e,t){t?.stopPropagation(),!(e.disabled||e.divider)&&(e.action&&e.action(),this.dispatchEvent(new CustomEvent(`item-selected`,{detail:e,bubbles:!0,composed:!0})),(!e.children||e.children.length===0)&&this.close())}onItemKeydown(e,t,n){let r=e.children||[];n.key===`ArrowRight`&&r.length>0?(n.preventDefault(),n.currentTarget.querySelector(`.dcx-context-menu__nested [tabindex="0"]`)?.focus()):n.key===`ArrowLeft`?(n.preventDefault(),(n.currentTarget.closest(`.dcx-context-menu__nested`)?.closest(`li`))?.focus()):(n.key===`Enter`||n.key===` `)&&(n.preventDefault(),this.onItemClick(e,n))}renderItem(t,n){if(t.divider)return e`<li class="dcx-context-menu__divider" role="separator"></li>`;let r=t.children&&t.children.length>0,i=[`dcx-context-menu__item`,`dcx-context-menu__item--selectable`,t.disabled?`dcx-context-menu__item--disabled`:``,r?`dcx-context-menu__item--has-children`:``,t.variant===`danger`?`dcx-context-menu__item--danger`:``].filter(Boolean).join(` `);return e`
    ...
    `}render(){return Me(this)}};l([c({type:Array}),d(`design:type`,Array),d(`design:paramtypes`,[])],k.prototype,`items`,null),l([c({type:Object}),d(`design:type`,Object),d(`design:paramtypes`,[])],k.prototype,`position`,null),l([c({type:String}),d(`design:type`,String),d(`design:paramtypes`,[])],k.prototype,`positionMode`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],k.prototype,`isOpen`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],k.prototype,`isPositioned`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],k.prototype,`top`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],k.prototype,`left`,null),k=l([m(`dcx-web-context-menu`)],k);var Ne=n`
  :host {
    display: contents;
  }
...
`,Pe=t=>{if(!t.rendered)return r;let n=[`dcx-drawer`,`dcx-drawer--${t.position}`,t.fullScreen?`dcx-drawer--fullscreen`:``].filter(Boolean),i=[`dcx-drawer-root`,t.closing?`dcx-drawer-root--closing`:``],a=t.modal;return e`
    <div class=${i.filter(Boolean).join(` `)} style="z-index:${t.resolvedZIndex};">
      ...
      <aside
        class=${n.join(` `)}
        role="dialog"
        aria-modal=${t.modal?`true`:r}
        aria-labelledby=${t.header?t.drawerTitleId:r}
  ...
  `},Fe=[`s`,`m`,`l`,`xl`,`auto`],Ie=[`top`,`bottom`,`left`,`right`],Le=[`vertical`,`horizontal`],Re=[`xs`,`s`,`m`,`l`,`xl`],A=`right`,ze=Ie,Be=`22rem`,j=1e3,Ve=`Drawer`,He={open:!1,position:A,modal:!0,dismissible:!0,showCloseIcon:!0,closeOnEscape:!0,blockScroll:!1,fullScreen:!1,size:Be,baseZIndex:j,autoZIndex:!0,header:Ve,footer:``},M,N=class extends i{static{M=this}#e=!1;get open(){return this.#e}set open(e){this.#e=e}#t=A;get position(){return this.#t}set position(e){this.#t=e}#n=!0;get modal(){return this.#n}set modal(e){this.#n=e}#r=!0;get dismissible(){return this.#r}set dismissible(e){this.#r=e}#i=!0;get showCloseIcon(){return this.#i}set showCloseIcon(e){this.#i=e}#a=!0;get closeOnEscape(){return this.#a}set closeOnEscape(e){this.#a=e}#o=!1;get blockScroll(){return this.#o}set blockScroll(e){this.#o=e}#s=!1;get fullScreen(){return this.#s}set fullScreen(e){this.#s=e}#c=Be;get size(){return this.#c}set size(e){this.#c=e}#l=j;get baseZIndex(){return this.#l}set baseZIndex(e){this.#l=e}#u=!0;get autoZIndex(){return this.#u}set autoZIndex(e){this.#u=e}#d=Ve;get header(){return this.#d}set header(e){this.#d=e}#f=``;get footer(){return this.#f}set footer(e){this.#f=e}static styles=Ne;static _instanceCount=0;static _globalZIndex=0;#p=j;get _currentZIndex(){return this.#p}set _currentZIndex(e){this.#p=e}#m=!1;get rendered(){return this.#m}set rendered(e){this.#m=e}#h=!1;get closing(){return this.#h}set closing(e){this.#h=e}_closeTimer;_scrollBlocked=!1;_previousOverflow=``;_hideAlreadyEmitted=!1;_drawerId=`dcx-drawer-${++M._instanceCount}`;_keydownHandler=e=>{!this.open||!this.closeOnEscape||e.key!==`Escape`||this.closeDrawer()};get drawerTitleId(){return`${this._drawerId}-title`}get hasHeader(){return!!(this.header||this.showCloseIcon||this.querySelector(`[slot="drawerHeader"]`))}get hasFooter(){return!!(this.footer||this.querySelector(`[slot="drawerFooter"]`))}get resolvedZIndex(){return this._currentZIndex}get panelWidth(){return this.fullScreen?`100%`:this.position===`left`||this.position===`right`?this.size:null}get panelHeight(){return this.fullScreen?`100%`:this.position===`top`||this.position===`bottom`?this.size:null}connectedCallback(){super.connectedCallback(),this._syncKeydownListener(),this._syncBodyScroll()}disconnectedCallback(){document.removeEventListener(`keydown`,this._keydownHandler),this._scrollBlocked&&=(document.body.style.overflow=this._previousOverflow,document.body.style.paddingRight=``,!1),window.clearTimeout(this._closeTimer),super.disconnectedCallback()}willUpdate(e){e.has(`open`)&&(this.open?(this.closing=!1,this.rendered=!0):this.closing=!0),(e.has(`open`)||e.has(`baseZIndex`)||e.has(`autoZIndex`))&&(this.open&&this.autoZIndex?(M._globalZIndex=Math.max(M._globalZIndex,this.baseZIndex),M._globalZIndex+=2,this._currentZIndex=M._globalZIndex):this._currentZIndex=this.baseZIndex)}updated(e){e.has(`open`)&&(this.open?this.dispatchEvent(new CustomEvent(`dcx-drawer-show`,{bubbles:!0,composed:!0})):(this._hideAlreadyEmitted?this._hideAlreadyEmitted=!1:this.dispatchEvent(new CustomEvent(`dcx-drawer-hide`,{bubbles:!0,composed:!0})),window.clearTimeout(this._closeTimer),this._closeTimer=window.setTimeout(()=>{this.rendered=!1,this.closing=!1,this.requestUpdate()},220))),(e.has(`open`)||e.has(`blockScroll`)||e.has(`modal`))&&this._syncBodyScroll(),(e.has(`open`)||e.has(`closeOnEscape`))&&this._syncKeydownListener()}render(){return Pe(this)}close(){this.closeDrawer()}handleMaskPointerDown=e=>{e.stopPropagation(),this.dismissible&&this.closeDrawer()};closeDrawer=()=>{this.open&&(this._hideAlreadyEmitted=!0,this.dispatchEvent(new CustomEvent(`dcx-drawer-hide`,{bubbles:!0,composed:!0})),this.open=!1,this.dispatchEvent(new CustomEvent(`dcx-drawer-visible-change`,{detail:!1,bubbles:!0,composed:!0})))};_syncBodyScroll(){let e=this.open&&this.modal&&this.blockScroll;if(e&&!this._scrollBlocked){let e=window.innerWidth-document.documentElement.clientWidth;this._previousOverflow=document.body.style.overflow,document.body.style.overflow=`hidden`,e>0&&(document.body.style.paddingRight=`${e}px`),this._scrollBlocked=!0}else!e&&this._scrollBlocked&&(document.body.style.overflow=this._previousOverflow,document.body.style.paddingRight=``,this._scrollBlocked=!1)}_syncKeydownListener(){this.open&&this.closeOnEscape?document.addEventListener(`keydown`,this._keydownHandler):document.removeEventListener(`keydown`,this._keydownHandler)}};l([c({type:Boolean,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],N.prototype,`open`,null),l([c({type:String,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],N.prototype,`position`,null),l([c({type:Boolean,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],N.prototype,`modal`,null),l([c({type:Boolean,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],N.prototype,`dismissible`,null),l([c({type:Boolean,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],N.prototype,`showCloseIcon`,null),l([c({type:Boolean,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],N.prototype,`closeOnEscape`,null),l([c({type:Boolean,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],N.prototype,`blockScroll`,null),l([c({type:Boolean,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],N.prototype,`fullScreen`,null),l([c({type:String,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],N.prototype,`size`,null),l([c({type:Number,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],N.prototype,`baseZIndex`,null),l([c({type:Boolean,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],N.prototype,`autoZIndex`,null),l([c({type:String,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],N.prototype,`header`,null),l([c({type:String,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],N.prototype,`footer`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],N.prototype,`_currentZIndex`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],N.prototype,`rendered`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],N.prototype,`closing`,null),N=M=l([m(`dcx-web-drawer`)],N);var Ue=n`
    :host {
      display: inline-flex;
    }
...
`,We=t=>{let n=`dcx-chip dcx-chip--${t.color}`,i=t.label?`Remover ${t.label}`:`Remover chip`;return e`
    <span
      class=${n}
    ...
    >
      ...
      ${t.chipType===`with-icon`?e`<span class="dcx-chip__icon" aria-hidden="true">${t.renderIcon()}</span>`:r}

      ${t.label?e`<span class="dcx-chip__label">${t.label}</span>`:r}
  ...
  `},P=class extends i{#e=``;get label(){return this.#e}set label(e){this.#e=e}#t=`primary`;get color(){return this.#t}set color(e){this.#t=e}#n=!1;get removable(){return this.#n}set removable(e){this.#n=e}#r=``;get icon(){return this.#r}set icon(e){this.#r=e}#i=``;get image(){return this.#i}set image(e){this.#i=e}#a=`choice`;get variant(){return this.#a}set variant(e){this.#a=e}static styles=Ue;get chipType(){return this.image.trim()?`with-image`:this.icon.trim()?`with-icon`:`label-only`}get showRemove(){return this.variant===`filter`||this.removable}renderIcon(){let t=[`house`,`person`,`gear`,`star`,`code-slash`,`terminal`,`palette`,`book`,`bug`].includes(this.icon)?this.icon:`question-circle`;return e`<dcx-web-icon name=${t}></dcx-web-icon>`}handleRemove(e){e.stopPropagation(),this.showRemove&&this.dispatchEvent(new CustomEvent(`dcx-chip-remove`,{bubbles:!0,composed:!0}))}render(){return We(this)}};l([c({type:String,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],P.prototype,`label`,null),l([c({type:String,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],P.prototype,`color`,null),l([c({type:Boolean,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],P.prototype,`removable`,null),l([c({type:String,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],P.prototype,`icon`,null),l([c({type:String,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],P.prototype,`image`,null),l([c({type:String,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],P.prototype,`variant`,null),P=l([m(`dcx-web-chip`)],P);var Ge=n`
  :host {
    display: block;
    width: 100%;
    box-sizing: border-box;
...
`,Je=t=>{let n={"dcx-datepicker__input-wrapper":!0,"dcx-datepicker__input-wrapper--disabled":t.disabled,"dcx-datepicker__input-wrapper--open":t.isOpen};return e`
                ...
                ${t.isCalendarMode?e`
                      <div class="dcx-datepicker__grid-wrapper">
                        ...
                        >
                          ...
                          <tbody>
                            ${t.calendarWeeks.map(n=>e`
                                <tr role="row">
                                  ${n.map(n=>{let i={"dcx-datepicker__day":!0,"dcx-datepicker__day--other-month":!n.isCurrentMonth,"dcx-datepicker__day--today":n.isToday,"dcx-datepicker__day--selected":n.isSelected,"dcx-datepicker__day--in-range":n.isInRange||!1};return e`
                                      <td
                                        role="gridcell"
                                        aria-selected="${n.isSelected?`true`:r}"
                                        aria-disabled="${n.isDisabled?`true`:r}"
                                        aria-current="${n.isToday?`date`:r}"
                                      >
                                        <dcx-web-button
                                          class="${s(i)}"
                                          variant="terciary"
                                          ...
                                          tabindex="${t.isFocusedDay(n)?0:-1}"
                                          aria-label="${n.date.getDate()} ${t.monthName} ${t.yearNumber}"
                                          @buttonClick="${()=>t.selectDate(n)}"
                                          @keydown="${e=>t.onGridKeydown(e,n)}"
                                        ></dcx-web-button>
                                      </td>
                                    `})}
                                </tr>
...
`,nt=t=>e`
    ${t.label?e`
          ...
          >
            ${t.label}
            ${t.required?e`<span class="dcx-input__required">*</span>`:r}
          </label>
        `:r}
  ...
  `,L=class extends i{#e=`dcx-input-${Math.random().toString(36).substring(2,9)}`;get id(){return this.#e}set id(e){this.#e=e}#t=``;get value(){return this.#t}set value(e){this.#t=e}#n=!1;get disabled(){return this.#n}set disabled(e){this.#n=e}#r=!1;get readonly(){return this.#r}set readonly(e){this.#r=e}#i=``;get placeholder(){return this.#i}set placeholder(e){this.#i=e}#a=te;get type(){return this.#a}set type(e){this.#a=e}#o=``;get name(){return this.#o}set name(e){this.#o=e}#s=!1;get required(){return this.#s}set required(e){this.#s=e}#c=!1;get checked(){return this.#c}set checked(e){this.#c=e}#l=``;get autocomplete(){return this.#l}set autocomplete(e){this.#l=e}#u=``;get inputMode(){return this.#u}set inputMode(e){this.#u=e}#d=!1;get isInvalid(){return this.#d}set isInvalid(e){this.#d=e}#f=``;get label(){return this.#f}set label(e){this.#f=e}#p=``;get hint(){return this.#p}set hint(e){this.#p=e}#m=null;get ariaLabel(){return this.#m}set ariaLabel(e){this.#m=e}#h=null;get ariaDescribedBy(){return this.#h}set ariaDescribedBy(e){this.#h=e}#g=``;get errorMessage(){return this.#g}set errorMessage(e){this.#g=e}#_=ee;get requiredMessage(){return this.#_}set requiredMessage(e){this.#_=e}#v=[];get errorMessages(){return this.#v}set errorMessages(e){this.#v=e}#y=x;get errorIcon(){return this.#y}set errorIcon(e){this.#y=e}#b=`xs`;get spacing(){return this.#b}set spacing(e){this.#b=e}#x=`horizontal`;get orientation(){return this.#x}set orientation(e){this.#x=e}#S=!1;get multiple(){return this.#S}set multiple(e){this.#S=e}#C=_.min;get min(){return this.#C}set min(e){this.#C=e}#w=_.max;get max(){return this.#w}set max(e){this.#w=e}#T=_.step;get step(){return this.#T}set step(e){this.#T=e}#E=!1;get showPassword(){return this.#E}set showPassword(e){this.#E=e}#D=!1;get touched(){return this.#D}set touched(e){this.#D=e}static styles=tt;get labelId(){return`${this.id}-label`}get errorId(){return`${this.id}-error`}get hintId(){return`${this.id}-hint`}get isPasswordType(){return this.type===g.PASSWORD}get isSearchType(){return this.type===g.SEARCH}get isFileType(){return this.type===g.FILE}get isRadioType(){return this.type===g.RADIO}get isRangeType(){return this.type===g.RANGE}get displayType(){return this.isPasswordType?this.showPassword?`text`:`password`:this.isRangeType?`range`:this.type}get showActionIcon(){return(this.isPasswordType||this.isSearchType)&&!this.readonly}get getInputIcon(){return{[g.TEXT]:null,[g.NUMBER]:`pin`,[g.EMAIL]:`mail`,[g.PASSWORD]:null,[g.SEARCH]:`search`,[g.TEL]:`phone`,[g.URL]:`link`,[g.FILE]:null,[g.RADIO]:null,[g.RANGE]:null}[this.type]??null}get describedBy(){let e=[this.ariaDescribedBy,this.hint&&!this.isInvalid?this.hintId:null,this.isInvalid?this.errorId:null].filter(Boolean).join(` `).trim();return e.length?e:null}get showRequiredWarning(){return this.required&&[``,null,void 0].includes(this.value)&&this.touched}get getActionButtonAriaLabel(){return this.isPasswordType?this.showPassword?`Ocultar contraseña`:`Mostrar contraseña`:this.isSearchType?`Buscar`:``}get getActionButtonIcon(){return this.isPasswordType?this.showPassword?`eye-slash-fill`:`eye-fill`:this.isSearchType?`search`:``}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}formatValueByType(e){switch(this.type){case`number`:return e.replace(/[^0-9.-]/g,``)===``?``:parseFloat(e.replace(/[^0-9.-]/g,``));case`email`:return e.toLowerCase();case`tel`:return e.replace(/[^0-9\s\-()]/g,``);case`search`:return e.trim();case`url`:return e.toLowerCase();default:return e}}onInputChange(e){if(this.isRadioType||this.isFileType)return;let t=e.target,n=this.formatValueByType(t.value);this.value=n,this.emit(`valueChange`,n)}onChangeEvent(e){this.isFileType||this.isRadioType&&e.target.checked&&this.emit(`valueChange`,this.value)}onFocusEvent(){this.touched=!1,this.emit(`focusEvent`)}onBlurEvent(){this.touched=!0,this.emit(`blurEvent`)}togglePasswordVisibility(){this.showPassword=!this.showPassword}onActionButtonClick(){if(this.isPasswordType){this.togglePasswordVisibility();return}this.isSearchType&&this.emit(`valueChange`,this.value)}getInputClasses(){let e=[`dcx-input__control`,`dcx-input__control--${this.spacing}`];return this.disabled&&e.push(`is-disabled`,`dcx-input__control--disabled`),this.isInvalid&&e.push(`is-invalid`,`dcx-input__control--invalid`),this.getInputIcon&&e.push(`has-icon`,`dcx-input__control--has-icon`),this.showActionIcon&&e.push(`has-action`,`dcx-input__control--has-action`),e.join(` `)}render(){return nt(this)}};l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`id`,null),l([c({attribute:!1}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`value`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`disabled`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`readonly`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`placeholder`,null),l([c({type:String}),d(`design:type`,g===void 0?Object:g),d(`design:paramtypes`,[])],L.prototype,`type`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`name`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`required`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`checked`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`autocomplete`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`inputMode`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`isInvalid`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`label`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`hint`,null),l([c({type:String,attribute:`aria-label`}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`ariaLabel`,null),l([c({type:String,attribute:`aria-describedby`}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`ariaDescribedBy`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`errorMessage`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`requiredMessage`,null),l([c({attribute:!1}),d(`design:type`,Array),d(`design:paramtypes`,[])],L.prototype,`errorMessages`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`errorIcon`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`spacing`,null),l([c({type:String,reflect:!0}),d(`design:type`,String),d(`design:paramtypes`,[])],L.prototype,`orientation`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`multiple`,null),l([c({type:Number}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`min`,null),l([c({type:Number}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`max`,null),l([c({type:Number}),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`step`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`showPassword`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],L.prototype,`touched`,null),L=l([m(`dcx-web-input`)],L);var rt=t=>e`
    <div
      class="dcx-input-otp__group"
      role="group"
      aria-label="${t.ariaLabel}"
      aria-invalid="${String(t.invalid)}"
      aria-describedby="${t.describedBy??r}"
    >
...
`,ot=t=>e``,z=class extends i{#e=`rectangle`;get shape(){return this.#e}set shape(e){this.#e=e}#t=`100%`;get width(){return this.#t}set width(e){this.#t=e}#n=`1rem`;get height(){return this.#n}set height(e){this.#n=e}#r=null;get size(){return this.#r}set size(e){this.#r=e}#i=null;get borderRadius(){return this.#i}set borderRadius(e){this.#i=e}#a=`wave`;get animation(){return this.#a}set animation(e){this.#a=e}static styles=at;get computedWidth(){return this.size||this.width}get computedHeight(){return this.size||this.height}get computedBorderRadius(){return this.shape===`circle`?`var(--r-pill, 999px)`:this.borderRadius||`var(--r-md, 6px)`}updateHostClassesAndStyles(){this.classList.add(`dcx-skeleton`),this.classList.toggle(`dcx-skeleton--circle`,this.shape===`circle`),this.classList.toggle(`dcx-skeleton--wave`,this.animation===`wave`),this.classList.toggle(`dcx-skeleton--none`,this.animation===`none`),this.style.setProperty(`--dcx-skeleton-width`,this.computedWidth),this.style.setProperty(`--dcx-skeleton-height`,this.computedHeight),this.style.setProperty(`--dcx-skeleton-border-radius`,this.computedBorderRadius)}connectedCallback(){super.connectedCallback(),this.setAttribute(`aria-hidden`,`true`)}firstUpdated(){this.updateHostClassesAndStyles()}updated(){this.updateHostClassesAndStyles()}render(){return ot(this)}};l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],z.prototype,`shape`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],z.prototype,`width`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],z.prototype,`height`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],z.prototype,`size`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],z.prototype,`borderRadius`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],z.prototype,`animation`,null),z=l([m(`dcx-web-skeleton`)],z);var st=n`
  :host {
    display: flex;
    flex-direction: column;
    gap: var(--sp-1, 4px);
...
`,ct=t=>e`
  ...
  ></dcx-web-input>
`,B=class extends i{static styles=st;#e=S.showLabel;get showLabel(){return this.#e}set showLabel(e){this.#e=e}#t=S.textLabel;get textLabel(){return this.#t}set textLabel(e){this.#t=e}#n=S.value;get value(){return this.#n}set value(e){this.#n=e}#r=S.min;get min(){return this.#r}set min(e){this.#r=e}#i=S.max;get max(){return this.#i}set max(e){this.#i=e}#a=S.step;get step(){return this.#a}set step(e){this.#a=e}#o=S.vertical;get vertical(){return this.#o}set vertical(e){this.#o=e}#s=S.disabled;get disabled(){return this.#s}set disabled(e){this.#s=e}#c=null;get ariaLabel(){return this.#c}set ariaLabel(e){this.#c=e}#l=S.valueSuffix;get valueSuffix(){return this.#l}set valueSuffix(e){this.#l=e}#u=0;get valueInput(){return this.#u}set valueInput(e){this.#u=e}willUpdate(e){(e.has(`value`)||e.has(`min`)||e.has(`max`))&&(this.valueInput=this.clamp(this.value))}updated(e){e.has(`vertical`)&&(this.vertical?this.classList.add(`dcx-slider--vertical`):this.classList.remove(`dcx-slider--vertical`)),this.style.setProperty(`--slider-progress`,`${this.progressPercent}%`)}async firstUpdated(){let e=this.shadowRoot?.querySelector(`dcx-web-input`);if(e&&(await e.updateComplete,e.shadowRoot)){let t=document.createElement(`style`);t.textContent=st.cssText,e.shadowRoot.appendChild(t)}}clamp(e){return Math.min(Math.max(e,this.min),this.max)}onInput(e){let t=Number(e.detail);this.valueInput=t,this.value=t,this.dispatchEvent(new CustomEvent(`valueChange`,{detail:t,bubbles:!0,composed:!0}))}get displayValue(){return`${this.valueInput}${this.valueSuffix}`}get effectiveAriaLabel(){return this.ariaLabel||(this.showLabel?this.textLabel:null)}get effectiveAriaValueText(){return this.valueSuffix?this.displayValue:null}get progressPercent(){let e=this.min,t=this.max,n=this.valueInput;return t===e?100:(n-e)/(t-e)*100}render(){return ct(this)}};l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],B.prototype,`showLabel`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],B.prototype,`textLabel`,null),l([c({type:Number}),d(`design:type`,Object),d(`design:paramtypes`,[])],B.prototype,`value`,null),l([c({type:Number}),d(`design:type`,Object),d(`design:paramtypes`,[])],B.prototype,`min`,null),l([c({type:Number}),d(`design:type`,Object),d(`design:paramtypes`,[])],B.prototype,`max`,null),l([c({type:Number}),d(`design:type`,Object),d(`design:paramtypes`,[])],B.prototype,`step`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],B.prototype,`vertical`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],B.prototype,`disabled`,null),l([c({type:String,attribute:`aria-label`}),d(`design:type`,Object),d(`design:paramtypes`,[])],B.prototype,`ariaLabel`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],B.prototype,`valueSuffix`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],B.prototype,`valueInput`,null),B=l([m(`dcx-web-slider`)],B);var lt=t=>e`
    ${t.label?e`
          <label
    ...
    <div class="dcx-select__wrapper">
      <div
        ...
        aria-labelledby="${t.label?t.labelId:r}"
        aria-label="${t.label?r:t.ariaLabel??``}"
        aria-haspopup="listbox"
        aria-controls="${t.selectId}-panel"
        aria-activedescendant="${t.activeDescendant??r}"
        aria-disabled="${t.disabled?`true`:`false`}"
        @click="${t.toggle}"
        @keydown="${t.onKey}"
      >
      ...
      ${t.isOpen?e`
            ...
            >
              ...
              <div class="dcx-select__options">
                ${t.filtered.map((n,i)=>e`
                    <div
                      class="
                        dcx-select__option
                        ${n.disabled?`is-disabled`:``}
                        ${n.value===t.value?`is-selected`:``}
                        ${i===t.activeIndex?`is-active`:``}
                      "
                      role="option"
                      aria-selected="${String(n.value===t.value)}"
                      aria-disabled="${n.disabled?`true`:r}"
                      id="${t.selectId}-opt-${i}"
                      @click="${()=>t.selectOption(n)}"
                    >
                      ${n.label}
                    </div>
                  `)}
      ...
      >
        ${t.steps.map((n,i)=>e`
            <li class="dcx-stepper__item">
              <button
                type="button"
                class="${t.getStepClasses(n)}"
                ?disabled="${n.disabled}"
                aria-current="${t.isActive(n.id)?`step`:r}"
                tabindex="${t.isActive(n.id)?0:-1}"
                @click="${()=>t.onStepClick(n,i)}"
                @keydown="${e=>t.onStepKeydown(e,n,i)}"
              >
                <div
                  class="dcx-stepper__step-indicator"
                >
                  ${n.completed&&!n.error?e`
                        <dcx-web-icon
                          name="check"
            ...
            ${i<t.steps.length-1?e`
                  <div
                    class="dcx-stepper__divider ${n.completed?`dcx-stepper__divider--completed`:``}"
                    aria-hidden="true"
                  ></div>
                `:r}
          `)}
...
`,U=class extends i{#e=``;get body(){return this.#e}set body(e){this.#e=e}#t=`notification`;get type(){return this.#t}set type(e){this.#t=e}#n=``;get title(){return this.#n}set title(e){this.#n=e}#r=``;get link(){return this.#r}set link(e){this.#r=e}#i=!1;get icon(){return this.#i}set icon(e){this.#i=e}#a=``;get iconName(){return this.#a}set iconName(e){this.#a=e}#o=!1;get showClose(){return this.#o}set showClose(e){this.#o=e}#s=!0;get announce(){return this.#s}set announce(e){this.#s=e}#c=!1;get dismissed(){return this.#c}set dismissed(e){this.#c=e}static styles=mt;get messageData(){return{notification:{icon:`info-circle`,role:`status`,ariaLive:`polite`},success:{icon:`check-circle`,role:`status`,ariaLive:`polite`},warning:{icon:`exclamation-triangle`,role:`alert`,ariaLive:`assertive`},error:{icon:`x-circle`,role:`alert`,ariaLive:`assertive`}}[this.type]}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}onClose=()=>{this.dismissed=!0,this.emit(`closed`)};render(){return pt(this)}};l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],U.prototype,`body`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],U.prototype,`type`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],U.prototype,`title`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],U.prototype,`link`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],U.prototype,`icon`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],U.prototype,`iconName`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],U.prototype,`showClose`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],U.prototype,`announce`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],U.prototype,`dismissed`,null),U=l([m(`dcx-web-message`)],U);var ht=n`
  :host {
    display: inline-flex;
  }
...
`,gt=t=>e`
  ...
  `,W=class extends i{#e=!1;get checked(){return this.#e}set checked(e){this.#e=e}#t=!1;get disabled(){return this.#t}set disabled(e){this.#t=e}#n=null;get label(){return this.#n}set label(e){this.#n=e}#r=`m`;get size(){return this.#r}set size(e){this.#r=e}#i=null;get ariaLabel(){return this.#i}set ariaLabel(e){this.#i=e}#a=`right`;get textPosition(){return this.#a}set textPosition(e){this.#a=e}static styles=ht;get effectiveAriaLabel(){return this.ariaLabel||this.label||`Toggle`}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}toggle(){if(this.disabled)return;let e=!this.checked;this.checked=e,this.emit(`toggled`,e)}getToggleClasses(){let e=[`dcx-toggle`,this.size?`dcx-toggle--${this.size}`:``,`dcx-toggle--${this.textPosition}`];return this.disabled&&e.push(`dcx-toggle--disabled`),e.filter(Boolean).join(` `)}render(){return gt(this)}};l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],W.prototype,`checked`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],W.prototype,`disabled`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],W.prototype,`label`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],W.prototype,`size`,null),l([c({type:String,attribute:`aria-label`}),d(`design:type`,Object),d(`design:paramtypes`,[])],W.prototype,`ariaLabel`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],W.prototype,`textPosition`,null),W=l([m(`dcx-web-toggle`)],W);var _t=n`
  :host {
    display: block;
    width: 100%;
  }
    ...
    ${t.isDefaultVariant||t.isSegmentedVariant?e`
          ...
          >
            <div
              ...
              aria-labelledby="${t.showLabel?t.labelId:r}"
              aria-label="${t.showLabel?r:t.ariaLabel||`Progreso`}"
            >
              <div
            ...
            <div class="dcx-progressbar__steps">
              ${t.steps.map((n,i)=>e`
                  <div
                    ...
                    aria-current="${t.isStepActive(i)?`step`:r}"
                  >
                    <div
...
`,G=class extends i{#e=`dcx-progressbar-${Math.random().toString(36).substring(2,9)}`;get id(){return this.#e}set id(e){this.#e=e}#t=`default`;get variant(){return this.#t}set variant(e){this.#t=e}#n=0;get value(){return this.#n}set value(e){this.#n=e}#r=``;get label(){return this.#r}set label(e){this.#r=e}#i=``;get ariaLabel(){return this.#i}set ariaLabel(e){this.#i=e}#a=!1;get showTooltip(){return this.#a}set showTooltip(e){this.#a=e}#o=!1;get showLabel(){return this.#o}set showLabel(e){this.#o=e}#s=[];get steps(){return this.#s}set steps(e){this.#s=e}#c=0;get currentStep(){return this.#c}set currentStep(e){this.#c=e}#l=!1;get showCheckmarks(){return this.#l}set showCheckmarks(e){this.#l=e}#u=5;get segments(){return this.#u}set segments(e){this.#u=e}static styles=_t;get labelId(){return`${this.id}-label`}get progressPercentage(){return Math.min(Math.max(this.value,0),100)}get isStepperVariant(){return this.variant===`stepper`}get isSegmentedVariant(){return this.variant===`segmented`}get isDefaultVariant(){return this.variant==="default"}get segmentArray(){return Array(this.segments).fill(0).map((e,t)=>t)}get stepProgress(){let e=this.steps.length;return e===0?0:this.currentStep/e*100}get stepValueText(){return`Paso ${this.currentStep} de ${this.steps.length}`}isStepCompleted(e){return e<this.currentStep-1}isStepActive(e){return e===this.currentStep-1}render(){return vt(this)}};l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],G.prototype,`id`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],G.prototype,`variant`,null),l([c({type:Number}),d(`design:type`,Object),d(`design:paramtypes`,[])],G.prototype,`value`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],G.prototype,`label`,null),l([c({type:String,attribute:`aria-label`}),d(`design:type`,Object),d(`design:paramtypes`,[])],G.prototype,`ariaLabel`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],G.prototype,`showTooltip`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],G.prototype,`showLabel`,null),l([c({attribute:!1}),d(`design:type`,Array),d(`design:paramtypes`,[])],G.prototype,`steps`,null),l([c({type:Number}),d(`design:type`,Object),d(`design:paramtypes`,[])],G.prototype,`currentStep`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],G.prototype,`showCheckmarks`,null),l([c({type:Number}),d(`design:type`,Object),d(`design:paramtypes`,[])],G.prototype,`segments`,null),G=l([m(`dcx-web-progressbar`)],G);var yt=n`
  :host {
    display: inline-block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,bt=t=>e`
    <fieldset
      ...
      aria-label="${!t.label&&t.ariaLabel?t.ariaLabel:r}"
      aria-describedby="${t.describedBy?t.describedBy:r}"
    >
      ${t.label?e`<legend class="dcx-radio-group__legend">${t.label}</legend>`:``}

      <div class="dcx-radio-group__options">
        ${t.options.map(n=>e`
            <label class="${t.radioClasses(n)}">
              <input
                class="dcx-radio__native"
                type="radio"
                name="${t.name}"
                .value="${n.value}"
                .checked="${t.isChecked(n.value)}"
                ?disabled="${t.isOptionDisabled(n)}"
                aria-invalid="${t.error?`true`:r}"
                @change="${()=>t.onOptionChange(n)}"
                @blur="${t.onBlur}"
              />

              <span class="dcx-radio__control" aria-hidden="true"></span>

              <span class="dcx-radio__label">${n.label}</span>
            </label>
          `)}
      </div>
  ...
  `,K=class extends i{static styles=yt;#e=[];get options(){return this.#e}set options(e){this.#e=e}#t=`dcx-radio-${Math.random().toString(36).substring(2,9)}`;get name(){return this.#t}set name(e){this.#t=e}#n=``;get label(){return this.#n}set label(e){this.#n=e}#r=``;get ariaLabel(){return this.#r}set ariaLabel(e){this.#r=e}#i=`l`;get size(){return this.#i}set size(e){this.#i=e}#a=!1;get disabled(){return this.#a}set disabled(e){this.#a=e}#o=!1;get error(){return this.#o}set error(e){this.#o=e}#s=``;get hint(){return this.#s}set hint(e){this.#s=e}#c=``;get errorMessage(){return this.#c}set errorMessage(e){this.#c=e}#l=null;get value(){return this.#l}set value(e){this.#l=e}groupId=`dcx-radio-group-${Math.random().toString(36).substring(2,9)}`;get hintId(){return`${this.groupId}-hint`}get errorId(){return`${this.groupId}-error`}get isGroupDisabled(){return this.disabled}get showError(){return this.error&&!!this.errorMessage}get showHint(){return!!this.hint&&!this.showError}get describedBy(){return this.showError?this.errorId:this.showHint?this.hintId:null}isChecked(e){return this.value===e}isOptionDisabled(e){return this.isGroupDisabled||!!e.disabled}radioClasses(e){let t=`dcx-radio`;return[t,`${t}--${this.size}`,this.error?`${t}--error`:``,this.isOptionDisabled(e)?`${t}--disabled`:``,this.isChecked(e.value)?`${t}--checked`:``].filter(Boolean).join(` `)}onOptionChange(e){this.isOptionDisabled(e)||(this.value=e.value,this.dispatchEvent(new CustomEvent(`valueChange`,{detail:e.value,bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`change`,{bubbles:!0,composed:!0})))}onBlur(){this.dispatchEvent(new CustomEvent(`blurEvent`,{bubbles:!0,composed:!0}))}render(){return bt(this)}};l([c({type:Array}),d(`design:type`,Array),d(`design:paramtypes`,[])],K.prototype,`options`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],K.prototype,`name`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],K.prototype,`label`,null),l([c({type:String,attribute:`aria-label`}),d(`design:type`,Object),d(`design:paramtypes`,[])],K.prototype,`ariaLabel`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],K.prototype,`size`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],K.prototype,`disabled`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],K.prototype,`error`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],K.prototype,`hint`,null),l([c({type:String,attribute:`error-message`}),d(`design:type`,Object),d(`design:paramtypes`,[])],K.prototype,`errorMessage`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],K.prototype,`value`,null),K=l([m(`dcx-web-radio`)],K);var xt=n`
  :host {
    display: inline-flex;
    position: relative;
  }
...
`,St=t=>e`
    ...
    ${t.visible&&(t.content||t.contentHtml)?e`
        ...
        `:r}
  `,Ct=[`left`,`center`,`right`],wt=[`default`,`primary`],Tt=[`a`,`button`,`input`,`select`,`textarea`],q=class extends i{#e=`top`;get position(){return this.#e}set position(e){this.#e=e}#t=`center`;get arrowAlignment(){return this.#t}set arrowAlignment(e){this.#t=e}#n=!1;get hideTooltipOnClick(){return this.#n}set hideTooltipOnClick(e){this.#n=e}#r=``;get content(){return this.#r}set content(e){this.#r=e}#i=``;get contentHtml(){return this.#i}set contentHtml(e){this.#i=e}#a=`default`;get variant(){return this.#a}set variant(e){this.#a=e}#o=!1;get visible(){return this.#o}set visible(e){this.#o=e}#s=`top`;get actualPosition(){return this.#s}set actualPosition(e){this.#s=e}tooltipId=`dcx-tooltip-${Math.random().toString(36).substring(2,9)}`;static styles=xt;get tooltipClasses(){let e=`dcx-ng-tooltip`;return[e,`${e}--${this.actualPosition}`,`${e}--arrow-${this.arrowAlignment}`,this.variant===`primary`?`${e}--primary`:``].filter(Boolean).join(` `)}get sanitizedHtml(){return this.sanitizeContent(this.contentHtml)}willUpdate(e){super.willUpdate(e),e.has(`position`)&&(this.actualPosition=this.position)}firstUpdated(){this.actualPosition=this.position,this.linkTriggerToTooltip()}linkTriggerToTooltip(){let e=((this.shadowRoot?.querySelector(`slot`))?.assignedElements({flatten:!0})??[])[0];e&&e.setAttribute(`aria-describedby`,this.tooltipId)}sanitizeContent(e){if(!e)return``;let t=new DOMParser().parseFromString(e,`text/html`);return Tt.forEach(e=>{t.body.querySelectorAll(e).forEach(e=>{e.replaceWith(...Array.from(e.childNodes))})}),t.body.innerHTML}show(){this.visible||!this.content&&!this.contentHtml||(this.visible=!0)}hide(){this.visible&&=!1}onMouseEnter(){this.show()}onMouseLeave(){this.hide()}onFocusIn(){this.show()}onFocusOut(){this.hide()}onEscape(){this.hide()}onClick(){this.hideTooltipOnClick&&this.hide()}connectedCallback(){super.connectedCallback(),this.addEventListener(`mouseenter`,this.onMouseEnter),this.addEventListener(`mouseleave`,this.onMouseLeave),this.addEventListener(`focusin`,this.onFocusIn),this.addEventListener(`focusout`,this.onFocusOut),this.addEventListener(`click`,this.onClick),this.addEventListener(`keydown`,e=>{e.key===`Escape`&&this.onEscape()})}render(){return St(this)}};l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],q.prototype,`position`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],q.prototype,`arrowAlignment`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],q.prototype,`hideTooltipOnClick`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],q.prototype,`content`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],q.prototype,`contentHtml`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],q.prototype,`variant`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],q.prototype,`visible`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],q.prototype,`actualPosition`,null),q=l([m(`dcx-web-tooltip`)],q);var Et=t=>e`
  <ul
    id="${t.id||``}"
    class="dcx-list-container"
    role="${t.listRole}"
    aria-label="${t.ariaLabel}"
    aria-multiselectable="${t.multiselectable??r}"
  >
    ${t.items.map((n,i)=>{let a=t.resolveAriaSelected(n,i)===!0;return n.divider?e`
              <li
            ...
            `:e`
              <li
                class="${t.getItemClasses(n,i)}"
                @click="${()=>t.onItemClick(n,i)}"
                @keydown="${e=>t.onKeydown(e,n,i)}"
                tabindex="${t.selectable&&!n.disabled?`0`:`-1`}"
                role="${t.itemRole}"
                aria-selected="${t.resolveAriaSelected(n,i)??r}"
                aria-disabled="${n.disabled||r}"
                aria-haspopup="${t.getChildren(n).length>0?`menu`:r}"
              >
                ${t.itemTemplate?t.itemTemplate({item:n,index:i,selected:a}):e`
                      <div class="dcx-list-item-content">
                        ...
                        ${t.showChildrenIndicator&&t.getChildren(n).length>0?e`
                              <dcx-web-icon
                ...
                ${t.renderChildren&&t.getChildren(n).length>0?e`
                      <dcx-web-list
                        class="dcx-list-nested ${t.isSelected(i)?`parent-selected`:``}"
                        .items="${t.getChildren(n)}"
...
`,J=class extends i{#e=[];get items(){return this.#e}set items(e){this.#e=e}#t=!1;get selectable(){return this.#t}set selectable(e){this.#t=e}#n=!1;get multiSelect(){return this.#n}set multiSelect(e){this.#n=e}#r=!1;get showChildrenIndicator(){return this.#r}set showChildrenIndicator(e){this.#r=e}#i=!0;get renderChildren(){return this.#i}set renderChildren(e){this.#i=e}#a=null;get itemTemplate(){return this.#a}set itemTemplate(e){this.#a=e}#o=``;get id(){return this.#o}set id(e){this.#o=e}#s=`Lista de elementos`;get ariaLabel(){return this.#s}set ariaLabel(e){this.#s=e}#c=`list`;get listRole(){return this.#c}set listRole(e){this.#c=e}#l=`listitem`;get itemRole(){return this.#l}set itemRole(e){this.#l=e}#u=null;get multiselectable(){return this.#u}set multiselectable(e){this.#u=e}#d=!1;get externalSelection(){return this.#d}set externalSelection(e){this.#d=e}#f=null;get isItemSelected(){return this.#f}set isItemSelected(e){this.#f=e}#p=!1;get cdkDropList(){return this.#p}set cdkDropList(e){this.#p=e}#m=[];get cdkDropListData(){return this.#m}set cdkDropListData(e){this.#m=e}#h=null;get cdkDropListConnectedTo(){return this.#h}set cdkDropListConnectedTo(e){this.#h=e}#g=!1;get cdkDropListDisabled(){return this.#g}set cdkDropListDisabled(e){this.#g=e}#_=!1;get dragEnabled(){return this.#_}set dragEnabled(e){this.#_=e}#v=e=>!1;get cdkDragDisabled(){return this.#v}set cdkDragDisabled(e){this.#v=e}#y=[];get selectedIndices(){return this.#y}set selectedIndices(e){this.#y=e}static styles=Dt;emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}getChildren(e){return e.children??[]}isSelected(e){return this.selectable?this.selectedIndices.includes(e):!1}resolveAriaSelected(e,t){return this.isItemSelected?this.isItemSelected(e,t):this.selectable&&!this.externalSelection?this.isSelected(t):null}onItemClick(e,t){if(!(!this.selectable||e.disabled||e.divider)){if(this.externalSelection){this.emit(`itemSelected`,{item:e,index:t});return}if(this.multiSelect){this.isSelected(t)?(this.selectedIndices=this.selectedIndices.filter(e=>e!==t),this.emit(`itemDeselected`,{item:e,index:t})):(this.selectedIndices=[...this.selectedIndices,t],this.emit(`itemSelected`,{item:e,index:t}));return}if(this.isSelected(t)){this.selectedIndices=[],this.emit(`itemDeselected`,{item:e,index:t});return}this.selectedIndices=[t],this.emit(`itemSelected`,{item:e,index:t})}}onKeydown(e,t,n){let r=this.getChildren(t);(e.key===`Enter`||e.key===` `)&&!t.disabled&&(e.preventDefault(),this.onItemClick(t,n)),e.key===`ArrowRight`&&r.length&&(e.preventDefault(),e.currentTarget.querySelector(`.dcx-list-nested [tabindex="0"]`)?.focus()),e.key===`ArrowLeft`&&(e.preventDefault(),(e.currentTarget.closest(`.dcx-list-nested`)?.closest(`li`))?.focus())}getItemClasses(e,t){let n=[`dcx-list-item`];return this.selectable&&n.push(`selectable`),this.isSelected(t)&&n.push(`selected`),e.disabled&&n.push(`disabled`),e.children&&e.children.length&&n.push(`has-children`),e.variant===`danger`&&n.push(`danger`),n.join(` `)}render(){return Et(this)}};l([c({attribute:!1}),d(`design:type`,Array),d(`design:paramtypes`,[])],J.prototype,`items`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`selectable`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`multiSelect`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`showChildrenIndicator`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`renderChildren`,null),l([c({attribute:!1}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`itemTemplate`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`id`,null),l([c({type:String,attribute:`aria-label`}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`ariaLabel`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`listRole`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`itemRole`,null),l([c({attribute:!1}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`multiselectable`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`externalSelection`,null),l([c({attribute:!1}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`isItemSelected`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`cdkDropList`,null),l([c({attribute:!1}),d(`design:type`,Array),d(`design:paramtypes`,[])],J.prototype,`cdkDropListData`,null),l([c({attribute:!1}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`cdkDropListConnectedTo`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`cdkDropListDisabled`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`dragEnabled`,null),l([c({attribute:!1}),d(`design:type`,Object),d(`design:paramtypes`,[])],J.prototype,`cdkDragDisabled`,null),l([o(),d(`design:type`,Array),d(`design:paramtypes`,[])],J.prototype,`selectedIndices`,null),J=l([m(`dcx-web-list`)],J);var Ot=n`
  :host {
    display: block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,kt=t=>e`
    ${t.label?e`
          <label class="dcx-editor__label" id="${t.id}-label">
            ${t.label}
            ${t.required?e`<span class="dcx-editor__required">*</span>`:r}
          </label>
        `:r}
    ...
    <div class="dcx-editor ${t.isDisabled?`is-disabled`:``}">
      ...
      <div
        ...
        tabindex="${t.isDisabled||t.readonly?r:`0`}"
        data-placeholder="${t.placeholder}"
        aria-labelledby="${t.label?`${t.id}-label`:r}"
        aria-label="${t.label?r:t.ariaLabel??r}"
        aria-required="${t.required?`true`:r}"
        aria-invalid="${String(t.isInvalid)}"
        aria-describedby="${t.describedBy??r}"
...
`,jt=t=>e`
  <div class="${t.getWrapperClasses()}">
    ${t.label?e`
          <label
            class="dcx-textarea__label
            ${t.invalid?`dcx-textarea__label--invalid`:``}
            ${t.disabled?`dcx-textarea__label--disabled`:``}"
            for="${t.id}"
          >
            ${t.label}
            ${t.required?e`
    ...
    <textarea
      ...
      ?disabled=${t.disabled}
      ?readonly=${t.readonly}
      style=${ne({resize:t.computedResize,height:t._autoHeight||``})}
      maxlength=${t.maxLength??r}
      aria-label=${t.label?r:t.ariaLabel??r}
  ...
  ${t.showHint?e`
      ...
      `:r}
`,X=class extends i{textareaElement;#e=``;get value(){return this.#e}set value(e){this.#e=e}#t=5;get rows(){return this.#t}set rows(e){this.#t=e}#n=30;get cols(){return this.#n}set cols(e){this.#n=e}#r=``;get placeholder(){return this.#r}set placeholder(e){this.#r=e}#i=!1;get disabled(){return this.#i}set disabled(e){this.#i=e}#a=!1;get readonly(){return this.#a}set readonly(e){this.#a=e}#o=!1;get autoResize(){return this.#o}set autoResize(e){this.#o=e}#s=void 0;get floatLabel(){return this.#s}set floatLabel(e){this.#s=e}#c=``;get label(){return this.#c}set label(e){this.#c=e}#l=`normal`;get size(){return this.#l}set size(e){this.#l=e}#u=!1;get fluid(){return this.#u}set fluid(e){this.#u=e}#d=!1;get filled(){return this.#d}set filled(e){this.#d=e}#f=!1;get invalid(){return this.#f}set invalid(e){this.#f=e}#p=``;get errorMessage(){return this.#p}set errorMessage(e){this.#p=e}#m=`dcx-textarea-${Math.random().toString(36).substring(2,9)}`;get id(){return this.#m}set id(e){this.#m=e}#h=null;get ariaLabel(){return this.#h}set ariaLabel(e){this.#h=e}#g=null;get ariaDescribedBy(){return this.#g}set ariaDescribedBy(e){this.#g=e}#_=!1;get required(){return this.#_}set required(e){this.#_=e}#v=``;get hint(){return this.#v}set hint(e){this.#v=e}#y=null;get maxLength(){return this.#y}set maxLength(e){this.#y=e}#b=!0;get resizable(){return this.#b}set resizable(e){this.#b=e}#x=!1;get focused(){return this.#x}set focused(e){this.#x=e}#S=``;get _autoHeight(){return this.#S}set _autoHeight(e){this.#S=e}static styles=At;get errorId(){return`${this.id}-error`}get hintId(){return`${this.id}-hint`}get showError(){return this.invalid&&!!this.errorMessage}get showHint(){return!!this.hint&&!this.showError}get describedBy(){return[this.ariaDescribedBy,this.showError?this.errorId:null,this.showHint?this.hintId:null].filter(Boolean).join(` `).trim()||null}get computedResize(){return!this.autoResize&&this.resizable?`vertical`:`none`}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}getTextareaClasses(){return[`dcx-textarea__control`,this.autoResize&&`dcx-textarea__control--autoresize`,this.size!==`normal`&&`dcx-textarea__control--${this.size}`,this.filled&&`dcx-textarea__control--filled`,this.invalid&&`dcx-textarea__control--invalid`].filter(Boolean).join(` `)}getWrapperClasses(){return[`dcx-textarea__wrapper`,this.fluid&&`dcx-textarea__wrapper--fluid`,this.floatLabel&&`dcx-textarea__wrapper--float`,this.floatLabel&&`dcx-textarea__wrapper--${this.floatLabel}`,this.floatLabel&&this.focused&&`dcx-textarea__wrapper--active`].filter(Boolean).join(` `)}onInput=e=>{let t=e.target;this.value=t?.value??``,this.emit(`valueChange`,this.value),this.syncTextareaSize()};onFocus=()=>{this.focused=!0};onBlur=()=>{this.focused=!1};firstUpdated(){this.syncTextareaSize()}updated(e){super.updated(e),e.has(`autoResize`)&&this.syncTextareaSize()}syncTextareaSize(){let e=this.renderRoot?.querySelector(`textarea`);if(!e)return;if(!this.autoResize){this._autoHeight=``;return}e.style.height=`auto`;let t=parseFloat(getComputedStyle(e).minHeight),n=Math.max(e.scrollHeight,t);this._autoHeight=`${n}px`}render(){return jt(this)}};l([oe(`textarea`),d(`design:type`,typeof HTMLTextAreaElement>`u`?Object:HTMLTextAreaElement)],X.prototype,`textareaElement`,void 0),l([c({attribute:!1}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`value`,null),l([c({type:Number}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`rows`,null),l([c({type:Number}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`cols`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`placeholder`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`disabled`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`readonly`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`autoResize`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`floatLabel`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`label`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`size`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`fluid`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`filled`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`invalid`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`errorMessage`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`id`,null),l([c({type:String,attribute:`aria-label`}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`ariaLabel`,null),l([c({type:String,attribute:`aria-describedby`}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`ariaDescribedBy`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`required`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`hint`,null),l([c({attribute:!1}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`maxLength`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`resizable`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`focused`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],X.prototype,`_autoHeight`,null),X=l([m(`dcx-web-textarea`)],X);var Mt=n`
  :host {
    position: fixed;
    right: var(--sp-6, 24px);
...
`,Z=class extends i{#e=null;get container(){return this.#e}set container(e){this.#e=e}#t=!0;get smooth(){return this.#t}set smooth(e){this.#t=e}#n=`m`;get size(){return this.#n}set size(e){this.#n=e}#r=`s`;get iconSize(){return this.#r}set iconSize(e){this.#r=e}#i=!0;get showTop(){return this.#i}set showTop(e){this.#i=e}#a=!0;get showBottom(){return this.#a}set showBottom(e){this.#a=e}#o=`Ir arriba`;get topLabel(){return this.#o}set topLabel(e){this.#o=e}#s=`Ir abajo`;get bottomLabel(){return this.#s}set bottomLabel(e){this.#s=e}#c=`chevron-up`;get topIcon(){return this.#c}set topIcon(e){this.#c=e}#l=`chevron-down`;get bottomIcon(){return this.#l}set bottomIcon(e){this.#l=e}#u=`Controles de desplazamiento`;get groupLabel(){return this.#u}set groupLabel(e){this.#u=e}#d=!0;get isAtTop(){return this.#d}set isAtTop(e){this.#d=e}#f=!1;get isAtBottom(){return this.#f}set isAtBottom(e){this.#f=e}scrollTargetRef=window;handleScroll=()=>{this.updateScrollState()};static styles=Mt;connectedCallback(){super.connectedCallback(),this.registerListeners()}disconnectedCallback(){this.unregisterListeners(),super.disconnectedCallback()}updated(e){e.has(`container`)&&(this.unregisterListeners(),this.registerListeners())}get isTopVisible(){return this.showTop&&!this.isAtTop}get isBottomVisible(){return this.showBottom&&!this.isAtBottom}get scrollClasses(){let e=`dcx-scroll-top-down`,t=this.isTopVisible&&!this.isBottomVisible,n=this.isBottomVisible&&!this.isTopVisible;return[e,`${e}--${this.size}`,t?`${e}--top-only`:``,n?`${e}--bottom-only`:``,!this.isTopVisible&&!this.isBottomVisible?`${e}--hidden`:``].filter(Boolean).join(` `)}buttonClasses(e){let t=`dcx-scroll-top-down__button`;return`${t} ${t}--${this.size} ${t}--${e}`}scrollBehavior(){return this.smooth&&!this.prefersReducedMotion()?`smooth`:`auto`}prefersReducedMotion(){return typeof window<`u`&&typeof window.matchMedia==`function`&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches}scrollToTop=()=>{let e=this.scrollTarget();if(e===window){window.scrollTo({top:0,behavior:this.scrollBehavior()});return}this.scrollElement(e,0)};scrollToBottom=()=>{let e=this.scrollTarget();if(e===window){let e=document.documentElement,t=document.body,n=Math.max(e.scrollHeight,t?.scrollHeight??0);window.scrollTo({top:n,behavior:this.scrollBehavior()});return}let t=e,n=Math.max(t.scrollHeight-t.clientHeight,0);this.scrollElement(t,n)};registerListeners(){this.scrollTargetRef=this.scrollTarget(),this.scrollTargetRef.addEventListener(`scroll`,this.handleScroll,{passive:!0}),window.addEventListener(`resize`,this.handleScroll,{passive:!0}),this.updateScrollState()}unregisterListeners(){this.scrollTargetRef.removeEventListener(`scroll`,this.handleScroll),window.removeEventListener(`resize`,this.handleScroll)}updateScrollState(){let e=this.scrollTarget(),t=0,n=0,r=0;if(e===window)t=window.scrollY||document.documentElement.scrollTop,n=document.documentElement.scrollHeight,r=document.documentElement.clientHeight;else{let i=e;t=i.scrollTop,n=i.scrollHeight,r=i.clientHeight}this.isAtTop=t<=0,this.isAtBottom=t+r>=n-1}scrollTarget(){return this.container??window}scrollElement(e,t){if(typeof e.scrollTo==`function`){e.scrollTo({top:t,behavior:this.scrollBehavior()});return}e.scrollTop=t}render(){return Nt(this)}};l([c({attribute:!1}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`container`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`smooth`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`size`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`iconSize`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`showTop`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`showBottom`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`topLabel`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`bottomLabel`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`topIcon`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`bottomIcon`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`groupLabel`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`isAtTop`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`isAtBottom`,null),Z=l([m(`dcx-web-scroll-top-down`)],Z);var Pt=n`
  :host {
    display: inline-block;
    font-family: var(
      --ff-base,
...
`,Ft=t=>e`
    <div
      class="${t.spinnerClasses()}"
      role="status"
      aria-live="polite"
      aria-label="${t.computedAriaLabel}"
    >
      ${t.wrapper?e`
            <slot></slot>
  ...
  `,Q=class extends i{#e=`m`;get size(){return this.#e}set size(e){this.#e=e}#t=!1;get wrapper(){return this.#t}set wrapper(e){this.#t=e}#n=``;get title(){return this.#n}set title(e){this.#n=e}#r=``;get description(){return this.#r}set description(e){this.#r=e}#i=1300;get delay(){return this.#i}set delay(e){this.#i=e}#a=null;get color(){return this.#a}set color(e){this.#a=e}#o=null;get ariaLabel(){return this.#o}set ariaLabel(e){this.#o=e}#s=!1;get visible(){return this.#s}set visible(e){this.#s=e}timeoutId=null;static styles=Pt;get computedAriaLabel(){return this.ariaLabel||this.title||`Cargando…`}get hasContent(){return!!(this.title||this.description)}spinnerClasses(){let e=`dcx-spinner`;return[e,`${e}--${this.size}`,this.wrapper?`${e}--wrapper`:``].filter(Boolean).join(` `)}startDelayTimer(){if(this.timeoutId!==null&&(clearTimeout(this.timeoutId),this.timeoutId=null),this.delay<=0){this.visible=!0;return}this.visible=!1,this.timeoutId=setTimeout(()=>{this.visible=!0},this.delay)}connectedCallback(){super.connectedCallback(),this.startDelayTimer()}willUpdate(e){e.has(`delay`)&&this.startDelayTimer()}disconnectedCallback(){this.timeoutId!==null&&clearTimeout(this.timeoutId),super.disconnectedCallback()}render(){return this.style.setProperty(`--dcx-spinner-delay`,`${this.delay}ms`),this.color?this.style.setProperty(`--dcx-spinner-color`,this.color):this.style.removeProperty(`--dcx-spinner-color`),Ft(this)}};l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],Q.prototype,`size`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],Q.prototype,`wrapper`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],Q.prototype,`title`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],Q.prototype,`description`,null),l([c({type:Number}),d(`design:type`,Object),d(`design:paramtypes`,[])],Q.prototype,`delay`,null),l([c({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],Q.prototype,`color`,null),l([c({type:String,attribute:`aria-label`}),d(`design:type`,Object),d(`design:paramtypes`,[])],Q.prototype,`ariaLabel`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],Q.prototype,`visible`,null),Q=l([m(`dcx-web-spinner`)],Q);var It=n`
  :host {
    display: block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,Lt=(e,t,n)=>{let r=new Map;for(let i=t;i<=n;i++)r.set(e[i],i);return r},Rt=a(class extends u{constructor(e){if(super(e),e.type!==f.CHILD)throw Error(`repeat() can only be used in text expressions`)}dt(e,t,n){let r;n===void 0?n=t:t!==void 0&&(r=t);let i=[],a=[],o=0;for(let t of e)i[o]=r?r(t,o):o,a[o]=n(t,o),o++;return{values:a,keys:i}}render(e,t,n){return this.dt(e,t,n).values}update(e,[n,r,i]){let a=ie(e),{values:o,keys:s}=this.dt(n,r,i);if(!Array.isArray(a))return this.ut=s,o;let c=this.ut??=[],l=[],u,d,f=0,p=a.length-1,m=0,h=o.length-1;for(;f<=p&&m<=h;)if(a[f]===null)f++;else if(a[p]===null)p--;else if(c[f]===s[m])l[m]=v(a[f],o[m]),f++,m++;else if(c[p]===s[h])l[h]=v(a[p],o[h]),p--,h--;else if(c[f]===s[h])l[h]=v(a[f],o[h]),b(e,l[h+1],a[f]),f++,h--;else if(c[p]===s[m])l[m]=v(a[p],o[m]),b(e,a[f],a[p]),p--,m++;else if(u===void 0&&(u=Lt(s,m,h),d=Lt(c,f,p)),u.has(c[f])){if(u.has(c[p])){let t=d.get(s[m]),n=t===void 0?null:a[t];if(n===null){let t=b(e,a[f]);v(t,o[m]),l[m]=t}else l[m]=v(n,o[m]),b(e,a[f],n),a[t]=null;m++}else y(a[p]),p--}else y(a[f]),f++;for(;m<=h;){let t=b(e,l[h+1]);v(t,o[m]),l[m++]=t}for(;f<=p;){let e=a[f++];e!==null&&y(e)}return this.ut=s,re(e,l),t}}),zt=t=>{let n=t.visiblePages;return e`
    <div class="dcx-paginator">
      <div class="dcx-paginator__row-meta">
        <div class="dcx-paginator__size">
          ${t.showItemsPerPageInfo?e`
                <label
                ...
                <select
                  ...
                  .value="${String(t.selectedItemsPerPage)}"
                  @change="${t.onItemsPerPageSelect}"
                >
                  ${t.pageSizeOptions.map(t=>e`
                      <option value="${t}">
                        ${t}
                      </option>
                    `)}
        ...
        >
          ${t.limitedButtons?e`
                <dcx-web-button
                  class="${t.prevNavClasses}"
                  variant="text"
                  .icon="${!0}"
                  icon-name="chevron-double-left"
                  icon-size="m"
                  aria-label="Primera página"
                  ?disabled="${!t.hasPrevious}"
                  @buttonClick="${t.goToStart}"
                >
                </dcx-web-button>
              `:null}
          ...
          <dcx-web-button
            ...
            ?disabled="${!t.hasPrevious}"
            @buttonClick="${t.goToPrevious}"
          >
          </dcx-web-button>

          ${Rt(n,(e,t)=>typeof e==`number`?e:t===1?`ellipsis-left`:`ellipsis-right`,(r,i)=>t.isEllipsis(r)?e`
                      <dcx-web-button
                        class="dcx-paginator__ellipsis"
                        label="..."
                        size="m"
                        variant="text"
                        aria-label="${t.getEllipsisDirection(i,n)<0?`Saltar páginas hacia atrás`:`Saltar páginas hacia adelante`}"
                        @buttonClick="${()=>t.goToPageRelative(t.getEllipsisDirection(i,n))}"
                      >
                      </dcx-web-button>
                    `:e`
                      <dcx-web-button
                        class="${t.getPageButtonClasses(r)}"
                        size="m"
                        .variant="${t.getButtonVariant(t.getPageNumber(r))}"
                        aria-label="${t.getPageAriaLabel(t.getPageNumber(r))}"
                        label="${t.getButtonLabel(t.getPageNumber(r))}"
                        @buttonClick="${()=>t.goToPage(t.getPageNumber(r))}"
                      >
                      </dcx-web-button>
                    `)}

          <dcx-web-button
            class="${t.nextNavClasses}"
            variant="text"
            .icon="${!0}"
      ...
      ${t.showPageInfo?e`
            <div
              ...
              aria-live="polite"
            >
              Página ${t.currentPage} de ${t.totalPages}
            </div>
          `:null}
    </div>
  `},$=class extends i{#e={totalItems:100,itemsPerPage:10,currentPage:1};get paginator(){return this.#e}set paginator(e){this.#e=e}#t=!1;get showPageInfo(){return this.#t}set showPageInfo(e){this.#t=e}#n=!1;get showItemsPerPageInfo(){return this.#n}set showItemsPerPageInfo(e){this.#n=e}#r=!1;get limitedButtons(){return this.#r}set limitedButtons(e){this.#r=e}#i=[5,10,20];get pageSizeOptions(){return this.#i}set pageSizeOptions(e){this.#i=e}#a=10;get selectedItemsPerPage(){return this.#a}set selectedItemsPerPage(e){this.#a=e}#o=1;get currentPage(){return this.#o}set currentPage(e){this.#o=e}static styles=It;willUpdate(e){if(e.has(`paginator`)){this.selectedItemsPerPage=this.paginator.itemsPerPage;let e=Math.max(1,Math.min(this.paginator.currentPage,this.totalPages));this.currentPage=e}this.emit(`totalPagesChange`,this.totalPages)}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}get totalPages(){return Math.ceil(this.paginator.totalItems/this.selectedItemsPerPage)}get hasPrevious(){return this.currentPage>1}get hasNext(){return this.currentPage<this.totalPages}get prevNavClasses(){return this.hasPrevious?`dcx-paginator__button`:`dcx-paginator__button--disabled`}get nextNavClasses(){return this.hasNext?`dcx-paginator__button`:`dcx-paginator__button--disabled`}get firstItem(){return(this.currentPage-1)*this.selectedItemsPerPage+1}get lastItem(){return Math.min(this.currentPage*this.selectedItemsPerPage,this.paginator.totalItems)}get visiblePages(){return this.calculateVisiblePages()}goToPrevious=()=>{this.hasPrevious&&(this.currentPage--,this.emit(`pageChange`,this.currentPage))};goToNext=()=>{this.hasNext&&(this.currentPage++,this.emit(`pageChange`,this.currentPage))};goToPage(e){this.currentPage=e,this.emit(`pageChange`,e)}goToStart=()=>{this.goToPage(1)};goToEnd=()=>{this.goToPage(this.totalPages)};goToPageRelative(e){let t=this.currentPage+3*e,n=Math.max(1,Math.min(t,this.totalPages));this.goToPage(n)}getCurrentPage(e){return this.currentPage===e}getPageButtonClasses(e){let t=this.getPageNumber(e);return this.getCurrentPage(t)?`dcx-paginator__page--current`:`dcx-paginator__page`}getButtonVariant(e){return this.currentPage===e?`primary`:`text`}getPageAriaCurrent(e){return this.currentPage===e?`page`:null}getPageAriaLabel(e){return this.currentPage===e?`Página ${e}, página actual`:`Ir a la página ${e}`}getButtonLabel(e){return e.toString()}getPageNumber(e){return typeof e==`number`?e:0}isEllipsis(e){return e===`...`}getEllipsisDirection(e,t){let n=t.findIndex(e=>e===this.currentPage);return n===-1?1:e<n?-1:1}onItemsPerPageSelect(e){let t=e.target.value;this.onItemsPerPageChange(t)}onItemsPerPageChange(e){let t=Number(e);if(!Number.isFinite(t)||t<=0)return;this.selectedItemsPerPage=t;let n=Math.max(1,Math.min(this.currentPage,this.totalPages));n!==this.currentPage&&(this.currentPage=n,this.emit(`pageChange`,n)),this.emit(`itemsPerPageChange`,t),this.emit(`totalPagesChange`,this.totalPages)}calculateVisiblePages(){let e=this.totalPages,t=this.currentPage;if(e<=1)return[1];if(e<=7)return Array.from({length:e},(e,t)=>t+1);let n=e-5,r=Math.max(2,Math.min(t-2,n)),i=r+5-1,a=[];a.push(1),r>2&&a.push(`...`);for(let e=r;e<=i;e++)a.push(e);return i<e-1&&a.push(`...`),a.push(e),a}render(){return zt(this)}};l([c({attribute:!1}),d(`design:type`,Object),d(`design:paramtypes`,[])],$.prototype,`paginator`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],$.prototype,`showPageInfo`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],$.prototype,`showItemsPerPageInfo`,null),l([c({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],$.prototype,`limitedButtons`,null),l([c({attribute:!1}),d(`design:type`,Array),d(`design:paramtypes`,[])],$.prototype,`pageSizeOptions`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],$.prototype,`selectedItemsPerPage`,null),l([o(),d(`design:type`,Object),d(`design:paramtypes`,[])],$.prototype,`currentPage`,null),$=l([m(`dcx-web-paginator`)],$);export{pe as C,le as S,ce as _,He as a,se as b,Ie as c,ve as d,me as f,fe as g,S as h,$e as i,Fe as l,ge as m,wt as n,ze as o,he as p,et as r,Le as s,Ct as t,Re as u,x as v,oe as w,ue as x,de as y};
import{a as e,l as t,n,t as r}from"./lit-C11zoK0j.js";import{c as i,i as a,l as o,n as s,r as c,t as ee,u as l}from"./dcx-web-button.component-D3Abov5f.js";import{_ as te,a as u,g as ne,n as re,r as d,t as ie}from"./defaults-BS9BWamO.js";var ae=[`vertical`,`horizontal`],oe=[`start`,`center`,`end`],se=[`s`,`m`,`l`,`xl`,`auto`],ce=[`top`,`bottom`,`left`,`right`],le=`vertical`,f=`center`,ue=[`xs`,`s`,`m`,`l`,`xl`],p=`info-circle`,m={showLabel:!0,textLabel:`Value`,value:0,step:1,vertical:!1,min:0,max:50,disabled:!1,valueSuffix:``},de=`Select`,fe=[{value:`one`,label:`Uno`},{value:`two`,label:`Dos`},{value:`three`,label:`Tres`}],h=`Seleccione una opción`,pe=`160px`,g=[`bold`,`italic`,`underline`,`orderedList`,`unorderedList`,`removeFormat`],me=t`
  :host {
    display: inline-flex;
  }
...
`,he=t=>{let n=`dcx-badge dcx-badge--${t.severity} dcx-badge--${t.size}`;return e`
    ...
    >${t.value}</span>
  `},_=class extends r{#e=``;get value(){return this.#e}set value(e){this.#e=e}#t=`primary`;get severity(){return this.#t}set severity(e){this.#t=e}#n=`md`;get size(){return this.#n}set size(e){this.#n=e}#r=null;get ariaLabel(){return this.#r}set ariaLabel(e){this.#r=e}#i=!1;get ariaHiddenAttr(){return this.#i}set ariaHiddenAttr(e){this.#i=e}#a=null;get roleAttr(){return this.#a}set roleAttr(e){this.#a=e}static styles=me;getComputedAriaLabel(){if(this.ariaHiddenAttr)return null;if(this.ariaLabel!==null)return this.ariaLabel;let e=this.value;return e?`${e}, ${this.severity}`:this.severity}render(){return he(this)}};s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],_.prototype,`value`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],_.prototype,`severity`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],_.prototype,`size`,null),s([o({type:String,attribute:`aria-label`}),c(`design:type`,Object),c(`design:paramtypes`,[])],_.prototype,`ariaLabel`,null),s([o({type:Boolean,attribute:`aria-hidden`}),c(`design:type`,Object),c(`design:paramtypes`,[])],_.prototype,`ariaHiddenAttr`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],_.prototype,`roleAttr`,null),_=s([l(`dcx-web-badge`)],_);var ge=t`
  :host {
    display: block;
  }
...
`,ye=t=>e`
    ...
    >
      <div class="${t.innerClasses}" style="${te(t.innerStyles)}">
        ${t.image?e`
...
`,xe=t=>e`
  ...
  `,b=class extends r{static styles=be;#e=[];get options(){return this.#e}set options(e){this.#e=e}errorIcon=`exclamation-circle-fill`;_getValue(e){return e===!0?!1:e!==!1||null}_normalizeValue(e){return e===!0||e!==!1&&null}getVariant(e){return this._normalizeValue(e.value)===null?`secondary`:`primary`}getIconName(e){let t=this._normalizeValue(e.value);return t===!0?`check`:t===!1?`dash`:``}getAriaChecked(e){let t=this._normalizeValue(e.value);return t===!0?`true`:t===!1?`mixed`:`false`}changeValue(e){let t=this.options.map(t=>t.id===e?{...t,value:this._getValue(t.value)}:t);this.dispatchEvent(new CustomEvent(`changeOptions`,{detail:t,bubbles:!0,composed:!0}))}renderLabel(t){return e`
      ...
      ${t.required?e`
          ...
          `:``}
    `}render(){return xe(this)}};s([o({attribute:!1}),c(`design:type`,Array),c(`design:paramtypes`,[])],b.prototype,`options`,null),b=s([l(`dcx-web-checkbox`)],b);var Se=t`
  :host {
    display: block;
  }
...
`,De=t=>{if(!t.isOpen)return e``;let n=`dcx-context-menu ${t.positionMode===`absolute`?`dcx-context-menu--absolute`:``}`,r=`top: ${t.top}; left: ${t.left}; opacity: ${t.isPositioned?`1`:`0`};`;return e`
  ...
  `},C=class extends r{#e=[];get items(){return this.#e}set items(e){this.#e=e}#t={x:0,y:0};get position(){return this.#t}set position(e){this.#t=e}#n=`fixed`;get positionMode(){return this.#n}set positionMode(e){this.#n=e}#r=!1;get isOpen(){return this.#r}set isOpen(e){this.#r=e}#i=!1;get isPositioned(){return this.#i}set isPositioned(e){this.#i=e}#a=`-9999px`;get top(){return this.#a}set top(e){this.#a=e}#o=`-9999px`;get left(){return this.#o}set left(e){this.#o=e}_openPosition=null;static styles=Ee;connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this._handleDocumentKeyDown),document.addEventListener(`click`,this._handleDocumentClick),window.addEventListener(`resize`,this._handleWindowResize)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`keydown`,this._handleDocumentKeyDown),document.removeEventListener(`click`,this._handleDocumentClick),window.removeEventListener(`resize`,this._handleWindowResize)}_handleDocumentKeyDown=e=>{e.key===`Escape`&&this.isOpen&&this.close()};_handleDocumentClick=e=>{if(!this.isOpen)return;let t=e.composedPath(),n=this.shadowRoot?.querySelector(`.dcx-context-menu`);n&&t.includes(n)||this.close()};_handleWindowResize=()=>{this.isOpen&&this.calculatePosition()};async open(e){e&&(this._openPosition=e),this.isOpen=!0,await this.updateComplete,this.calculatePosition()}close(){this._openPosition=null,this.isOpen=!1,this.isPositioned=!1,this.dispatchEvent(new CustomEvent(`menu-closed`))}calculatePosition(){let e=this._openPosition??this.position;if(this.positionMode===`absolute`){this.left=`${e.x}px`,this.top=`${e.y}px`,this.isPositioned=!0;return}let t=e.x,n=e.y,r=this.shadowRoot?.querySelector(`.dcx-context-menu`);if(r){let e=r.getBoundingClientRect();if(t+e.width>window.innerWidth-10&&(t=window.innerWidth-10-e.width,t<0&&(t=0)),n+e.height>window.innerHeight-10){let t=n-e.height;n=t>=0?t:10}}let i=0,a=0;if(this.shadowRoot){let e=document.createElement(`div`);e.style.position=`fixed`,e.style.left=`0px`,e.style.top=`0px`,e.style.width=`0px`,e.style.height=`0px`,e.style.visibility=`hidden`,this.shadowRoot.appendChild(e);let t=e.getBoundingClientRect();i=t.left,a=t.top,this.shadowRoot.removeChild(e)}this.left=`${t-i}px`,this.top=`${n-a}px`,this.isPositioned=!0}onItemClick(e,t){t?.stopPropagation(),!(e.disabled||e.divider)&&(e.action&&e.action(),this.dispatchEvent(new CustomEvent(`item-selected`,{detail:e,bubbles:!0,composed:!0})),(!e.children||e.children.length===0)&&this.close())}onItemKeydown(e,t,n){let r=e.children||[];n.key===`ArrowRight`&&r.length>0?(n.preventDefault(),n.currentTarget.querySelector(`.dcx-context-menu__nested [tabindex="0"]`)?.focus()):n.key===`ArrowLeft`?(n.preventDefault(),(n.currentTarget.closest(`.dcx-context-menu__nested`)?.closest(`li`))?.focus()):(n.key===`Enter`||n.key===` `)&&(n.preventDefault(),this.onItemClick(e,n))}renderItem(t,n){if(t.divider)return e`<li class="dcx-context-menu__divider" role="separator"></li>`;let r=t.children&&t.children.length>0,i=[`dcx-context-menu__item`,`dcx-context-menu__item--selectable`,t.disabled?`dcx-context-menu__item--disabled`:``,r?`dcx-context-menu__item--has-children`:``,t.variant===`danger`?`dcx-context-menu__item--danger`:``].filter(Boolean).join(` `);return e`
    ...
    `}render(){return De(this)}};s([o({type:Array}),c(`design:type`,Array),c(`design:paramtypes`,[])],C.prototype,`items`,null),s([o({type:Object}),c(`design:type`,Object),c(`design:paramtypes`,[])],C.prototype,`position`,null),s([o({type:String}),c(`design:type`,String),c(`design:paramtypes`,[])],C.prototype,`positionMode`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],C.prototype,`isOpen`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],C.prototype,`isPositioned`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],C.prototype,`top`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],C.prototype,`left`,null),C=s([l(`dcx-web-context-menu`)],C);var w=t`
  :host {
    display: contents;
  }
...
`,T=t=>{if(!t.rendered)return n;let r=[`dcx-drawer`,`dcx-drawer--${t.position}`,t.fullScreen?`dcx-drawer--fullscreen`:``].filter(Boolean),i=[`dcx-drawer-root`,t.closing?`dcx-drawer-root--closing`:``],a=t.modal;return e`
  ...
  `},E=[`s`,`m`,`l`,`xl`,`auto`],D=[`top`,`bottom`,`left`,`right`],Oe=[`vertical`,`horizontal`],ke=[`xs`,`s`,`m`,`l`,`xl`],O=`right`,Ae=D,k=`22rem`,A=1e3,j=`Drawer`,je={open:!1,position:O,modal:!0,dismissible:!0,showCloseIcon:!0,closeOnEscape:!0,blockScroll:!1,fullScreen:!1,size:k,baseZIndex:A,autoZIndex:!0,header:j,footer:``},M,N=class extends r{static{M=this}#e=!1;get open(){return this.#e}set open(e){this.#e=e}#t=O;get position(){return this.#t}set position(e){this.#t=e}#n=!0;get modal(){return this.#n}set modal(e){this.#n=e}#r=!0;get dismissible(){return this.#r}set dismissible(e){this.#r=e}#i=!0;get showCloseIcon(){return this.#i}set showCloseIcon(e){this.#i=e}#a=!0;get closeOnEscape(){return this.#a}set closeOnEscape(e){this.#a=e}#o=!1;get blockScroll(){return this.#o}set blockScroll(e){this.#o=e}#s=!1;get fullScreen(){return this.#s}set fullScreen(e){this.#s=e}#c=k;get size(){return this.#c}set size(e){this.#c=e}#l=A;get baseZIndex(){return this.#l}set baseZIndex(e){this.#l=e}#u=!0;get autoZIndex(){return this.#u}set autoZIndex(e){this.#u=e}#d=j;get header(){return this.#d}set header(e){this.#d=e}#f=``;get footer(){return this.#f}set footer(e){this.#f=e}static styles=w;static _instanceCount=0;static _globalZIndex=0;#p=A;get _currentZIndex(){return this.#p}set _currentZIndex(e){this.#p=e}#m=!1;get rendered(){return this.#m}set rendered(e){this.#m=e}#h=!1;get closing(){return this.#h}set closing(e){this.#h=e}_closeTimer;_scrollBlocked=!1;_previousOverflow=``;_hideAlreadyEmitted=!1;_drawerId=`dcx-drawer-${++M._instanceCount}`;_keydownHandler=e=>{!this.open||!this.closeOnEscape||e.key!==`Escape`||this.closeDrawer()};get drawerTitleId(){return`${this._drawerId}-title`}get hasHeader(){return!!(this.header||this.showCloseIcon||this.querySelector(`[slot="drawerHeader"]`))}get hasFooter(){return!!(this.footer||this.querySelector(`[slot="drawerFooter"]`))}get resolvedZIndex(){return this._currentZIndex}get panelWidth(){return this.fullScreen?`100%`:this.position===`left`||this.position===`right`?this.size:null}get panelHeight(){return this.fullScreen?`100%`:this.position===`top`||this.position===`bottom`?this.size:null}connectedCallback(){super.connectedCallback(),this._syncKeydownListener(),this._syncBodyScroll()}disconnectedCallback(){document.removeEventListener(`keydown`,this._keydownHandler),this._scrollBlocked&&=(document.body.style.overflow=this._previousOverflow,document.body.style.paddingRight=``,!1),window.clearTimeout(this._closeTimer),super.disconnectedCallback()}willUpdate(e){e.has(`open`)&&(this.open?(this.closing=!1,this.rendered=!0):this.closing=!0),(e.has(`open`)||e.has(`baseZIndex`)||e.has(`autoZIndex`))&&(this.open&&this.autoZIndex?(M._globalZIndex=Math.max(M._globalZIndex,this.baseZIndex),M._globalZIndex+=2,this._currentZIndex=M._globalZIndex):this._currentZIndex=this.baseZIndex)}updated(e){e.has(`open`)&&(this.open?this.dispatchEvent(new CustomEvent(`dcx-drawer-show`,{bubbles:!0,composed:!0})):(this._hideAlreadyEmitted?this._hideAlreadyEmitted=!1:this.dispatchEvent(new CustomEvent(`dcx-drawer-hide`,{bubbles:!0,composed:!0})),window.clearTimeout(this._closeTimer),this._closeTimer=window.setTimeout(()=>{this.rendered=!1,this.closing=!1,this.requestUpdate()},220))),(e.has(`open`)||e.has(`blockScroll`)||e.has(`modal`))&&this._syncBodyScroll(),(e.has(`open`)||e.has(`closeOnEscape`))&&this._syncKeydownListener()}render(){return T(this)}close(){this.closeDrawer()}handleMaskPointerDown=e=>{e.stopPropagation(),this.dismissible&&this.closeDrawer()};closeDrawer=()=>{this.open&&(this._hideAlreadyEmitted=!0,this.dispatchEvent(new CustomEvent(`dcx-drawer-hide`,{bubbles:!0,composed:!0})),this.open=!1,this.dispatchEvent(new CustomEvent(`dcx-drawer-visible-change`,{detail:!1,bubbles:!0,composed:!0})))};_syncBodyScroll(){let e=this.open&&this.modal&&this.blockScroll;if(e&&!this._scrollBlocked){let e=window.innerWidth-document.documentElement.clientWidth;this._previousOverflow=document.body.style.overflow,document.body.style.overflow=`hidden`,e>0&&(document.body.style.paddingRight=`${e}px`),this._scrollBlocked=!0}else!e&&this._scrollBlocked&&(document.body.style.overflow=this._previousOverflow,document.body.style.paddingRight=``,this._scrollBlocked=!1)}_syncKeydownListener(){this.open&&this.closeOnEscape?document.addEventListener(`keydown`,this._keydownHandler):document.removeEventListener(`keydown`,this._keydownHandler)}};s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],N.prototype,`open`,null),s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],N.prototype,`position`,null),s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],N.prototype,`modal`,null),s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],N.prototype,`dismissible`,null),s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],N.prototype,`showCloseIcon`,null),s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],N.prototype,`closeOnEscape`,null),s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],N.prototype,`blockScroll`,null),s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],N.prototype,`fullScreen`,null),s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],N.prototype,`size`,null),s([o({type:Number,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],N.prototype,`baseZIndex`,null),s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],N.prototype,`autoZIndex`,null),s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],N.prototype,`header`,null),s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],N.prototype,`footer`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],N.prototype,`_currentZIndex`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],N.prototype,`rendered`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],N.prototype,`closing`,null),N=M=s([l(`dcx-web-drawer`)],N);var Me=t`
    :host {
      display: inline-flex;
    }
...
`,Ne=t=>{let r=`dcx-chip dcx-chip--${t.color}`,i=t.label?`Remover ${t.label}`:`Remover chip`;return e`
    <span
      class=${r}
  ...
  `},P=class extends r{#e=``;get label(){return this.#e}set label(e){this.#e=e}#t=`primary`;get color(){return this.#t}set color(e){this.#t=e}#n=!1;get removable(){return this.#n}set removable(e){this.#n=e}#r=``;get icon(){return this.#r}set icon(e){this.#r=e}#i=``;get image(){return this.#i}set image(e){this.#i=e}#a=`choice`;get variant(){return this.#a}set variant(e){this.#a=e}static styles=Me;get chipType(){return this.image.trim()?`with-image`:this.icon.trim()?`with-icon`:`label-only`}get showRemove(){return this.variant===`filter`||this.removable}renderIcon(){let t=[`house`,`person`,`gear`,`star`,`code-slash`,`terminal`,`palette`,`book`,`bug`].includes(this.icon)?this.icon:`question-circle`;return e`<dcx-web-icon name=${t}></dcx-web-icon>`}handleRemove(e){e.stopPropagation(),this.showRemove&&this.dispatchEvent(new CustomEvent(`dcx-chip-remove`,{bubbles:!0,composed:!0}))}render(){return Ne(this)}};s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],P.prototype,`label`,null),s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],P.prototype,`color`,null),s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],P.prototype,`removable`,null),s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],P.prototype,`icon`,null),s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],P.prototype,`image`,null),s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],P.prototype,`variant`,null),P=s([l(`dcx-web-chip`)],P);var Pe=t`
  :host {
    display: block;
    width: 100%;
    box-sizing: border-box;
...
`,Le=t=>{let r={"dcx-datepicker__input-wrapper":!0,"dcx-datepicker__input-wrapper--disabled":t.disabled,"dcx-datepicker__input-wrapper--open":t.isOpen};return e`
...
`,Ge=t=>e`
  ...
  `,L=class extends r{#e=`dcx-input-${Math.random().toString(36).substring(2,9)}`;get id(){return this.#e}set id(e){this.#e=e}#t=``;get value(){return this.#t}set value(e){this.#t=e}#n=!1;get disabled(){return this.#n}set disabled(e){this.#n=e}#r=!1;get readonly(){return this.#r}set readonly(e){this.#r=e}#i=``;get placeholder(){return this.#i}set placeholder(e){this.#i=e}#a=re;get type(){return this.#a}set type(e){this.#a=e}#o=``;get name(){return this.#o}set name(e){this.#o=e}#s=!1;get required(){return this.#s}set required(e){this.#s=e}#c=!1;get checked(){return this.#c}set checked(e){this.#c=e}#l=``;get autocomplete(){return this.#l}set autocomplete(e){this.#l=e}#u=``;get inputMode(){return this.#u}set inputMode(e){this.#u=e}#d=!1;get isInvalid(){return this.#d}set isInvalid(e){this.#d=e}#f=``;get label(){return this.#f}set label(e){this.#f=e}#p=``;get hint(){return this.#p}set hint(e){this.#p=e}#m=null;get ariaLabel(){return this.#m}set ariaLabel(e){this.#m=e}#h=null;get ariaDescribedBy(){return this.#h}set ariaDescribedBy(e){this.#h=e}#g=``;get errorMessage(){return this.#g}set errorMessage(e){this.#g=e}#_=ie;get requiredMessage(){return this.#_}set requiredMessage(e){this.#_=e}#v=[];get errorMessages(){return this.#v}set errorMessages(e){this.#v=e}#y=p;get errorIcon(){return this.#y}set errorIcon(e){this.#y=e}#b=`xs`;get spacing(){return this.#b}set spacing(e){this.#b=e}#x=`horizontal`;get orientation(){return this.#x}set orientation(e){this.#x=e}#S=!1;get multiple(){return this.#S}set multiple(e){this.#S=e}#C=d.min;get min(){return this.#C}set min(e){this.#C=e}#w=d.max;get max(){return this.#w}set max(e){this.#w=e}#T=d.step;get step(){return this.#T}set step(e){this.#T=e}#E=!1;get showPassword(){return this.#E}set showPassword(e){this.#E=e}#D=!1;get touched(){return this.#D}set touched(e){this.#D=e}static styles=We;get labelId(){return`${this.id}-label`}get errorId(){return`${this.id}-error`}get hintId(){return`${this.id}-hint`}get isPasswordType(){return this.type===u.PASSWORD}get isSearchType(){return this.type===u.SEARCH}get isFileType(){return this.type===u.FILE}get isRadioType(){return this.type===u.RADIO}get isRangeType(){return this.type===u.RANGE}get displayType(){return this.isPasswordType?this.showPassword?`text`:`password`:this.isRangeType?`range`:this.type}get showActionIcon(){return(this.isPasswordType||this.isSearchType)&&!this.readonly}get getInputIcon(){return{[u.TEXT]:null,[u.NUMBER]:`pin`,[u.EMAIL]:`mail`,[u.PASSWORD]:null,[u.SEARCH]:`search`,[u.TEL]:`phone`,[u.URL]:`link`,[u.FILE]:null,[u.RADIO]:null,[u.RANGE]:null}[this.type]??null}get describedBy(){let e=[this.ariaDescribedBy,this.hint&&!this.isInvalid?this.hintId:null,this.isInvalid?this.errorId:null].filter(Boolean).join(` `).trim();return e.length?e:null}get showRequiredWarning(){return this.required&&[``,null,void 0].includes(this.value)&&this.touched}get getActionButtonAriaLabel(){return this.isPasswordType?this.showPassword?`Ocultar contraseña`:`Mostrar contraseña`:this.isSearchType?`Buscar`:``}get getActionButtonIcon(){return this.isPasswordType?this.showPassword?`eye-slash-fill`:`eye-fill`:this.isSearchType?`search`:``}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}formatValueByType(e){switch(this.type){case`number`:return e.replace(/[^0-9.-]/g,``)===``?``:parseFloat(e.replace(/[^0-9.-]/g,``));case`email`:return e.toLowerCase();case`tel`:return e.replace(/[^0-9\s\-()]/g,``);case`search`:return e.trim();case`url`:return e.toLowerCase();default:return e}}onInputChange(e){if(this.isRadioType||this.isFileType)return;let t=e.target,n=this.formatValueByType(t.value);this.value=n,this.emit(`valueChange`,n)}onChangeEvent(e){this.isFileType||this.isRadioType&&e.target.checked&&this.emit(`valueChange`,this.value)}onFocusEvent(){this.touched=!1,this.emit(`focusEvent`)}onBlurEvent(){this.touched=!0,this.emit(`blurEvent`)}togglePasswordVisibility(){this.showPassword=!this.showPassword}onActionButtonClick(){if(this.isPasswordType){this.togglePasswordVisibility();return}this.isSearchType&&this.emit(`valueChange`,this.value)}getInputClasses(){let e=[`dcx-input__control`,`dcx-input__control--${this.spacing}`];return this.disabled&&e.push(`is-disabled`,`dcx-input__control--disabled`),this.isInvalid&&e.push(`is-invalid`,`dcx-input__control--invalid`),this.getInputIcon&&e.push(`has-icon`,`dcx-input__control--has-icon`),this.showActionIcon&&e.push(`has-action`,`dcx-input__control--has-action`),e.join(` `)}render(){return Ge(this)}};s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`id`,null),s([o({attribute:!1}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`value`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`disabled`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`readonly`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`placeholder`,null),s([o({type:String}),c(`design:type`,u===void 0?Object:u),c(`design:paramtypes`,[])],L.prototype,`type`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`name`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`required`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`checked`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`autocomplete`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`inputMode`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`isInvalid`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`label`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`hint`,null),s([o({type:String,attribute:`aria-label`}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`ariaLabel`,null),s([o({type:String,attribute:`aria-describedby`}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`ariaDescribedBy`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`errorMessage`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`requiredMessage`,null),s([o({attribute:!1}),c(`design:type`,Array),c(`design:paramtypes`,[])],L.prototype,`errorMessages`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`errorIcon`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`spacing`,null),s([o({type:String,reflect:!0}),c(`design:type`,String),c(`design:paramtypes`,[])],L.prototype,`orientation`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`multiple`,null),s([o({type:Number}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`min`,null),s([o({type:Number}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`max`,null),s([o({type:Number}),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`step`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`showPassword`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],L.prototype,`touched`,null),L=s([l(`dcx-web-input`)],L);var Ke=t=>e`
    <div
...
`,Ye=t=>e``,z=class extends r{#e=`rectangle`;get shape(){return this.#e}set shape(e){this.#e=e}#t=`100%`;get width(){return this.#t}set width(e){this.#t=e}#n=`1rem`;get height(){return this.#n}set height(e){this.#n=e}#r=null;get size(){return this.#r}set size(e){this.#r=e}#i=null;get borderRadius(){return this.#i}set borderRadius(e){this.#i=e}#a=`wave`;get animation(){return this.#a}set animation(e){this.#a=e}static styles=Je;get computedWidth(){return this.size||this.width}get computedHeight(){return this.size||this.height}get computedBorderRadius(){return this.shape===`circle`?`var(--r-pill, 999px)`:this.borderRadius||`var(--r-md, 6px)`}updateHostClassesAndStyles(){this.classList.add(`dcx-skeleton`),this.classList.toggle(`dcx-skeleton--circle`,this.shape===`circle`),this.classList.toggle(`dcx-skeleton--wave`,this.animation===`wave`),this.classList.toggle(`dcx-skeleton--none`,this.animation===`none`),this.style.setProperty(`--dcx-skeleton-width`,this.computedWidth),this.style.setProperty(`--dcx-skeleton-height`,this.computedHeight),this.style.setProperty(`--dcx-skeleton-border-radius`,this.computedBorderRadius)}connectedCallback(){super.connectedCallback(),this.setAttribute(`aria-hidden`,`true`)}firstUpdated(){this.updateHostClassesAndStyles()}updated(){this.updateHostClassesAndStyles()}render(){return Ye(this)}};s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],z.prototype,`shape`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],z.prototype,`width`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],z.prototype,`height`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],z.prototype,`size`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],z.prototype,`borderRadius`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],z.prototype,`animation`,null),z=s([l(`dcx-web-skeleton`)],z);var B=t`
  :host {
    display: flex;
    flex-direction: column;
    gap: var(--sp-1, 4px);
...
`,Xe=t=>e`
  ...
  ></dcx-web-input>
`,V=class extends r{static styles=B;#e=m.showLabel;get showLabel(){return this.#e}set showLabel(e){this.#e=e}#t=m.textLabel;get textLabel(){return this.#t}set textLabel(e){this.#t=e}#n=m.value;get value(){return this.#n}set value(e){this.#n=e}#r=m.min;get min(){return this.#r}set min(e){this.#r=e}#i=m.max;get max(){return this.#i}set max(e){this.#i=e}#a=m.step;get step(){return this.#a}set step(e){this.#a=e}#o=m.vertical;get vertical(){return this.#o}set vertical(e){this.#o=e}#s=m.disabled;get disabled(){return this.#s}set disabled(e){this.#s=e}#c=null;get ariaLabel(){return this.#c}set ariaLabel(e){this.#c=e}#l=m.valueSuffix;get valueSuffix(){return this.#l}set valueSuffix(e){this.#l=e}#u=0;get valueInput(){return this.#u}set valueInput(e){this.#u=e}willUpdate(e){(e.has(`value`)||e.has(`min`)||e.has(`max`))&&(this.valueInput=this.clamp(this.value))}updated(e){e.has(`vertical`)&&(this.vertical?this.classList.add(`dcx-slider--vertical`):this.classList.remove(`dcx-slider--vertical`)),this.style.setProperty(`--slider-progress`,`${this.progressPercent}%`)}async firstUpdated(){let e=this.shadowRoot?.querySelector(`dcx-web-input`);if(e&&(await e.updateComplete,e.shadowRoot)){let t=document.createElement(`style`);t.textContent=B.cssText,e.shadowRoot.appendChild(t)}}clamp(e){return Math.min(Math.max(e,this.min),this.max)}onInput(e){let t=Number(e.detail);this.valueInput=t,this.value=t,this.dispatchEvent(new CustomEvent(`valueChange`,{detail:t,bubbles:!0,composed:!0}))}get displayValue(){return`${this.valueInput}${this.valueSuffix}`}get effectiveAriaLabel(){return this.ariaLabel||(this.showLabel?this.textLabel:null)}get effectiveAriaValueText(){return this.valueSuffix?this.displayValue:null}get progressPercent(){let e=this.min,t=this.max,n=this.valueInput;return t===e?100:(n-e)/(t-e)*100}render(){return Xe(this)}};s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],V.prototype,`showLabel`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],V.prototype,`textLabel`,null),s([o({type:Number}),c(`design:type`,Object),c(`design:paramtypes`,[])],V.prototype,`value`,null),s([o({type:Number}),c(`design:type`,Object),c(`design:paramtypes`,[])],V.prototype,`min`,null),s([o({type:Number}),c(`design:type`,Object),c(`design:paramtypes`,[])],V.prototype,`max`,null),s([o({type:Number}),c(`design:type`,Object),c(`design:paramtypes`,[])],V.prototype,`step`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],V.prototype,`vertical`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],V.prototype,`disabled`,null),s([o({type:String,attribute:`aria-label`}),c(`design:type`,Object),c(`design:paramtypes`,[])],V.prototype,`ariaLabel`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],V.prototype,`valueSuffix`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],V.prototype,`valueInput`,null),V=s([l(`dcx-web-slider`)],V);var Ze=t=>e`
    ${t.label?e`
          <label
...
`,W=class extends r{#e=``;get body(){return this.#e}set body(e){this.#e=e}#t=`notification`;get type(){return this.#t}set type(e){this.#t=e}#n=``;get title(){return this.#n}set title(e){this.#n=e}#r=``;get link(){return this.#r}set link(e){this.#r=e}#i=!1;get icon(){return this.#i}set icon(e){this.#i=e}#a=``;get iconName(){return this.#a}set iconName(e){this.#a=e}#o=!1;get showClose(){return this.#o}set showClose(e){this.#o=e}#s=!0;get announce(){return this.#s}set announce(e){this.#s=e}#c=!1;get dismissed(){return this.#c}set dismissed(e){this.#c=e}static styles=nt;get messageData(){return{notification:{icon:`info-circle`,role:`status`,ariaLive:`polite`},success:{icon:`check-circle`,role:`status`,ariaLive:`polite`},warning:{icon:`exclamation-triangle`,role:`alert`,ariaLive:`assertive`},error:{icon:`x-circle`,role:`alert`,ariaLive:`assertive`}}[this.type]}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}onClose=()=>{this.dismissed=!0,this.emit(`closed`)};render(){return tt(this)}};s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],W.prototype,`body`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],W.prototype,`type`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],W.prototype,`title`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],W.prototype,`link`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],W.prototype,`icon`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],W.prototype,`iconName`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],W.prototype,`showClose`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],W.prototype,`announce`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],W.prototype,`dismissed`,null),W=s([l(`dcx-web-message`)],W);var rt=t`
  :host {
    display: inline-flex;
  }
...
`,it=t=>e`
  ...
  `,G=class extends r{#e=!1;get checked(){return this.#e}set checked(e){this.#e=e}#t=!1;get disabled(){return this.#t}set disabled(e){this.#t=e}#n=null;get label(){return this.#n}set label(e){this.#n=e}#r=`m`;get size(){return this.#r}set size(e){this.#r=e}#i=null;get ariaLabel(){return this.#i}set ariaLabel(e){this.#i=e}#a=`right`;get textPosition(){return this.#a}set textPosition(e){this.#a=e}static styles=rt;get effectiveAriaLabel(){return this.ariaLabel||this.label||`Toggle`}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}toggle(){if(this.disabled)return;let e=!this.checked;this.checked=e,this.emit(`toggled`,e)}getToggleClasses(){let e=[`dcx-toggle`,this.size?`dcx-toggle--${this.size}`:``,`dcx-toggle--${this.textPosition}`];return this.disabled&&e.push(`dcx-toggle--disabled`),e.filter(Boolean).join(` `)}render(){return it(this)}};s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],G.prototype,`checked`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],G.prototype,`disabled`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],G.prototype,`label`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],G.prototype,`size`,null),s([o({type:String,attribute:`aria-label`}),c(`design:type`,Object),c(`design:paramtypes`,[])],G.prototype,`ariaLabel`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],G.prototype,`textPosition`,null),G=s([l(`dcx-web-toggle`)],G);var at=t`
  :host {
    display: block;
    width: 100%;
  }
...
`,K=class extends r{#e=`dcx-progressbar-${Math.random().toString(36).substring(2,9)}`;get id(){return this.#e}set id(e){this.#e=e}#t=`default`;get variant(){return this.#t}set variant(e){this.#t=e}#n=0;get value(){return this.#n}set value(e){this.#n=e}#r=``;get label(){return this.#r}set label(e){this.#r=e}#i=``;get ariaLabel(){return this.#i}set ariaLabel(e){this.#i=e}#a=!1;get showTooltip(){return this.#a}set showTooltip(e){this.#a=e}#o=!1;get showLabel(){return this.#o}set showLabel(e){this.#o=e}#s=[];get steps(){return this.#s}set steps(e){this.#s=e}#c=0;get currentStep(){return this.#c}set currentStep(e){this.#c=e}#l=!1;get showCheckmarks(){return this.#l}set showCheckmarks(e){this.#l=e}#u=5;get segments(){return this.#u}set segments(e){this.#u=e}static styles=at;get labelId(){return`${this.id}-label`}get progressPercentage(){return Math.min(Math.max(this.value,0),100)}get isStepperVariant(){return this.variant===`stepper`}get isSegmentedVariant(){return this.variant===`segmented`}get isDefaultVariant(){return this.variant==="default"}get segmentArray(){return Array(this.segments).fill(0).map((e,t)=>t)}get stepProgress(){let e=this.steps.length;return e===0?0:this.currentStep/e*100}get stepValueText(){return`Paso ${this.currentStep} de ${this.steps.length}`}isStepCompleted(e){return e<this.currentStep-1}isStepActive(e){return e===this.currentStep-1}render(){return ot(this)}};s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],K.prototype,`id`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],K.prototype,`variant`,null),s([o({type:Number}),c(`design:type`,Object),c(`design:paramtypes`,[])],K.prototype,`value`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],K.prototype,`label`,null),s([o({type:String,attribute:`aria-label`}),c(`design:type`,Object),c(`design:paramtypes`,[])],K.prototype,`ariaLabel`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],K.prototype,`showTooltip`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],K.prototype,`showLabel`,null),s([o({attribute:!1}),c(`design:type`,Array),c(`design:paramtypes`,[])],K.prototype,`steps`,null),s([o({type:Number}),c(`design:type`,Object),c(`design:paramtypes`,[])],K.prototype,`currentStep`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],K.prototype,`showCheckmarks`,null),s([o({type:Number}),c(`design:type`,Object),c(`design:paramtypes`,[])],K.prototype,`segments`,null),K=s([l(`dcx-web-progressbar`)],K);var st=t`
  :host {
    display: inline-block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,ct=t=>e`
  ...
  `,q=class extends r{static styles=st;#e=[];get options(){return this.#e}set options(e){this.#e=e}#t=`dcx-radio-${Math.random().toString(36).substring(2,9)}`;get name(){return this.#t}set name(e){this.#t=e}#n=``;get label(){return this.#n}set label(e){this.#n=e}#r=``;get ariaLabel(){return this.#r}set ariaLabel(e){this.#r=e}#i=`l`;get size(){return this.#i}set size(e){this.#i=e}#a=!1;get disabled(){return this.#a}set disabled(e){this.#a=e}#o=!1;get error(){return this.#o}set error(e){this.#o=e}#s=``;get hint(){return this.#s}set hint(e){this.#s=e}#c=``;get errorMessage(){return this.#c}set errorMessage(e){this.#c=e}#l=null;get value(){return this.#l}set value(e){this.#l=e}groupId=`dcx-radio-group-${Math.random().toString(36).substring(2,9)}`;get hintId(){return`${this.groupId}-hint`}get errorId(){return`${this.groupId}-error`}get isGroupDisabled(){return this.disabled}get showError(){return this.error&&!!this.errorMessage}get showHint(){return!!this.hint&&!this.showError}get describedBy(){return this.showError?this.errorId:this.showHint?this.hintId:null}isChecked(e){return this.value===e}isOptionDisabled(e){return this.isGroupDisabled||!!e.disabled}radioClasses(e){let t=`dcx-radio`;return[t,`${t}--${this.size}`,this.error?`${t}--error`:``,this.isOptionDisabled(e)?`${t}--disabled`:``,this.isChecked(e.value)?`${t}--checked`:``].filter(Boolean).join(` `)}onOptionChange(e){this.isOptionDisabled(e)||(this.value=e.value,this.dispatchEvent(new CustomEvent(`valueChange`,{detail:e.value,bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`change`,{bubbles:!0,composed:!0})))}onBlur(){this.dispatchEvent(new CustomEvent(`blurEvent`,{bubbles:!0,composed:!0}))}render(){return ct(this)}};s([o({type:Array}),c(`design:type`,Array),c(`design:paramtypes`,[])],q.prototype,`options`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`name`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`label`,null),s([o({type:String,attribute:`aria-label`}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`ariaLabel`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`size`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`disabled`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`error`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`hint`,null),s([o({type:String,attribute:`error-message`}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`errorMessage`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`value`,null),q=s([l(`dcx-web-radio`)],q);var lt=t`
  :host {
    display: inline-flex;
    position: relative;
  }
...
`,ut=t=>e`
    ...
    ${t.visible&&(t.content||t.contentHtml)?e`
        ...
        `:n}
  `,dt=[`left`,`center`,`right`],ft=[`default`,`primary`],pt=[`a`,`button`,`input`,`select`,`textarea`],J=class extends r{#e=`top`;get position(){return this.#e}set position(e){this.#e=e}#t=`center`;get arrowAlignment(){return this.#t}set arrowAlignment(e){this.#t=e}#n=!1;get hideTooltipOnClick(){return this.#n}set hideTooltipOnClick(e){this.#n=e}#r=``;get content(){return this.#r}set content(e){this.#r=e}#i=``;get contentHtml(){return this.#i}set contentHtml(e){this.#i=e}#a=`default`;get variant(){return this.#a}set variant(e){this.#a=e}#o=!1;get visible(){return this.#o}set visible(e){this.#o=e}#s=`top`;get actualPosition(){return this.#s}set actualPosition(e){this.#s=e}tooltipId=`dcx-tooltip-${Math.random().toString(36).substring(2,9)}`;static styles=lt;get tooltipClasses(){let e=`dcx-ng-tooltip`;return[e,`${e}--${this.actualPosition}`,`${e}--arrow-${this.arrowAlignment}`,this.variant===`primary`?`${e}--primary`:``].filter(Boolean).join(` `)}get sanitizedHtml(){return this.sanitizeContent(this.contentHtml)}willUpdate(e){super.willUpdate(e),e.has(`position`)&&(this.actualPosition=this.position)}firstUpdated(){this.actualPosition=this.position,this.linkTriggerToTooltip()}linkTriggerToTooltip(){let e=((this.shadowRoot?.querySelector(`slot`))?.assignedElements({flatten:!0})??[])[0];e&&e.setAttribute(`aria-describedby`,this.tooltipId)}sanitizeContent(e){if(!e)return``;let t=new DOMParser().parseFromString(e,`text/html`);return pt.forEach(e=>{t.body.querySelectorAll(e).forEach(e=>{e.replaceWith(...Array.from(e.childNodes))})}),t.body.innerHTML}show(){this.visible||!this.content&&!this.contentHtml||(this.visible=!0)}hide(){this.visible&&=!1}onMouseEnter(){this.show()}onMouseLeave(){this.hide()}onFocusIn(){this.show()}onFocusOut(){this.hide()}onEscape(){this.hide()}onClick(){this.hideTooltipOnClick&&this.hide()}connectedCallback(){super.connectedCallback(),this.addEventListener(`mouseenter`,this.onMouseEnter),this.addEventListener(`mouseleave`,this.onMouseLeave),this.addEventListener(`focusin`,this.onFocusIn),this.addEventListener(`focusout`,this.onFocusOut),this.addEventListener(`click`,this.onClick),this.addEventListener(`keydown`,e=>{e.key===`Escape`&&this.onEscape()})}render(){return ut(this)}};s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],J.prototype,`position`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],J.prototype,`arrowAlignment`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],J.prototype,`hideTooltipOnClick`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],J.prototype,`content`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],J.prototype,`contentHtml`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],J.prototype,`variant`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],J.prototype,`visible`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],J.prototype,`actualPosition`,null),J=s([l(`dcx-web-tooltip`)],J);var mt=t=>e`
  <ul
    id="${t.id||``}"
...
`,Y=class extends r{#e=[];get items(){return this.#e}set items(e){this.#e=e}#t=!1;get selectable(){return this.#t}set selectable(e){this.#t=e}#n=!1;get multiSelect(){return this.#n}set multiSelect(e){this.#n=e}#r=!1;get showChildrenIndicator(){return this.#r}set showChildrenIndicator(e){this.#r=e}#i=!0;get renderChildren(){return this.#i}set renderChildren(e){this.#i=e}#a=null;get itemTemplate(){return this.#a}set itemTemplate(e){this.#a=e}#o=``;get id(){return this.#o}set id(e){this.#o=e}#s=`Lista de elementos`;get ariaLabel(){return this.#s}set ariaLabel(e){this.#s=e}#c=`list`;get listRole(){return this.#c}set listRole(e){this.#c=e}#l=`listitem`;get itemRole(){return this.#l}set itemRole(e){this.#l=e}#u=null;get multiselectable(){return this.#u}set multiselectable(e){this.#u=e}#d=!1;get externalSelection(){return this.#d}set externalSelection(e){this.#d=e}#f=null;get isItemSelected(){return this.#f}set isItemSelected(e){this.#f=e}#p=!1;get cdkDropList(){return this.#p}set cdkDropList(e){this.#p=e}#m=[];get cdkDropListData(){return this.#m}set cdkDropListData(e){this.#m=e}#h=null;get cdkDropListConnectedTo(){return this.#h}set cdkDropListConnectedTo(e){this.#h=e}#g=!1;get cdkDropListDisabled(){return this.#g}set cdkDropListDisabled(e){this.#g=e}#_=!1;get dragEnabled(){return this.#_}set dragEnabled(e){this.#_=e}#v=e=>!1;get cdkDragDisabled(){return this.#v}set cdkDragDisabled(e){this.#v=e}#y=[];get selectedIndices(){return this.#y}set selectedIndices(e){this.#y=e}static styles=ht;emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}getChildren(e){return e.children??[]}isSelected(e){return this.selectable?this.selectedIndices.includes(e):!1}resolveAriaSelected(e,t){return this.isItemSelected?this.isItemSelected(e,t):this.selectable&&!this.externalSelection?this.isSelected(t):null}onItemClick(e,t){if(!(!this.selectable||e.disabled||e.divider)){if(this.externalSelection){this.emit(`itemSelected`,{item:e,index:t});return}if(this.multiSelect){this.isSelected(t)?(this.selectedIndices=this.selectedIndices.filter(e=>e!==t),this.emit(`itemDeselected`,{item:e,index:t})):(this.selectedIndices=[...this.selectedIndices,t],this.emit(`itemSelected`,{item:e,index:t}));return}if(this.isSelected(t)){this.selectedIndices=[],this.emit(`itemDeselected`,{item:e,index:t});return}this.selectedIndices=[t],this.emit(`itemSelected`,{item:e,index:t})}}onKeydown(e,t,n){let r=this.getChildren(t);(e.key===`Enter`||e.key===` `)&&!t.disabled&&(e.preventDefault(),this.onItemClick(t,n)),e.key===`ArrowRight`&&r.length&&(e.preventDefault(),e.currentTarget.querySelector(`.dcx-list-nested [tabindex="0"]`)?.focus()),e.key===`ArrowLeft`&&(e.preventDefault(),(e.currentTarget.closest(`.dcx-list-nested`)?.closest(`li`))?.focus())}getItemClasses(e,t){let n=[`dcx-list-item`];return this.selectable&&n.push(`selectable`),this.isSelected(t)&&n.push(`selected`),e.disabled&&n.push(`disabled`),e.children&&e.children.length&&n.push(`has-children`),e.variant===`danger`&&n.push(`danger`),n.join(` `)}render(){return mt(this)}};s([o({attribute:!1}),c(`design:type`,Array),c(`design:paramtypes`,[])],Y.prototype,`items`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`selectable`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`multiSelect`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`showChildrenIndicator`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`renderChildren`,null),s([o({attribute:!1}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`itemTemplate`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`id`,null),s([o({type:String,attribute:`aria-label`}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`ariaLabel`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`listRole`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`itemRole`,null),s([o({attribute:!1}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`multiselectable`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`externalSelection`,null),s([o({attribute:!1}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`isItemSelected`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`cdkDropList`,null),s([o({attribute:!1}),c(`design:type`,Array),c(`design:paramtypes`,[])],Y.prototype,`cdkDropListData`,null),s([o({attribute:!1}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`cdkDropListConnectedTo`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`cdkDropListDisabled`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`dragEnabled`,null),s([o({attribute:!1}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`cdkDragDisabled`,null),s([i(),c(`design:type`,Array),c(`design:paramtypes`,[])],Y.prototype,`selectedIndices`,null),Y=s([l(`dcx-web-list`)],Y);var X=t`
  :host {
    display: block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }

import{a as e}from"./lit-C11zoK0j.js";import"./src-C8W-Yn-o.js";import{a as t,i as n,n as r,s as i,t as a}from"./dcx-web-picklist.component-B2R037-M.js";var o=`Título de la carta`,s=`Subtítulo de la carta`,c=`https://picsum.photos/360/240`,l=`560px`,u=`100%`,d=`solid`,f=[`solid`,`dashed`,`dotted`,`double`,`none`],p=[0,1,2,3],m={align:a,bordered:!1,borderStyle:d,borderWidth:1,disabled:!1,image:c,imageAlt:``,interactive:!0,layout:n,maxContentWidth:l,maxImageWidth:u,shadow:1,size:`s`,subtitle:s,title:o,accent:!1},h=e`
  <style>
...
`,g=(t,n)=>{let r={...m,...t};return e`
  ...
  `},_={title:`DCXLibrary/WebComponents/Card`,component:`dcx-web-card`,tags:[`autodocs`],parameters:{controls:{expanded:!0},layout:`centered`},decorators:[t=>e`
      ${h}
      ${t()}
    `],argTypes:{align:{description:`Alineación del bloque y del contenido.`,options:r,control:{type:`select`},table:{category:`Atributos`,defaultValue:{summary:a}}},bordered:{description:`Activa borde explícito.`,control:{type:`boolean`},table:{category:`Atributos`}},borderStyle:{description:`Tipo de línea del borde de la carta.`,options:f,control:{type:`select`},table:{category:`Atributos`,defaultValue:{summary:d}}},borderWidth:{description:`Grosor del borde (px). Máx 16px`,control:{type:`number`,min:0,max:16,step:1},table:{category:`Atributos`}},accent:{description:`Aplica color de acento al borde.`,control:{type:`boolean`},table:{category:`Atributos`}},disabled:{description:`Deshabilita la carta`,control:{type:`boolean`},table:{category:`Atributos`}},image:{description:`URL de la imagen.`,control:{type:`text`},table:{category:`Atributos`}},imageAlt:{description:`Texto alternativo para la imagen.`,control:{type:`text`},table:{category:`Atributos`}},interactive:{description:`Convierte la carta en interactivo (hover/cursor).`,control:{type:`boolean`},table:{category:`Atributos`}},layout:{description:`Orientación del contenido.`,options:t,control:{type:`select`},table:{category:`Atributos`,defaultValue:{summary:n}}},maxContentWidth:{description:`Ancho máx. del bloque (en cualquier layout).`,control:{type:`text`},table:{category:`Atributos`}},maxImageWidth:{description:`Ancho máx. de imagen.`,control:{type:`text`},table:{category:`Atributos`}},shadow:{description:`Sombra: preset 0/1/2/3.`,options:p,control:{type:`select`},table:{category:`Atributos`}},size:{description:`Tamaño (padding + tipografía).`,options:i,control:{type:`select`},table:{category:`Atributos`,defaultValue:{summary:`s`}}},subtitle:{description:`Subtítulo o descripción corta de la carta.`,control:{type:`text`},table:{category:`Atributos`}},title:{description:`Título principal de la carta.`,control:{type:`text`},table:{category:`Atributos`}},"dcx-card-click":{description:`Se emite al hacer clic o activar con teclado (Enter/Space) cuando la carta es interactiva.`,table:{category:`Eventos`,type:{summary:`(event: MouseEvent | KeyboardEvent) => void`}}}},args:m,render:e=>g(e)},v={},y={render:t=>e`

import{a as e}from"./lit-C11zoK0j.js";import"./defaults-vv0ZT-_6.js";import{C as t,f as n,m as r,p as i,v as a}from"./src-DLX29kS0.js";var o={title:`DCXLibrary/WebComponents/Select`,component:`dcx-web-select`,tags:[`autodocs`],parameters:{controls:{expanded:!0},docs:{source:{transform:(e,{args:t})=>`
        <dcx-web-select
          label="${t.label??``}"
    ...
    `},s={},c={args:{searchable:!0}},l={args:{searchable:!0,clearable:!0}},u={args:{placeholder:`Disabled`,disabled:!0}},d={name:`Deshabilitado con búsqueda`,args:{searchable:!0,clearable:!0,disabled:!0,valueInput:i[0].value}},f={args:{searchable:!0,clearable:!0,required:!0}},p={args:{searchable:!0,clearable:!0,required:!0,isInvalid:!0,errorMessage:`Error`}},m={name:`Con valor preseleccionado`,args:{clearable:!0,valueInput:i[1].value}},h={name:`Sin opciones`,args:{options:[],placeholder:`No hay opciones disponibles`,searchable:!0}},g={render:()=>e`
    <div
      style="
        display:flex;
        gap:var(--sp-3, 12px);

...
`,ge=t=>{let n=`dcx-badge dcx-badge--${t.severity} dcx-badge--${t.size}`;return e`
    <span
      class="${n}"
      role="${t.roleAttr||``}"
    ...
    >${t.value}</span>
  `},v=class extends r{#e=``;get value(){return this.#e}set value(e){this.#e=e}#t=`primary`;get severity(){return this.#t}set severity(e){this.#t=e}#n=`md`;get size(){return this.#n}set size(e){this.#n=e}#r=null;get ariaLabel(){return this.#r}set ariaLabel(e){this.#r=e}#i=!1;get ariaHiddenAttr(){return this.#i}set ariaHiddenAttr(e){this.#i=e}#a=null;get roleAttr(){return this.#a}set roleAttr(e){this.#a=e}static styles=he;getComputedAriaLabel(){if(this.ariaHiddenAttr)return null;if(this.ariaLabel!==null)return this.ariaLabel;let e=this.value;return e?`${e}, ${this.severity}`:this.severity}render(){return ge(this)}};s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],v.prototype,`value`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],v.prototype,`severity`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],v.prototype,`size`,null),s([o({type:String,attribute:`aria-label`}),c(`design:type`,Object),c(`design:paramtypes`,[])],v.prototype,`ariaLabel`,null),s([o({type:Boolean,attribute:`aria-hidden`}),c(`design:type`,Object),c(`design:paramtypes`,[])],v.prototype,`ariaHiddenAttr`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],v.prototype,`roleAttr`,null),v=s([l(`dcx-web-badge`)],v);var _e=t`
  :host {
    display: block;
  }
...
`,ve=t=>t.visible?e`
  ...
  `:e``,y=class extends r{#e=`center`;get position(){return this.#e}set position(e){this.#e=e}#t=``;get title(){return this.#t}set title(e){this.#t=e}#n=``;get dialogId(){return this.#n}set dialogId(e){this.#n=e}#r=!0;get showClose(){return this.#r}set showClose(e){this.#r=e}#i=!0;get closeOnBackdrop(){return this.#i}set closeOnBackdrop(e){this.#i=e}#a=!1;get visible(){return this.#a}set visible(e){this.#a=e}static styles=_e;get dialogTitleId(){return`dialog-title-${this.dialogId||`default`}`}get dialogClasses(){return`dcx-dialog dcx-dialog--pos-${this.position}`}close(){this.dispatchEvent(new CustomEvent(`closeDialog`,{bubbles:!0,composed:!0}))}onBackdropClick(e){e.stopPropagation(),this.closeOnBackdrop&&this.close()}onKeyDown=e=>{e.key===`Escape`&&this.visible&&this.close()};connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this.onKeyDown)}disconnectedCallback(){document.removeEventListener(`keydown`,this.onKeyDown),super.disconnectedCallback()}render(){return ve(this)}};s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],y.prototype,`position`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],y.prototype,`title`,null),s([o({type:String,attribute:`dialog-id`}),c(`design:type`,Object),c(`design:paramtypes`,[])],y.prototype,`dialogId`,null),s([o({type:Boolean,attribute:`show-close`}),c(`design:type`,Object),c(`design:paramtypes`,[])],y.prototype,`showClose`,null),s([o({type:Boolean,attribute:`close-on-backdrop`}),c(`design:type`,Object),c(`design:paramtypes`,[])],y.prototype,`closeOnBackdrop`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],y.prototype,`visible`,null),y=s([l(`dcx-web-dialog`)],y);var ye=t`
  :host {
    display: block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,be=t=>e`
  ...
  `,b=class extends r{#e=`https://picsum.photos/360/240`;get image(){return this.#e}set image(e){this.#e=e}#t=``;get imageAlt(){return this.#t}set imageAlt(e){this.#t=e}#n=`Título de la carta`;get title(){return this.#n}set title(e){this.#n=e}#r=`Subtítulo de la carta`;get subtitle(){return this.#r}set subtitle(e){this.#r=e}#i=`vertical`;get layout(){return this.#i}set layout(e){this.#i=e}#a=`center`;get align(){return this.#a}set align(e){this.#a=e}#o=`s`;get size(){return this.#o}set size(e){this.#o=e}#s=`560px`;get maxContentWidth(){return this.#s}set maxContentWidth(e){this.#s=e}#c=`100%`;get maxImageWidth(){return this.#c}set maxImageWidth(e){this.#c=e}#l=!1;get accent(){return this.#l}set accent(e){this.#l=e}#u=!1;get bordered(){return this.#u}set bordered(e){this.#u=e}#d=1;get borderWidth(){return this.#d}set borderWidth(e){this.#d=e}#f=`solid`;get borderStyle(){return this.#f}set borderStyle(e){this.#f=e}#p=1;get shadow(){return this.#p}set shadow(e){this.#p=e}#m=!0;get interactive(){return this.#m}set interactive(e){this.#m=e}#h=!1;get disabled(){return this.#h}set disabled(e){this.#h=e}static styles=ye;get cardClasses(){return`dcx-card ${this.interactive?`dcx-card--interactive`:``} ${this.disabled?`dcx-card--disabled`:``}`.trim().replace(/\s+/g,` `)}get innerClasses(){let e=this.accent?`dcx-card__inner--accent-top`:``;return`dcx-card__inner dcx-card__inner--layout-${this.layout} dcx-card__inner--align-${this.align} dcx-card__inner--size-${this.size} ${e}`.trim().replace(/\s+/g,` `)}get innerStyles(){return{"--card-max-content-width":this.maxContentWidth,"--card-max-image-width":this.maxImageWidth,"--card-border-style":this.bordered?this.borderStyle:`solid`,"--card-border-width":this.bordered?`${this.borderWidth}px`:`0`,"--card-shadow":this.shadowCSS}}get cardRole(){return this.disabled?`region`:this.interactive?`button`:`region`}get cardTabIndex(){if(this.disabled)return-1;if(this.cardRole===`button`)return 0}get hasHeader(){return this.querySelector(`[slot="header"]`)!==null}get hasContent(){return this.querySelector(`[slot="content"]`)!==null||Array.from(this.childNodes).some(e=>e.nodeType===Node.ELEMENT_NODE&&!e.hasAttribute(`slot`)||e.nodeType===Node.TEXT_NODE&&(e.textContent??``).trim().length>0)}get hasFooter(){return this.querySelector(`[slot="footer"]`)!==null}get effectiveAriaLabel(){return this.cardRole===`region`&&!this.hasHeader&&this.title?this.title:null}get shadowCSS(){switch(this.shadow){case 1:return`var(--shadow-sm, 0 1px 2px rgba(0, 0, 0, 0.06))`;case 2:return`var(--shadow-md, 0 4px 12px rgba(0, 0, 0, 0.08))`;case 3:return`var(--shadow-lg, 0 8px 24px rgba(0, 0, 0, 0.12))`;default:return`var(--shadow-0, none)`}}_handleCardClick(e){if(!this.disabled){if(e instanceof KeyboardEvent){let t=e.key.toLowerCase();this.interactive&&(t===`enter`||t===` `)&&(e.preventDefault(),this.dispatchEvent(new CustomEvent(`dcx-card-click`,{detail:e,bubbles:!0,composed:!0})))}else this.dispatchEvent(new CustomEvent(`dcx-card-click`,{detail:e,bubbles:!0,composed:!0}))}}render(){return be(this)}};s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],b.prototype,`image`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],b.prototype,`imageAlt`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],b.prototype,`title`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],b.prototype,`subtitle`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],b.prototype,`layout`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],b.prototype,`align`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],b.prototype,`size`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],b.prototype,`maxContentWidth`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],b.prototype,`maxImageWidth`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],b.prototype,`accent`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],b.prototype,`bordered`,null),s([o({type:Number}),c(`design:type`,Object),c(`design:paramtypes`,[])],b.prototype,`borderWidth`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],b.prototype,`borderStyle`,null),s([o({type:Number}),c(`design:type`,Object),c(`design:paramtypes`,[])],b.prototype,`shadow`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],b.prototype,`interactive`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],b.prototype,`disabled`,null),b=s([l(`dcx-web-card`)],b);var xe=t`
  :host {
    display: block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,Se=t=>e`
  ...
  `,x=class extends r{static styles=xe;#e=[];get options(){return this.#e}set options(e){this.#e=e}errorIcon=`exclamation-circle-fill`;_getValue(e){return e===!0?!1:e!==!1||null}_normalizeValue(e){return e===!0||e!==!1&&null}getVariant(e){return this._normalizeValue(e.value)===null?`secondary`:`primary`}getIconName(e){let t=this._normalizeValue(e.value);return t===!0?`check`:t===!1?`dash`:``}getAriaChecked(e){let t=this._normalizeValue(e.value);return t===!0?`true`:t===!1?`mixed`:`false`}changeValue(e){let t=this.options.map(t=>t.id===e?{...t,value:this._getValue(t.value)}:t);this.dispatchEvent(new CustomEvent(`changeOptions`,{detail:t,bubbles:!0,composed:!0}))}renderLabel(t){return e`
      ...
      ${t.required?e`
          ...
          `:``}
    `}render(){return Se(this)}};s([o({attribute:!1}),c(`design:type`,Array),c(`design:paramtypes`,[])],x.prototype,`options`,null),x=s([l(`dcx-web-checkbox`)],x);var Ce=t`
  :host {
    display: block;
  }
...
`,we=t=>{let n=t.getComputedAriaLabel(),r=t.isHidden();return t.label?e`
      <div
    ...
    <span
      ...
      aria-hidden="${r?`true`:`false`}"
    ></span>
  `},S=class extends r{#e=`horizontal`;get orientation(){return this.#e}set orientation(e){this.#e=e}#t=`default`;get type(){return this.#t}set type(e){this.#t=e}#n=`auto`;get size(){return this.#n}set size(e){this.#n=e}#r=.25;get thickness(){return this.#r}set thickness(e){this.#r=e}#i=`#d1d5db`;get color(){return this.#i}set color(e){this.#i=e}#a=``;get label(){return this.#a}set label(e){this.#a=e}#o=null;get ariaLabel(){return this.#o}set ariaLabel(e){this.#o=e}static styles=Ce;_getDividerStyle(){switch(this.type){case`dot`:return`dotted`;case`dash`:return`dashed`;default:return`solid`}}_getDividerSize(){switch(this.size){case`s`:return`5rem`;case`m`:return`15rem`;case`l`:return`30rem`;case`xl`:return`35rem`;default:return`100%`}}getComputedAriaLabel(){return this.ariaLabel&&this.ariaLabel.trim().length>0?this.ariaLabel:this.label&&this.label.trim().length>0?this.label:``}isHidden(){return!this.label&&!this.ariaLabel}updated(){this.classList.toggle(`horizontal`,this.orientation===`horizontal`),this.classList.toggle(`vertical`,this.orientation===`vertical`),this.classList.toggle(`has-label`,!!this.label),this.style.setProperty(`--_dcx-divider-size`,this._getDividerSize()),this.style.setProperty(`--_dcx-divider-style`,this._getDividerStyle()),this.style.setProperty(`--_dcx-divider-thickness`,`${this.thickness}rem`),this.style.setProperty(`--_dcx-divider-color`,this.color)}render(){return we(this)}};s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],S.prototype,`orientation`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],S.prototype,`type`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],S.prototype,`size`,null),s([o({type:Number}),c(`design:type`,Object),c(`design:paramtypes`,[])],S.prototype,`thickness`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],S.prototype,`color`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],S.prototype,`label`,null),s([o({type:String,attribute:`aria-label`}),c(`design:type`,Object),c(`design:paramtypes`,[])],S.prototype,`ariaLabel`,null),S=s([l(`dcx-web-divider`)],S);var Te=t`
  :host {
    display: block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,Ee=t=>{let n=t.items.length,r=n>t.maxVisibleItems,i=[],a=[];r?(i=t.items.slice(0,n-t.maxVisibleItems),a=t.items.slice(-t.maxVisibleItems)):a=t.items;let o=a[a.length-1]||null;return e`
...
`,Oe=t=>{if(!t.isOpen)return e``;let n=`dcx-context-menu ${t.positionMode===`absolute`?`dcx-context-menu--absolute`:``}`,r=`top: ${t.top}; left: ${t.left}; opacity: ${t.isPositioned?`1`:`0`};`;return e`
    <div
      class="${n}"
      style="${r}"
  ...
  `},w=class extends r{#e=[];get items(){return this.#e}set items(e){this.#e=e}#t={x:0,y:0};get position(){return this.#t}set position(e){this.#t=e}#n=`fixed`;get positionMode(){return this.#n}set positionMode(e){this.#n=e}#r=!1;get isOpen(){return this.#r}set isOpen(e){this.#r=e}#i=!1;get isPositioned(){return this.#i}set isPositioned(e){this.#i=e}#a=`-9999px`;get top(){return this.#a}set top(e){this.#a=e}#o=`-9999px`;get left(){return this.#o}set left(e){this.#o=e}_openPosition=null;static styles=De;connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this._handleDocumentKeyDown),document.addEventListener(`click`,this._handleDocumentClick),window.addEventListener(`resize`,this._handleWindowResize)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`keydown`,this._handleDocumentKeyDown),document.removeEventListener(`click`,this._handleDocumentClick),window.removeEventListener(`resize`,this._handleWindowResize)}_handleDocumentKeyDown=e=>{e.key===`Escape`&&this.isOpen&&this.close()};_handleDocumentClick=e=>{if(!this.isOpen)return;let t=e.composedPath(),n=this.shadowRoot?.querySelector(`.dcx-context-menu`);n&&t.includes(n)||this.close()};_handleWindowResize=()=>{this.isOpen&&this.calculatePosition()};async open(e){e&&(this._openPosition=e),this.isOpen=!0,await this.updateComplete,this.calculatePosition()}close(){this._openPosition=null,this.isOpen=!1,this.isPositioned=!1,this.dispatchEvent(new CustomEvent(`menu-closed`))}calculatePosition(){let e=this._openPosition??this.position;if(this.positionMode===`absolute`){this.left=`${e.x}px`,this.top=`${e.y}px`,this.isPositioned=!0;return}let t=e.x,n=e.y,r=this.shadowRoot?.querySelector(`.dcx-context-menu`);if(r){let e=r.getBoundingClientRect();if(t+e.width>window.innerWidth-10&&(t=window.innerWidth-10-e.width,t<0&&(t=0)),n+e.height>window.innerHeight-10){let t=n-e.height;n=t>=0?t:10}}let i=0,a=0;if(this.shadowRoot){let e=document.createElement(`div`);e.style.position=`fixed`,e.style.left=`0px`,e.style.top=`0px`,e.style.width=`0px`,e.style.height=`0px`,e.style.visibility=`hidden`,this.shadowRoot.appendChild(e);let t=e.getBoundingClientRect();i=t.left,a=t.top,this.shadowRoot.removeChild(e)}this.left=`${t-i}px`,this.top=`${n-a}px`,this.isPositioned=!0}onItemClick(e,t){t?.stopPropagation(),!(e.disabled||e.divider)&&(e.action&&e.action(),this.dispatchEvent(new CustomEvent(`item-selected`,{detail:e,bubbles:!0,composed:!0})),(!e.children||e.children.length===0)&&this.close())}onItemKeydown(e,t,n){let r=e.children||[];n.key===`ArrowRight`&&r.length>0?(n.preventDefault(),n.currentTarget.querySelector(`.dcx-context-menu__nested [tabindex="0"]`)?.focus()):n.key===`ArrowLeft`?(n.preventDefault(),(n.currentTarget.closest(`.dcx-context-menu__nested`)?.closest(`li`))?.focus()):(n.key===`Enter`||n.key===` `)&&(n.preventDefault(),this.onItemClick(e,n))}renderItem(t,n){if(t.divider)return e`<li class="dcx-context-menu__divider" role="separator"></li>`;let r=t.children&&t.children.length>0,i=[`dcx-context-menu__item`,`dcx-context-menu__item--selectable`,t.disabled?`dcx-context-menu__item--disabled`:``,r?`dcx-context-menu__item--has-children`:``,t.variant===`danger`?`dcx-context-menu__item--danger`:``].filter(Boolean).join(` `);return e`
    ...
    `}render(){return Oe(this)}};s([o({type:Array}),c(`design:type`,Array),c(`design:paramtypes`,[])],w.prototype,`items`,null),s([o({type:Object}),c(`design:type`,Object),c(`design:paramtypes`,[])],w.prototype,`position`,null),s([o({type:String}),c(`design:type`,String),c(`design:paramtypes`,[])],w.prototype,`positionMode`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],w.prototype,`isOpen`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],w.prototype,`isPositioned`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],w.prototype,`top`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],w.prototype,`left`,null),w=s([l(`dcx-web-context-menu`)],w);var T=t`
  :host {
    display: contents;
  }

import{a as e,l as t,n,t as r}from"./lit-C11zoK0j.js";import{c as i,i as a,l as o,n as s,r as c,t as ee,u as l}from"./dcx-web-button.component-D3Abov5f.js";import{_ as te,a as u,g as ne,n as re,r as d,t as ie}from"./defaults-BS9BWamO.js";var ae=[`vertical`,`horizontal`],oe=[`start`,`center`,`end`],se=[`s`,`m`,`l`,`xl`,`auto`],f=[`top`,`bottom`,`left`,`right`],ce=`vertical`,le=`center`,ue=[`xs`,`s`,`m`,`l`,`xl`],p=`info-circle`,m={showLabel:!0,textLabel:`Value`,value:0,step:1,vertical:!1,min:0,max:50,disabled:!1,valueSuffix:``},de=`Select`,fe=[{value:`one`,label:`Uno`},{value:`two`,label:`Dos`},{value:`three`,label:`Tres`}],h=`Seleccione una opción`,g=`160px`,_=[`bold`,`italic`,`underline`,`orderedList`,`unorderedList`,`removeFormat`],pe=t`
  :host {
    display: inline-flex;
  }
...
`,me=t=>{let n=`dcx-badge dcx-badge--${t.severity} dcx-badge--${t.size}`;return e`
    <span
      class="${n}"
      role="${t.roleAttr||``}"
    ...
    >${t.value}</span>
  `},v=class extends r{#e=``;get value(){return this.#e}set value(e){this.#e=e}#t=`primary`;get severity(){return this.#t}set severity(e){this.#t=e}#n=`md`;get size(){return this.#n}set size(e){this.#n=e}#r=null;get ariaLabel(){return this.#r}set ariaLabel(e){this.#r=e}#i=!1;get ariaHiddenAttr(){return this.#i}set ariaHiddenAttr(e){this.#i=e}#a=null;get roleAttr(){return this.#a}set roleAttr(e){this.#a=e}static styles=pe;getComputedAriaLabel(){if(this.ariaHiddenAttr)return null;if(this.ariaLabel!==null)return this.ariaLabel;let e=this.value;return e?`${e}, ${this.severity}`:this.severity}render(){return me(this)}};s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],v.prototype,`value`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],v.prototype,`severity`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],v.prototype,`size`,null),s([o({type:String,attribute:`aria-label`}),c(`design:type`,Object),c(`design:paramtypes`,[])],v.prototype,`ariaLabel`,null),s([o({type:Boolean,attribute:`aria-hidden`}),c(`design:type`,Object),c(`design:paramtypes`,[])],v.prototype,`ariaHiddenAttr`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],v.prototype,`roleAttr`,null),v=s([l(`dcx-web-badge`)],v);var he=t`
  :host {
    display: block;
  }
...
`,ge=t=>t.visible?e`
  ...
  `:e``,y=class extends r{#e=`center`;get position(){return this.#e}set position(e){this.#e=e}#t=``;get title(){return this.#t}set title(e){this.#t=e}#n=``;get dialogId(){return this.#n}set dialogId(e){this.#n=e}#r=!0;get showClose(){return this.#r}set showClose(e){this.#r=e}#i=!0;get closeOnBackdrop(){return this.#i}set closeOnBackdrop(e){this.#i=e}#a=!1;get visible(){return this.#a}set visible(e){this.#a=e}static styles=he;get dialogTitleId(){return`dialog-title-${this.dialogId||`default`}`}get dialogClasses(){return`dcx-dialog dcx-dialog--pos-${this.position}`}close(){this.dispatchEvent(new CustomEvent(`closeDialog`,{bubbles:!0,composed:!0}))}onBackdropClick(e){e.stopPropagation(),this.closeOnBackdrop&&this.close()}onKeyDown=e=>{e.key===`Escape`&&this.visible&&this.close()};connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this.onKeyDown)}disconnectedCallback(){document.removeEventListener(`keydown`,this.onKeyDown),super.disconnectedCallback()}render(){return ge(this)}};s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],y.prototype,`position`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],y.prototype,`title`,null),s([o({type:String,attribute:`dialog-id`}),c(`design:type`,Object),c(`design:paramtypes`,[])],y.prototype,`dialogId`,null),s([o({type:Boolean,attribute:`show-close`}),c(`design:type`,Object),c(`design:paramtypes`,[])],y.prototype,`showClose`,null),s([o({type:Boolean,attribute:`close-on-backdrop`}),c(`design:type`,Object),c(`design:paramtypes`,[])],y.prototype,`closeOnBackdrop`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],y.prototype,`visible`,null),y=s([l(`dcx-web-dialog`)],y);var _e=t`
  :host {
    display: block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,be=t=>e`
  ...
  `,x=class extends r{static styles=ye;#e=[];get options(){return this.#e}set options(e){this.#e=e}errorIcon=`exclamation-circle-fill`;_getValue(e){return e===!0?!1:e!==!1||null}_normalizeValue(e){return e===!0||e!==!1&&null}getVariant(e){return this._normalizeValue(e.value)===null?`secondary`:`primary`}getIconName(e){let t=this._normalizeValue(e.value);return t===!0?`check`:t===!1?`dash`:``}getAriaChecked(e){let t=this._normalizeValue(e.value);return t===!0?`true`:t===!1?`mixed`:`false`}changeValue(e){let t=this.options.map(t=>t.id===e?{...t,value:this._getValue(t.value)}:t);this.dispatchEvent(new CustomEvent(`changeOptions`,{detail:t,bubbles:!0,composed:!0}))}renderLabel(t){return e`
      ...
      ${t.required?e`
          ...
          `:``}
    `}render(){return be(this)}};s([o({attribute:!1}),c(`design:type`,Array),c(`design:paramtypes`,[])],x.prototype,`options`,null),x=s([l(`dcx-web-checkbox`)],x);var xe=t`
  :host {
    display: block;
  }
...
`,Se=t=>{let n=t.getComputedAriaLabel(),r=t.isHidden();return t.label?e`
      <div
...
`,we=t=>{let n=t.items.length,r=n>t.maxVisibleItems,i=[],a=[];r?(i=t.items.slice(0,n-t.maxVisibleItems),a=t.items.slice(-t.maxVisibleItems)):a=t.items;let o=a[a.length-1]||null;return e`
...
`,w=t=>{if(!t.isOpen)return e``;let n=`dcx-context-menu ${t.positionMode===`absolute`?`dcx-context-menu--absolute`:``}`,r=`top: ${t.top}; left: ${t.left}; opacity: ${t.isPositioned?`1`:`0`};`;return e`
    <div
      class="${n}"
      style="${r}"
...
`,D=t=>{if(!t.rendered)return n;let r=[`dcx-drawer`,`dcx-drawer--${t.position}`,t.fullScreen?`dcx-drawer--fullscreen`:``].filter(Boolean),i=[`dcx-drawer-root`,t.closing?`dcx-drawer-root--closing`:``],a=t.modal;return e`
  ...
  `},O=[`s`,`m`,`l`,`xl`,`auto`],k=[`top`,`bottom`,`left`,`right`],Ee=[`vertical`,`horizontal`],De=[`xs`,`s`,`m`,`l`,`xl`],A=`right`,Oe=k,j=`22rem`,M=1e3,N=`Drawer`,ke={open:!1,position:A,modal:!0,dismissible:!0,showCloseIcon:!0,closeOnEscape:!0,blockScroll:!1,fullScreen:!1,size:j,baseZIndex:M,autoZIndex:!0,header:N,footer:``},P,F=class extends r{static{P=this}#e=!1;get open(){return this.#e}set open(e){this.#e=e}#t=A;get position(){return this.#t}set position(e){this.#t=e}#n=!0;get modal(){return this.#n}set modal(e){this.#n=e}#r=!0;get dismissible(){return this.#r}set dismissible(e){this.#r=e}#i=!0;get showCloseIcon(){return this.#i}set showCloseIcon(e){this.#i=e}#a=!0;get closeOnEscape(){return this.#a}set closeOnEscape(e){this.#a=e}#o=!1;get blockScroll(){return this.#o}set blockScroll(e){this.#o=e}#s=!1;get fullScreen(){return this.#s}set fullScreen(e){this.#s=e}#c=j;get size(){return this.#c}set size(e){this.#c=e}#l=M;get baseZIndex(){return this.#l}set baseZIndex(e){this.#l=e}#u=!0;get autoZIndex(){return this.#u}set autoZIndex(e){this.#u=e}#d=N;get header(){return this.#d}set header(e){this.#d=e}#f=``;get footer(){return this.#f}set footer(e){this.#f=e}static styles=E;static _instanceCount=0;static _globalZIndex=0;#p=M;get _currentZIndex(){return this.#p}set _currentZIndex(e){this.#p=e}#m=!1;get rendered(){return this.#m}set rendered(e){this.#m=e}#h=!1;get closing(){return this.#h}set closing(e){this.#h=e}_closeTimer;_scrollBlocked=!1;_previousOverflow=``;_hideAlreadyEmitted=!1;_drawerId=`dcx-drawer-${++P._instanceCount}`;_keydownHandler=e=>{!this.open||!this.closeOnEscape||e.key!==`Escape`||this.closeDrawer()};get drawerTitleId(){return`${this._drawerId}-title`}get hasHeader(){return!!(this.header||this.showCloseIcon||this.querySelector(`[slot="drawerHeader"]`))}get hasFooter(){return!!(this.footer||this.querySelector(`[slot="drawerFooter"]`))}get resolvedZIndex(){return this._currentZIndex}get panelWidth(){return this.fullScreen?`100%`:this.position===`left`||this.position===`right`?this.size:null}get panelHeight(){return this.fullScreen?`100%`:this.position===`top`||this.position===`bottom`?this.size:null}connectedCallback(){super.connectedCallback(),this._syncKeydownListener(),this._syncBodyScroll()}disconnectedCallback(){document.removeEventListener(`keydown`,this._keydownHandler),this._scrollBlocked&&=(document.body.style.overflow=this._previousOverflow,document.body.style.paddingRight=``,!1),window.clearTimeout(this._closeTimer),super.disconnectedCallback()}willUpdate(e){e.has(`open`)&&(this.open?(this.closing=!1,this.rendered=!0):this.closing=!0),(e.has(`open`)||e.has(`baseZIndex`)||e.has(`autoZIndex`))&&(this.open&&this.autoZIndex?(P._globalZIndex=Math.max(P._globalZIndex,this.baseZIndex),P._globalZIndex+=2,this._currentZIndex=P._globalZIndex):this._currentZIndex=this.baseZIndex)}updated(e){e.has(`open`)&&(this.open?this.dispatchEvent(new CustomEvent(`dcx-drawer-show`,{bubbles:!0,composed:!0})):(this._hideAlreadyEmitted?this._hideAlreadyEmitted=!1:this.dispatchEvent(new CustomEvent(`dcx-drawer-hide`,{bubbles:!0,composed:!0})),window.clearTimeout(this._closeTimer),this._closeTimer=window.setTimeout(()=>{this.rendered=!1,this.closing=!1,this.requestUpdate()},220))),(e.has(`open`)||e.has(`blockScroll`)||e.has(`modal`))&&this._syncBodyScroll(),(e.has(`open`)||e.has(`closeOnEscape`))&&this._syncKeydownListener()}render(){return D(this)}close(){this.closeDrawer()}handleMaskPointerDown=e=>{e.stopPropagation(),this.dismissible&&this.closeDrawer()};closeDrawer=()=>{this.open&&(this._hideAlreadyEmitted=!0,this.dispatchEvent(new CustomEvent(`dcx-drawer-hide`,{bubbles:!0,composed:!0})),this.open=!1,this.dispatchEvent(new CustomEvent(`dcx-drawer-visible-change`,{detail:!1,bubbles:!0,composed:!0})))};_syncBodyScroll(){let e=this.open&&this.modal&&this.blockScroll;if(e&&!this._scrollBlocked){let e=window.innerWidth-document.documentElement.clientWidth;this._previousOverflow=document.body.style.overflow,document.body.style.overflow=`hidden`,e>0&&(document.body.style.paddingRight=`${e}px`),this._scrollBlocked=!0}else!e&&this._scrollBlocked&&(document.body.style.overflow=this._previousOverflow,document.body.style.paddingRight=``,this._scrollBlocked=!1)}_syncKeydownListener(){this.open&&this.closeOnEscape?document.addEventListener(`keydown`,this._keydownHandler):document.removeEventListener(`keydown`,this._keydownHandler)}};s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],F.prototype,`open`,null),s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],F.prototype,`position`,null),s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],F.prototype,`modal`,null),s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],F.prototype,`dismissible`,null),s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],F.prototype,`showCloseIcon`,null),s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],F.prototype,`closeOnEscape`,null),s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],F.prototype,`blockScroll`,null),s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],F.prototype,`fullScreen`,null),s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],F.prototype,`size`,null),s([o({type:Number,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],F.prototype,`baseZIndex`,null),s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],F.prototype,`autoZIndex`,null),s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],F.prototype,`header`,null),s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],F.prototype,`footer`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],F.prototype,`_currentZIndex`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],F.prototype,`rendered`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],F.prototype,`closing`,null),F=P=s([l(`dcx-web-drawer`)],F);var Ae=t`
    :host {
      display: inline-flex;
    }
...
`,je=t=>{let r=`dcx-chip dcx-chip--${t.color}`,i=t.label?`Remover ${t.label}`:`Remover chip`;return e`
    <span
      class=${r}
  ...
  `},I=class extends r{#e=``;get label(){return this.#e}set label(e){this.#e=e}#t=`primary`;get color(){return this.#t}set color(e){this.#t=e}#n=!1;get removable(){return this.#n}set removable(e){this.#n=e}#r=``;get icon(){return this.#r}set icon(e){this.#r=e}#i=``;get image(){return this.#i}set image(e){this.#i=e}#a=`choice`;get variant(){return this.#a}set variant(e){this.#a=e}static styles=Ae;get chipType(){return this.image.trim()?`with-image`:this.icon.trim()?`with-icon`:`label-only`}get showRemove(){return this.variant===`filter`||this.removable}renderIcon(){let t=[`house`,`person`,`gear`,`star`,`code-slash`,`terminal`,`palette`,`book`,`bug`].includes(this.icon)?this.icon:`question-circle`;return e`<dcx-web-icon name=${t}></dcx-web-icon>`}handleRemove(e){e.stopPropagation(),this.showRemove&&this.dispatchEvent(new CustomEvent(`dcx-chip-remove`,{bubbles:!0,composed:!0}))}render(){return je(this)}};s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],I.prototype,`label`,null),s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],I.prototype,`color`,null),s([o({type:Boolean,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],I.prototype,`removable`,null),s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],I.prototype,`icon`,null),s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],I.prototype,`image`,null),s([o({type:String,reflect:!0}),c(`design:type`,Object),c(`design:paramtypes`,[])],I.prototype,`variant`,null),I=s([l(`dcx-web-chip`)],I);var Me=t`
  :host {
    display: block;
    width: 100%;
    box-sizing: border-box;
...
`,Fe=t=>{let r={"dcx-datepicker__input-wrapper":!0,"dcx-datepicker__input-wrapper--disabled":t.disabled,"dcx-datepicker__input-wrapper--open":t.isOpen};return e`
...
`,G=class extends r{#e=``;get body(){return this.#e}set body(e){this.#e=e}#t=`notification`;get type(){return this.#t}set type(e){this.#t=e}#n=``;get title(){return this.#n}set title(e){this.#n=e}#r=``;get link(){return this.#r}set link(e){this.#r=e}#i=!1;get icon(){return this.#i}set icon(e){this.#i=e}#a=``;get iconName(){return this.#a}set iconName(e){this.#a=e}#o=!1;get showClose(){return this.#o}set showClose(e){this.#o=e}#s=!0;get announce(){return this.#s}set announce(e){this.#s=e}#c=!1;get dismissed(){return this.#c}set dismissed(e){this.#c=e}static styles=Qe;get messageData(){return{notification:{icon:`info-circle`,role:`status`,ariaLive:`polite`},success:{icon:`check-circle`,role:`status`,ariaLive:`polite`},warning:{icon:`exclamation-triangle`,role:`alert`,ariaLive:`assertive`},error:{icon:`x-circle`,role:`alert`,ariaLive:`assertive`}}[this.type]}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}onClose=()=>{this.dismissed=!0,this.emit(`closed`)};render(){return Ze(this)}};s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],G.prototype,`body`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],G.prototype,`type`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],G.prototype,`title`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],G.prototype,`link`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],G.prototype,`icon`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],G.prototype,`iconName`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],G.prototype,`showClose`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],G.prototype,`announce`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],G.prototype,`dismissed`,null),G=s([l(`dcx-web-message`)],G);var $e=t`
  :host {
    display: inline-flex;
  }
...
`,et=t=>e`
  ...
  `,K=class extends r{#e=!1;get checked(){return this.#e}set checked(e){this.#e=e}#t=!1;get disabled(){return this.#t}set disabled(e){this.#t=e}#n=null;get label(){return this.#n}set label(e){this.#n=e}#r=`m`;get size(){return this.#r}set size(e){this.#r=e}#i=null;get ariaLabel(){return this.#i}set ariaLabel(e){this.#i=e}#a=`right`;get textPosition(){return this.#a}set textPosition(e){this.#a=e}static styles=$e;get effectiveAriaLabel(){return this.ariaLabel||this.label||`Toggle`}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}toggle(){if(this.disabled)return;let e=!this.checked;this.checked=e,this.emit(`toggled`,e)}getToggleClasses(){let e=[`dcx-toggle`,this.size?`dcx-toggle--${this.size}`:``,`dcx-toggle--${this.textPosition}`];return this.disabled&&e.push(`dcx-toggle--disabled`),e.filter(Boolean).join(` `)}render(){return et(this)}};s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],K.prototype,`checked`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],K.prototype,`disabled`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],K.prototype,`label`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],K.prototype,`size`,null),s([o({type:String,attribute:`aria-label`}),c(`design:type`,Object),c(`design:paramtypes`,[])],K.prototype,`ariaLabel`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],K.prototype,`textPosition`,null),K=s([l(`dcx-web-toggle`)],K);var tt=t`
  :host {
    display: block;
    width: 100%;
  }
...
`,q=class extends r{#e=`dcx-progressbar-${Math.random().toString(36).substring(2,9)}`;get id(){return this.#e}set id(e){this.#e=e}#t=`default`;get variant(){return this.#t}set variant(e){this.#t=e}#n=0;get value(){return this.#n}set value(e){this.#n=e}#r=``;get label(){return this.#r}set label(e){this.#r=e}#i=``;get ariaLabel(){return this.#i}set ariaLabel(e){this.#i=e}#a=!1;get showTooltip(){return this.#a}set showTooltip(e){this.#a=e}#o=!1;get showLabel(){return this.#o}set showLabel(e){this.#o=e}#s=[];get steps(){return this.#s}set steps(e){this.#s=e}#c=0;get currentStep(){return this.#c}set currentStep(e){this.#c=e}#l=!1;get showCheckmarks(){return this.#l}set showCheckmarks(e){this.#l=e}#u=5;get segments(){return this.#u}set segments(e){this.#u=e}static styles=tt;get labelId(){return`${this.id}-label`}get progressPercentage(){return Math.min(Math.max(this.value,0),100)}get isStepperVariant(){return this.variant===`stepper`}get isSegmentedVariant(){return this.variant===`segmented`}get isDefaultVariant(){return this.variant==="default"}get segmentArray(){return Array(this.segments).fill(0).map((e,t)=>t)}get stepProgress(){let e=this.steps.length;return e===0?0:this.currentStep/e*100}get stepValueText(){return`Paso ${this.currentStep} de ${this.steps.length}`}isStepCompleted(e){return e<this.currentStep-1}isStepActive(e){return e===this.currentStep-1}render(){return nt(this)}};s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`id`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`variant`,null),s([o({type:Number}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`value`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`label`,null),s([o({type:String,attribute:`aria-label`}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`ariaLabel`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`showTooltip`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`showLabel`,null),s([o({attribute:!1}),c(`design:type`,Array),c(`design:paramtypes`,[])],q.prototype,`steps`,null),s([o({type:Number}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`currentStep`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`showCheckmarks`,null),s([o({type:Number}),c(`design:type`,Object),c(`design:paramtypes`,[])],q.prototype,`segments`,null),q=s([l(`dcx-web-progressbar`)],q);var rt=t`
  :host {
    display: inline-block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,ot=t=>e`
    ...
    ${t.visible&&(t.content||t.contentHtml)?e`
        ...
        `:n}
  `,st=[`left`,`center`,`right`],ct=[`default`,`primary`],lt=[`a`,`button`,`input`,`select`,`textarea`],Y=class extends r{#e=`top`;get position(){return this.#e}set position(e){this.#e=e}#t=`center`;get arrowAlignment(){return this.#t}set arrowAlignment(e){this.#t=e}#n=!1;get hideTooltipOnClick(){return this.#n}set hideTooltipOnClick(e){this.#n=e}#r=``;get content(){return this.#r}set content(e){this.#r=e}#i=``;get contentHtml(){return this.#i}set contentHtml(e){this.#i=e}#a=`default`;get variant(){return this.#a}set variant(e){this.#a=e}#o=!1;get visible(){return this.#o}set visible(e){this.#o=e}#s=`top`;get actualPosition(){return this.#s}set actualPosition(e){this.#s=e}tooltipId=`dcx-tooltip-${Math.random().toString(36).substring(2,9)}`;static styles=at;get tooltipClasses(){let e=`dcx-ng-tooltip`;return[e,`${e}--${this.actualPosition}`,`${e}--arrow-${this.arrowAlignment}`,this.variant===`primary`?`${e}--primary`:``].filter(Boolean).join(` `)}get sanitizedHtml(){return this.sanitizeContent(this.contentHtml)}willUpdate(e){super.willUpdate(e),e.has(`position`)&&(this.actualPosition=this.position)}firstUpdated(){this.actualPosition=this.position,this.linkTriggerToTooltip()}linkTriggerToTooltip(){let e=((this.shadowRoot?.querySelector(`slot`))?.assignedElements({flatten:!0})??[])[0];e&&e.setAttribute(`aria-describedby`,this.tooltipId)}sanitizeContent(e){if(!e)return``;let t=new DOMParser().parseFromString(e,`text/html`);return lt.forEach(e=>{t.body.querySelectorAll(e).forEach(e=>{e.replaceWith(...Array.from(e.childNodes))})}),t.body.innerHTML}show(){this.visible||!this.content&&!this.contentHtml||(this.visible=!0)}hide(){this.visible&&=!1}onMouseEnter(){this.show()}onMouseLeave(){this.hide()}onFocusIn(){this.show()}onFocusOut(){this.hide()}onEscape(){this.hide()}onClick(){this.hideTooltipOnClick&&this.hide()}connectedCallback(){super.connectedCallback(),this.addEventListener(`mouseenter`,this.onMouseEnter),this.addEventListener(`mouseleave`,this.onMouseLeave),this.addEventListener(`focusin`,this.onFocusIn),this.addEventListener(`focusout`,this.onFocusOut),this.addEventListener(`click`,this.onClick),this.addEventListener(`keydown`,e=>{e.key===`Escape`&&this.onEscape()})}render(){return ot(this)}};s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`position`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`arrowAlignment`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`hideTooltipOnClick`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`content`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`contentHtml`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`variant`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`visible`,null),s([i(),c(`design:type`,Object),c(`design:paramtypes`,[])],Y.prototype,`actualPosition`,null),Y=s([l(`dcx-web-tooltip`)],Y);var ut=t=>e`
  <ul
    id="${t.id||``}"
...
`,X=class extends r{#e=[];get items(){return this.#e}set items(e){this.#e=e}#t=!1;get selectable(){return this.#t}set selectable(e){this.#t=e}#n=!1;get multiSelect(){return this.#n}set multiSelect(e){this.#n=e}#r=!1;get showChildrenIndicator(){return this.#r}set showChildrenIndicator(e){this.#r=e}#i=!0;get renderChildren(){return this.#i}set renderChildren(e){this.#i=e}#a=null;get itemTemplate(){return this.#a}set itemTemplate(e){this.#a=e}#o=``;get id(){return this.#o}set id(e){this.#o=e}#s=`Lista de elementos`;get ariaLabel(){return this.#s}set ariaLabel(e){this.#s=e}#c=`list`;get listRole(){return this.#c}set listRole(e){this.#c=e}#l=`listitem`;get itemRole(){return this.#l}set itemRole(e){this.#l=e}#u=null;get multiselectable(){return this.#u}set multiselectable(e){this.#u=e}#d=!1;get externalSelection(){return this.#d}set externalSelection(e){this.#d=e}#f=null;get isItemSelected(){return this.#f}set isItemSelected(e){this.#f=e}#p=!1;get cdkDropList(){return this.#p}set cdkDropList(e){this.#p=e}#m=[];get cdkDropListData(){return this.#m}set cdkDropListData(e){this.#m=e}#h=null;get cdkDropListConnectedTo(){return this.#h}set cdkDropListConnectedTo(e){this.#h=e}#g=!1;get cdkDropListDisabled(){return this.#g}set cdkDropListDisabled(e){this.#g=e}#_=!1;get dragEnabled(){return this.#_}set dragEnabled(e){this.#_=e}#v=e=>!1;get cdkDragDisabled(){return this.#v}set cdkDragDisabled(e){this.#v=e}#y=[];get selectedIndices(){return this.#y}set selectedIndices(e){this.#y=e}static styles=dt;emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}getChildren(e){return e.children??[]}isSelected(e){return this.selectable?this.selectedIndices.includes(e):!1}resolveAriaSelected(e,t){return this.isItemSelected?this.isItemSelected(e,t):this.selectable&&!this.externalSelection?this.isSelected(t):null}onItemClick(e,t){if(!(!this.selectable||e.disabled||e.divider)){if(this.externalSelection){this.emit(`itemSelected`,{item:e,index:t});return}if(this.multiSelect){this.isSelected(t)?(this.selectedIndices=this.selectedIndices.filter(e=>e!==t),this.emit(`itemDeselected`,{item:e,index:t})):(this.selectedIndices=[...this.selectedIndices,t],this.emit(`itemSelected`,{item:e,index:t}));return}if(this.isSelected(t)){this.selectedIndices=[],this.emit(`itemDeselected`,{item:e,index:t});return}this.selectedIndices=[t],this.emit(`itemSelected`,{item:e,index:t})}}onKeydown(e,t,n){let r=this.getChildren(t);(e.key===`Enter`||e.key===` `)&&!t.disabled&&(e.preventDefault(),this.onItemClick(t,n)),e.key===`ArrowRight`&&r.length&&(e.preventDefault(),e.currentTarget.querySelector(`.dcx-list-nested [tabindex="0"]`)?.focus()),e.key===`ArrowLeft`&&(e.preventDefault(),(e.currentTarget.closest(`.dcx-list-nested`)?.closest(`li`))?.focus())}getItemClasses(e,t){let n=[`dcx-list-item`];return this.selectable&&n.push(`selectable`),this.isSelected(t)&&n.push(`selected`),e.disabled&&n.push(`disabled`),e.children&&e.children.length&&n.push(`has-children`),e.variant===`danger`&&n.push(`danger`),n.join(` `)}render(){return ut(this)}};s([o({attribute:!1}),c(`design:type`,Array),c(`design:paramtypes`,[])],X.prototype,`items`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`selectable`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`multiSelect`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`showChildrenIndicator`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`renderChildren`,null),s([o({attribute:!1}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`itemTemplate`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`id`,null),s([o({type:String,attribute:`aria-label`}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`ariaLabel`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`listRole`,null),s([o({type:String}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`itemRole`,null),s([o({attribute:!1}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`multiselectable`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`externalSelection`,null),s([o({attribute:!1}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`isItemSelected`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`cdkDropList`,null),s([o({attribute:!1}),c(`design:type`,Array),c(`design:paramtypes`,[])],X.prototype,`cdkDropListData`,null),s([o({attribute:!1}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`cdkDropListConnectedTo`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`cdkDropListDisabled`,null),s([o({type:Boolean}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`dragEnabled`,null),s([o({attribute:!1}),c(`design:type`,Object),c(`design:paramtypes`,[])],X.prototype,`cdkDragDisabled`,null),s([i(),c(`design:type`,Array),c(`design:paramtypes`,[])],X.prototype,`selectedIndices`,null),X=s([l(`dcx-web-list`)],X);var ft=t`
  :host {
    display: block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }

import{a as e,n as t}from"./lit-C11zoK0j.js";import"./dcx-web-button.component-DgDUViKA.js";import"./dcx-web-accordion.component-CYtpEFJp.js";import{S as n,_ as r,b as i,g as a,h as o,m as s,p as c,v as l,x as u,y as d}from"./defaults-DBXV-fV-.js";var f={title:`DCXLibrary/WebComponents/Accordion`,component:`dcx-web-accordion`,tags:[`autodocs`],parameters:{controls:{expanded:!0}},argTypes:{items:{control:`object`,description:`Lista de items del acordeón.`,table:{category:`Atributos`}},transition:{control:`select`,options:i,description:`Velocidad de la animación al expandir o colapsar.`,table:{category:`Atributos`}},closeOthers:{control:`boolean`,description:`Si es true, abrir un panel cierra el resto.`,table:{category:`Atributos`}},variant:{control:`select`,options:u,description:`Variante visual del acordeón.`,table:{category:`Atributos`}},ariaLabel:{control:`text`,description:`Etiqueta accesible para el elemento raíz.`,table:{category:`Atributos`}}},args:{items:c,transition:`smooth`,closeOthers:!0,variant:`default`},render:t=>e`
    <dcx-web-accordion
      .items=${t.items}
    ...
    ></dcx-web-accordion>
  `},p={args:{items:c}},m={args:{items:l}},h={args:{items:o}},g={args:{items:s}},_={args:{items:r,closeOthers:!1}},v={args:{items:c,transition:`fast`}},y={args:{items:c,transition:`slow`}},b={args:{items:c,transition:`none`}},x={args:{items:d}},S={args:{items:a}},C={render:()=>{let t=[...n];return e`
    ...
    <dcx-web-accordion
      ...
      .closeOthers=${!1}
    ></dcx-web-accordion>
  `,args:{items:c}},E={args:{items:l,variant:`flush`}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {

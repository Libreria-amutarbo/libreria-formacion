...
`,he=t=>e`
  ...
  `,S=class extends r{static styles=me;#e=[];get options(){return this.#e}set options(e){this.#e=e}errorIcon=`exclamation-circle-fill`;_getValue(e){return e===!0?!1:e!==!1||null}_normalizeValue(e){return e===!0||e!==!1&&null}getVariant(e){return this._normalizeValue(e.value)===null?`secondary`:`primary`}getIconName(e){let t=this._normalizeValue(e.value);return t===!0?`check`:t===!1?`dash`:``}getAriaChecked(e){let t=this._normalizeValue(e.value);return t===!0?`true`:t===!1?`mixed`:`false`}changeValue(e){let t=this.options.map(t=>t.id===e?{...t,value:this._getValue(t.value)}:t);this.dispatchEvent(new CustomEvent(`changeOptions`,{detail:t,bubbles:!0,composed:!0}))}renderLabel(t){return e`
      ...
      ${t.required?e`
          ...
          `:``}
    `}render(){return he(this)}};o([a({attribute:!1}),d(`design:type`,Array),d(`design:paramtypes`,[])],S.prototype,`options`,null),S=o([i(`dcx-web-checkbox`)],S);var ge=t`
  :host {
    display: block;
  }
...
`,C=t=>{let n=t.getComputedAriaLabel(),r=t.isHidden();return t.label?e`
      <div
...
`,k=t=>t.isOpen?e`
  ...
  `:e``,A=class extends r{#e=[];get items(){return this.#e}set items(e){this.#e=e}#t={x:0,y:0};get position(){return this.#t}set position(e){this.#t=e}#n=`fixed`;get positionMode(){return this.#n}set positionMode(e){this.#n=e}#r=!1;get isOpen(){return this.#r}set isOpen(e){this.#r=e}#i=!1;get isPositioned(){return this.#i}set isPositioned(e){this.#i=e}#a=`-9999px`;get top(){return this.#a}set top(e){this.#a=e}#o=`-9999px`;get left(){return this.#o}set left(e){this.#o=e}_openPosition=null;static styles=O;connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this._handleDocumentKeyDown),document.addEventListener(`click`,this._handleDocumentClick),window.addEventListener(`resize`,this._handleWindowResize)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`keydown`,this._handleDocumentKeyDown),document.removeEventListener(`click`,this._handleDocumentClick),window.removeEventListener(`resize`,this._handleWindowResize)}_handleDocumentKeyDown=e=>{e.key===`Escape`&&this.isOpen&&this.close()};_handleDocumentClick=e=>{if(!this.isOpen)return;let t=e.composedPath(),n=this.shadowRoot?.querySelector(`.dcx-context-menu`);n&&t.includes(n)||this.close()};_handleWindowResize=()=>{this.isOpen&&this.calculatePosition()};async open(e){e&&(this._openPosition=e),this.isOpen=!0,await this.updateComplete,this.calculatePosition()}close(){this._openPosition=null,this.isOpen=!1,this.isPositioned=!1,this.dispatchEvent(new CustomEvent(`menu-closed`))}calculatePosition(){let e=this._openPosition??this.position;if(this.positionMode===`absolute`){this.left=`${e.x}px`,this.top=`${e.y}px`,this.isPositioned=!0;return}let t=e.x,n=e.y,r=this.shadowRoot?.querySelector(`.dcx-context-menu`);if(r){let e=r.getBoundingClientRect();if(t+e.width>window.innerWidth-10&&(t=window.innerWidth-10-e.width,t<0&&(t=0)),n+e.height>window.innerHeight-10){let t=n-e.height;n=t>=0?t:10}}let i=0,a=0;if(this.shadowRoot){let e=document.createElement(`div`);e.style.position=`fixed`,e.style.left=`0px`,e.style.top=`0px`,e.style.width=`0px`,e.style.height=`0px`,e.style.visibility=`hidden`,this.shadowRoot.appendChild(e);let t=e.getBoundingClientRect();i=t.left,a=t.top,this.shadowRoot.removeChild(e)}this.left=`${t-i}px`,this.top=`${n-a}px`,this.isPositioned=!0}onItemClick(e,t){t?.stopPropagation(),!(e.disabled||e.divider)&&(e.action&&e.action(),this.dispatchEvent(new CustomEvent(`item-selected`,{detail:e,bubbles:!0,composed:!0})),(!e.children||e.children.length===0)&&this.close())}onItemKeydown(e,t,n){let r=e.children||[];n.key===`ArrowRight`&&r.length>0?(n.preventDefault(),n.currentTarget.querySelector(`.dcx-context-menu__nested [tabindex="0"]`)?.focus()):n.key===`ArrowLeft`?(n.preventDefault(),(n.currentTarget.closest(`.dcx-context-menu__nested`)?.closest(`li`))?.focus()):(n.key===`Enter`||n.key===` `)&&(n.preventDefault(),this.onItemClick(e,n))}renderItem(t,n){if(t.divider)return e`<li class="dcx-context-menu__divider" role="separator"></li>`;let r=t.children&&t.children.length>0;return e`
    ...
    `}render(){return k(this)}};o([a({type:Array}),d(`design:type`,Array),d(`design:paramtypes`,[])],A.prototype,`items`,null),o([a({type:Object}),d(`design:type`,Object),d(`design:paramtypes`,[])],A.prototype,`position`,null),o([a({type:String}),d(`design:type`,String),d(`design:paramtypes`,[])],A.prototype,`positionMode`,null),o([f(),d(`design:type`,Object),d(`design:paramtypes`,[])],A.prototype,`isOpen`,null),o([f(),d(`design:type`,Object),d(`design:paramtypes`,[])],A.prototype,`isPositioned`,null),o([f(),d(`design:type`,Object),d(`design:paramtypes`,[])],A.prototype,`top`,null),o([f(),d(`design:type`,Object),d(`design:paramtypes`,[])],A.prototype,`left`,null),A=o([i(`dcx-web-context-menu`)],A);var j=t`
  :host {
    display: contents;
  }
...
`,be=t=>{let r=`dcx-chip dcx-chip--${t.color}`,i=t.label?`Remover ${t.label}`:`Remover chip`;return e`
  ...
  `},U=class extends r{#e=``;get label(){return this.#e}set label(e){this.#e=e}#t=`primary`;get color(){return this.#t}set color(e){this.#t=e}#n=!1;get removable(){return this.#n}set removable(e){this.#n=e}#r=``;get icon(){return this.#r}set icon(e){this.#r=e}#i=``;get image(){return this.#i}set image(e){this.#i=e}#a=`choice`;get variant(){return this.#a}set variant(e){this.#a=e}static styles=ye;get chipType(){return this.image.trim()?`with-image`:this.icon.trim()?`with-icon`:`label-only`}get showRemove(){return this.variant===`filter`||this.removable}renderIcon(){return e`<dcx-web-icon name=${[`house`,`person`,`gear`,`star`,`code-slash`,`terminal`,`palette`,`book`,`bug`].includes(this.icon)?this.icon:`question-circle`}></dcx-web-icon>`}handleRemove(e){e.stopPropagation(),this.showRemove&&this.dispatchEvent(new CustomEvent(`dcx-chip-remove`,{bubbles:!0,composed:!0}))}render(){return be(this)}};o([a({type:String,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],U.prototype,`label`,null),o([a({type:String,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],U.prototype,`color`,null),o([a({type:Boolean,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],U.prototype,`removable`,null),o([a({type:String,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],U.prototype,`icon`,null),o([a({type:String,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],U.prototype,`image`,null),o([a({type:String,reflect:!0}),d(`design:type`,Object),d(`design:paramtypes`,[])],U.prototype,`variant`,null),U=o([i(`dcx-web-chip`)],U);var xe=t`
  :host {
    display: block;
    width: 100%;
    box-sizing: border-box;
...
`,Z=class extends r{#e=``;get label(){return this.#e}set label(e){this.#e=e}#t=[];get options(){return this.#t}set options(e){this.#t=e}#n=v;get placeholder(){return this.#n}set placeholder(e){this.#n=e}#r=null;get ariaLabel(){return this.#r}set ariaLabel(e){this.#r=e}#i=!1;get searchable(){return this.#i}set searchable(e){this.#i=e}#a=!1;get clearable(){return this.#a}set clearable(e){this.#a=e}#o=!1;get disabled(){return this.#o}set disabled(e){this.#o=e}#s=!1;get required(){return this.#s}set required(e){this.#s=e}#c=!1;get isInvalid(){return this.#c}set isInvalid(e){this.#c=e}#l=``;get errorMessage(){return this.#l}set errorMessage(e){this.#l=e}#u=g;get errorIcon(){return this.#u}set errorIcon(e){this.#u=e}#d=null;get valueInput(){return this.#d}set valueInput(e){this.#d=e}#f=`m`;get spacing(){return this.#f}set spacing(e){this.#f=e}#p=null;get value(){return this.#p}set value(e){this.#p=e}#m=!1;get isOpen(){return this.#m}set isOpen(e){this.#m=e}#h=``;get search(){return this.#h}set search(e){this.#h=e}#g=-1;get activeIndex(){return this.#g}set activeIndex(e){this.#g=e}#_=!1;get receivedFromExternal(){return this.#_}set receivedFromExternal(e){this.#_=e}static styles=Ie;id=`dcx-select-${Math.random().toString(36).substring(2,9)}`;get selectId(){return this.id}get labelId(){return`${this.id}-label`}controlElement=null;connectedCallback(){super.connectedCallback(),document.addEventListener(`click`,this.handleDocumentClick,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`click`,this.handleDocumentClick,!0)}updated(e){e.has(`valueInput`)&&!this.receivedFromExternal&&(this.value=this.valueInput)}get filtered(){let e=this.search.toLowerCase();return this.options.filter(t=>t.label.toLowerCase().includes(e))}get selectedLabel(){let e=this.value;return e===null?this.placeholder:this.options.find(t=>t.value===e)?.label??this.placeholder}get activeDescendant(){return!this.isOpen||this.activeIndex<0?null:`${this.selectId}-opt-${this.activeIndex}`}getControlClasses(){let e=[`dcx-select__control`];return this.isOpen&&e.push(`is-open`),this.disabled&&e.push(`is-disabled`),this.isInvalid&&e.push(`is-invalid`),this.spacing&&e.push(`dcx-select--spacing-${this.spacing}`),e.join(` `)}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}toggle=()=>{this.disabled||(this.isOpen?this.close():this.open())};open(){let e=this.filtered.findIndex(e=>e.value===this.value);this.activeIndex=e>=0?e:0,this.isOpen=!0,queueMicrotask(()=>{this.renderRoot.querySelector(`#${this.selectId}-opt-${this.activeIndex}`)?.scrollIntoView({block:`nearest`})})}close(){this.isOpen=!1,this.activeIndex=-1}selectOption(e){e.disabled||(this.value=e.value,this.emit(`valueChange`,e.value),this.close())}clearValue=e=>{e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation?.(),!this.disabled&&(this.search=``,this.value=null,this.close(),this.emit(`clear`))};onSearchEvent=e=>{this.search=e.detail===null?``:String(e.detail),this.activeIndex=this.filtered.length>0?0:-1};handleDocumentClick=e=>{!e.composedPath().includes(this)&&this.isOpen&&this.close()};moveActive(e){let t=this.filtered.map((e,t)=>e.disabled?-1:t).filter(e=>e>=0);if(!t.length)return;let n=t.indexOf(this.activeIndex),r=0;switch(e){case`next`:r=n<0?0:(n+1)%t.length;break;case`prev`:r=n<0?t.length-1:(n-1+t.length)%t.length;break;case`first`:r=0;break;case`last`:r=t.length-1;break}this.activeIndex=t[r]}confirmActive(){let e=this.filtered[this.activeIndex];e&&!e.disabled&&this.selectOption(e)}onKey=e=>{if(!this.isOpen){(e.key===`ArrowDown`||e.key===`ArrowUp`)&&(e.preventDefault(),this.open());return}switch(e.key){case`ArrowDown`:e.preventDefault(),this.moveActive(`next`);break;case`ArrowUp`:e.preventDefault(),this.moveActive(`prev`);break;case`Home`:e.preventDefault(),this.moveActive(`first`);break;case`End`:e.preventDefault(),this.moveActive(`last`);break;case`Enter`:e.preventDefault(),this.confirmActive();break;case`Escape`:e.preventDefault(),this.close(),this.controlElement?.focus();break}};registerControlElement(e){this.controlElement=e}render(){return Fe(this)}};o([a({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`label`,null),o([a({attribute:!1}),d(`design:type`,Array),d(`design:paramtypes`,[])],Z.prototype,`options`,null),o([a({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`placeholder`,null),o([a({type:String,attribute:`aria-label`}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`ariaLabel`,null),o([a({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`searchable`,null),o([a({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`clearable`,null),o([a({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`disabled`,null),o([a({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`required`,null),o([a({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`isInvalid`,null),o([a({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`errorMessage`,null),o([a({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`errorIcon`,null),o([a({attribute:!1}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`valueInput`,null),o([a({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`spacing`,null),o([f(),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`value`,null),o([f(),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`isOpen`,null),o([f(),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`search`,null),o([f(),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`activeIndex`,null),o([f(),d(`design:type`,Object),d(`design:paramtypes`,[])],Z.prototype,`receivedFromExternal`,null),Z=o([i(`dcx-web-select`)],Z);var Le=t`
  :host {
    display: block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,Be=t=>e`
  ...
  `,$=class extends r{static styles=ze;#e=[];get options(){return this.#e}set options(e){this.#e=e}#t=`dcx-radio-${Math.random().toString(36).substring(2,9)}`;get name(){return this.#t}set name(e){this.#t=e}#n=``;get label(){return this.#n}set label(e){this.#n=e}#r=``;get ariaLabel(){return this.#r}set ariaLabel(e){this.#r=e}#i=`l`;get size(){return this.#i}set size(e){this.#i=e}#a=!1;get disabled(){return this.#a}set disabled(e){this.#a=e}#o=!1;get error(){return this.#o}set error(e){this.#o=e}#s=``;get hint(){return this.#s}set hint(e){this.#s=e}#c=``;get errorMessage(){return this.#c}set errorMessage(e){this.#c=e}#l=null;get value(){return this.#l}set value(e){this.#l=e}groupId=`dcx-radio-group-${Math.random().toString(36).substring(2,9)}`;get hintId(){return`${this.groupId}-hint`}get errorId(){return`${this.groupId}-error`}get isGroupDisabled(){return this.disabled}get showError(){return this.error&&!!this.errorMessage}get showHint(){return!!this.hint&&!this.showError}get describedBy(){return this.showError?this.errorId:this.showHint?this.hintId:null}isChecked(e){return this.value===e}isOptionDisabled(e){return this.isGroupDisabled||!!e.disabled}radioClasses(e){let t=`dcx-radio`;return[t,`${t}--${this.size}`,this.error?`${t}--error`:``,this.isOptionDisabled(e)?`${t}--disabled`:``,this.isChecked(e.value)?`${t}--checked`:``].filter(Boolean).join(` `)}onOptionChange(e){this.isOptionDisabled(e)||(this.value=e.value,this.dispatchEvent(new CustomEvent(`valueChange`,{detail:e.value,bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`change`,{bubbles:!0,composed:!0})))}onBlur(){this.dispatchEvent(new CustomEvent(`blurEvent`,{bubbles:!0,composed:!0}))}render(){return Be(this)}};o([a({type:Array}),d(`design:type`,Array),d(`design:paramtypes`,[])],$.prototype,`options`,null),o([a({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],$.prototype,`name`,null),o([a({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],$.prototype,`label`,null),o([a({type:String,attribute:`aria-label`}),d(`design:type`,Object),d(`design:paramtypes`,[])],$.prototype,`ariaLabel`,null),o([a({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],$.prototype,`size`,null),o([a({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],$.prototype,`disabled`,null),o([a({type:Boolean}),d(`design:type`,Object),d(`design:paramtypes`,[])],$.prototype,`error`,null),o([a({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],$.prototype,`hint`,null),o([a({type:String,attribute:`error-message`}),d(`design:type`,Object),d(`design:paramtypes`,[])],$.prototype,`errorMessage`,null),o([a({type:String}),d(`design:type`,Object),d(`design:paramtypes`,[])],$.prototype,`value`,null),$=o([i(`dcx-web-radio`)],$);export{ae as _,F as a,oe as c,_ as d,m as f,re as g,p as h,_e as i,se as l,g as m,ke as n,N as o,ie as p,ve as r,I as s,Ae as t,v as u,h as v};
...
`,me=t=>{let n=`dcx-badge dcx-badge--${t.severity} dcx-badge--${t.size}`;return e`
    ...
    >${t.value}</span>
  `},v=class extends r{#e=``;get value(){return this.#e}set value(e){this.#e=e}#t=`primary`;get severity(){return this.#t}set severity(e){this.#t=e}#n=`md`;get size(){return this.#n}set size(e){this.#n=e}#r=null;get ariaLabel(){return this.#r}set ariaLabel(e){this.#r=e}#i=!1;get ariaHiddenAttr(){return this.#i}set ariaHiddenAttr(e){this.#i=e}#a=null;get roleAttr(){return this.#a}set roleAttr(e){this.#a=e}static styles=pe;getComputedAriaLabel(){if(this.ariaHiddenAttr)return null;if(this.ariaLabel!==null)return this.ariaLabel;let e=this.value;return e?`${e}, ${this.severity}`:this.severity}render(){return me(this)}};o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],v.prototype,`value`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],v.prototype,`severity`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],v.prototype,`size`,null),o([i({type:String,attribute:`aria-label`}),u(`design:type`,Object),u(`design:paramtypes`,[])],v.prototype,`ariaLabel`,null),o([i({type:Boolean,attribute:`aria-hidden`}),u(`design:type`,Object),u(`design:paramtypes`,[])],v.prototype,`ariaHiddenAttr`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],v.prototype,`roleAttr`,null),v=o([d(`dcx-web-badge`)],v);var he=t`
  :host {
    display: block;
  }
...
`,ge=t=>t.visible?e`
  ...
  `:e``,y=class extends r{#e=`center`;get position(){return this.#e}set position(e){this.#e=e}#t=``;get title(){return this.#t}set title(e){this.#t=e}#n=``;get dialogId(){return this.#n}set dialogId(e){this.#n=e}#r=!0;get showClose(){return this.#r}set showClose(e){this.#r=e}#i=!0;get closeOnBackdrop(){return this.#i}set closeOnBackdrop(e){this.#i=e}#a=!1;get visible(){return this.#a}set visible(e){this.#a=e}static styles=he;get dialogTitleId(){return`dialog-title-${this.dialogId||`default`}`}get dialogClasses(){return`dcx-dialog dcx-dialog--pos-${this.position}`}close(){this.dispatchEvent(new CustomEvent(`closeDialog`,{bubbles:!0,composed:!0}))}onBackdropClick(e){e.stopPropagation(),this.closeOnBackdrop&&this.close()}onKeyDown=e=>{e.key===`Escape`&&this.visible&&this.close()};connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this.onKeyDown)}disconnectedCallback(){document.removeEventListener(`keydown`,this.onKeyDown),super.disconnectedCallback()}render(){return ge(this)}};o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],y.prototype,`position`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],y.prototype,`title`,null),o([i({type:String,attribute:`dialog-id`}),u(`design:type`,Object),u(`design:paramtypes`,[])],y.prototype,`dialogId`,null),o([i({type:Boolean,attribute:`show-close`}),u(`design:type`,Object),u(`design:paramtypes`,[])],y.prototype,`showClose`,null),o([i({type:Boolean,attribute:`close-on-backdrop`}),u(`design:type`,Object),u(`design:paramtypes`,[])],y.prototype,`closeOnBackdrop`,null),o([i({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],y.prototype,`visible`,null),y=o([d(`dcx-web-dialog`)],y);var _e=t`
  :host {
    display: block;
    font-family: var(--ff-base, 'Inter', sans-serif);
  }
...
`,be=t=>e`
  ...
  `,x=class extends r{static styles=ye;#e=[];get options(){return this.#e}set options(e){this.#e=e}errorIcon=`exclamation-circle-fill`;_getValue(e){return e===!0?!1:e!==!1||null}_normalizeValue(e){return e===!0||e!==!1&&null}getVariant(e){return this._normalizeValue(e.value)===null?`secondary`:`primary`}getIconName(e){let t=this._normalizeValue(e.value);return t===!0?`check`:t===!1?`dash`:``}getAriaChecked(e){let t=this._normalizeValue(e.value);return t===!0?`true`:t===!1?`mixed`:`false`}changeValue(e){let t=this.options.map(t=>t.id===e?{...t,value:this._getValue(t.value)}:t);this.dispatchEvent(new CustomEvent(`changeOptions`,{detail:t,bubbles:!0,composed:!0}))}renderLabel(t){return e`
      ...
      ${t.required?e`
          ...
          `:``}
    `}render(){return be(this)}};o([i({attribute:!1}),u(`design:type`,Array),u(`design:paramtypes`,[])],x.prototype,`options`,null),x=o([d(`dcx-web-checkbox`)],x);var xe=t`
  :host {
    display: block;
  }
...
`,w=t=>{if(!t.isOpen)return e``;let n=`dcx-context-menu ${t.positionMode===`absolute`?`dcx-context-menu--absolute`:``}`,r=`top: ${t.top}; left: ${t.left}; opacity: ${t.isPositioned?`1`:`0`};`;return e`
  ...
  `},T=class extends r{#e=[];get items(){return this.#e}set items(e){this.#e=e}#t={x:0,y:0};get position(){return this.#t}set position(e){this.#t=e}#n=`fixed`;get positionMode(){return this.#n}set positionMode(e){this.#n=e}#r=!1;get isOpen(){return this.#r}set isOpen(e){this.#r=e}#i=!1;get isPositioned(){return this.#i}set isPositioned(e){this.#i=e}#a=`-9999px`;get top(){return this.#a}set top(e){this.#a=e}#o=`-9999px`;get left(){return this.#o}set left(e){this.#o=e}_openPosition=null;static styles=Te;connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this._handleDocumentKeyDown),document.addEventListener(`click`,this._handleDocumentClick),window.addEventListener(`resize`,this._handleWindowResize)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`keydown`,this._handleDocumentKeyDown),document.removeEventListener(`click`,this._handleDocumentClick),window.removeEventListener(`resize`,this._handleWindowResize)}_handleDocumentKeyDown=e=>{e.key===`Escape`&&this.isOpen&&this.close()};_handleDocumentClick=e=>{if(!this.isOpen)return;let t=e.composedPath(),n=this.shadowRoot?.querySelector(`.dcx-context-menu`);n&&t.includes(n)||this.close()};_handleWindowResize=()=>{this.isOpen&&this.calculatePosition()};async open(e){e&&(this._openPosition=e),this.isOpen=!0,await this.updateComplete,this.calculatePosition()}close(){this._openPosition=null,this.isOpen=!1,this.isPositioned=!1,this.dispatchEvent(new CustomEvent(`menu-closed`))}calculatePosition(){let e=this._openPosition??this.position;if(this.positionMode===`absolute`){this.left=`${e.x}px`,this.top=`${e.y}px`,this.isPositioned=!0;return}let t=e.x,n=e.y,r=this.shadowRoot?.querySelector(`.dcx-context-menu`);if(r){let e=r.getBoundingClientRect();if(t+e.width>window.innerWidth-10&&(t=window.innerWidth-10-e.width,t<0&&(t=0)),n+e.height>window.innerHeight-10){let t=n-e.height;n=t>=0?t:10}}let i=0,a=0;if(this.shadowRoot){let e=document.createElement(`div`);e.style.position=`fixed`,e.style.left=`0px`,e.style.top=`0px`,e.style.width=`0px`,e.style.height=`0px`,e.style.visibility=`hidden`,this.shadowRoot.appendChild(e);let t=e.getBoundingClientRect();i=t.left,a=t.top,this.shadowRoot.removeChild(e)}this.left=`${t-i}px`,this.top=`${n-a}px`,this.isPositioned=!0}onItemClick(e,t){t?.stopPropagation(),!(e.disabled||e.divider)&&(e.action&&e.action(),this.dispatchEvent(new CustomEvent(`item-selected`,{detail:e,bubbles:!0,composed:!0})),(!e.children||e.children.length===0)&&this.close())}onItemKeydown(e,t,n){let r=e.children||[];n.key===`ArrowRight`&&r.length>0?(n.preventDefault(),n.currentTarget.querySelector(`.dcx-context-menu__nested [tabindex="0"]`)?.focus()):n.key===`ArrowLeft`?(n.preventDefault(),(n.currentTarget.closest(`.dcx-context-menu__nested`)?.closest(`li`))?.focus()):(n.key===`Enter`||n.key===` `)&&(n.preventDefault(),this.onItemClick(e,n))}renderItem(t,n){if(t.divider)return e`<li class="dcx-context-menu__divider" role="separator"></li>`;let r=t.children&&t.children.length>0,i=[`dcx-context-menu__item`,`dcx-context-menu__item--selectable`,t.disabled?`dcx-context-menu__item--disabled`:``,r?`dcx-context-menu__item--has-children`:``,t.variant===`danger`?`dcx-context-menu__item--danger`:``].filter(Boolean).join(` `);return e`
    ...
    `}render(){return w(this)}};o([i({type:Array}),u(`design:type`,Array),u(`design:paramtypes`,[])],T.prototype,`items`,null),o([i({type:Object}),u(`design:type`,Object),u(`design:paramtypes`,[])],T.prototype,`position`,null),o([i({type:String}),u(`design:type`,String),u(`design:paramtypes`,[])],T.prototype,`positionMode`,null),o([a(),u(`design:type`,Object),u(`design:paramtypes`,[])],T.prototype,`isOpen`,null),o([a(),u(`design:type`,Object),u(`design:paramtypes`,[])],T.prototype,`isPositioned`,null),o([a(),u(`design:type`,Object),u(`design:paramtypes`,[])],T.prototype,`top`,null),o([a(),u(`design:type`,Object),u(`design:paramtypes`,[])],T.prototype,`left`,null),T=o([d(`dcx-web-context-menu`)],T);var E=t`
  :host {
    display: contents;
  }
...
`,je=t=>{let r=`dcx-chip dcx-chip--${t.color}`,i=t.label?`Remover ${t.label}`:`Remover chip`;return e`
  ...
  `},I=class extends r{#e=``;get label(){return this.#e}set label(e){this.#e=e}#t=`primary`;get color(){return this.#t}set color(e){this.#t=e}#n=!1;get removable(){return this.#n}set removable(e){this.#n=e}#r=``;get icon(){return this.#r}set icon(e){this.#r=e}#i=``;get image(){return this.#i}set image(e){this.#i=e}#a=`choice`;get variant(){return this.#a}set variant(e){this.#a=e}static styles=Ae;get chipType(){return this.image.trim()?`with-image`:this.icon.trim()?`with-icon`:`label-only`}get showRemove(){return this.variant===`filter`||this.removable}renderIcon(){let t=[`house`,`person`,`gear`,`star`,`code-slash`,`terminal`,`palette`,`book`,`bug`].includes(this.icon)?this.icon:`question-circle`;return e`<dcx-web-icon name=${t}></dcx-web-icon>`}handleRemove(e){e.stopPropagation(),this.showRemove&&this.dispatchEvent(new CustomEvent(`dcx-chip-remove`,{bubbles:!0,composed:!0}))}render(){return je(this)}};o([i({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],I.prototype,`label`,null),o([i({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],I.prototype,`color`,null),o([i({type:Boolean,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],I.prototype,`removable`,null),o([i({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],I.prototype,`icon`,null),o([i({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],I.prototype,`image`,null),o([i({type:String,reflect:!0}),u(`design:type`,Object),u(`design:paramtypes`,[])],I.prototype,`variant`,null),I=o([d(`dcx-web-chip`)],I);var Me=t`
  :host {
    display: block;
    width: 100%;
    box-sizing: border-box;
...
`,Ue=t=>e`
  ...
  `,z=class extends r{#e=`dcx-input-${Math.random().toString(36).substring(2,9)}`;get id(){return this.#e}set id(e){this.#e=e}#t=``;get value(){return this.#t}set value(e){this.#t=e}#n=!1;get disabled(){return this.#n}set disabled(e){this.#n=e}#r=!1;get readonly(){return this.#r}set readonly(e){this.#r=e}#i=``;get placeholder(){return this.#i}set placeholder(e){this.#i=e}#a=te;get type(){return this.#a}set type(e){this.#a=e}#o=``;get name(){return this.#o}set name(e){this.#o=e}#s=!1;get required(){return this.#s}set required(e){this.#s=e}#c=!1;get checked(){return this.#c}set checked(e){this.#c=e}#l=``;get autocomplete(){return this.#l}set autocomplete(e){this.#l=e}#u=``;get inputMode(){return this.#u}set inputMode(e){this.#u=e}#d=!1;get isInvalid(){return this.#d}set isInvalid(e){this.#d=e}#f=``;get label(){return this.#f}set label(e){this.#f=e}#p=``;get hint(){return this.#p}set hint(e){this.#p=e}#m=null;get ariaLabel(){return this.#m}set ariaLabel(e){this.#m=e}#h=null;get ariaDescribedBy(){return this.#h}set ariaDescribedBy(e){this.#h=e}#g=``;get errorMessage(){return this.#g}set errorMessage(e){this.#g=e}#_=ne;get requiredMessage(){return this.#_}set requiredMessage(e){this.#_=e}#v=[];get errorMessages(){return this.#v}set errorMessages(e){this.#v=e}#y=m;get errorIcon(){return this.#y}set errorIcon(e){this.#y=e}#b=`xs`;get spacing(){return this.#b}set spacing(e){this.#b=e}#x=`horizontal`;get orientation(){return this.#x}set orientation(e){this.#x=e}#S=!1;get multiple(){return this.#S}set multiple(e){this.#S=e}#C=l.min;get min(){return this.#C}set min(e){this.#C=e}#w=l.max;get max(){return this.#w}set max(e){this.#w=e}#T=l.step;get step(){return this.#T}set step(e){this.#T=e}#E=!1;get showPassword(){return this.#E}set showPassword(e){this.#E=e}#D=!1;get touched(){return this.#D}set touched(e){this.#D=e}static styles=He;get labelId(){return`${this.id}-label`}get errorId(){return`${this.id}-error`}get hintId(){return`${this.id}-hint`}get isPasswordType(){return this.type===s.PASSWORD}get isSearchType(){return this.type===s.SEARCH}get isFileType(){return this.type===s.FILE}get isRadioType(){return this.type===s.RADIO}get isRangeType(){return this.type===s.RANGE}get displayType(){return this.isPasswordType?this.showPassword?`text`:`password`:this.isRangeType?`range`:this.type}get showActionIcon(){return(this.isPasswordType||this.isSearchType)&&!this.readonly}get getInputIcon(){return{[s.TEXT]:null,[s.NUMBER]:`pin`,[s.EMAIL]:`mail`,[s.PASSWORD]:null,[s.SEARCH]:`search`,[s.TEL]:`phone`,[s.URL]:`link`,[s.FILE]:null,[s.RADIO]:null,[s.RANGE]:null}[this.type]??null}get describedBy(){let e=[this.ariaDescribedBy,this.hint&&!this.isInvalid?this.hintId:null,this.isInvalid?this.errorId:null].filter(Boolean).join(` `).trim();return e.length?e:null}get showRequiredWarning(){return this.required&&[``,null,void 0].includes(this.value)&&this.touched}get getActionButtonAriaLabel(){return this.isPasswordType?this.showPassword?`Ocultar contraseña`:`Mostrar contraseña`:this.isSearchType?`Buscar`:``}get getActionButtonIcon(){return this.isPasswordType?this.showPassword?`eye-slash-fill`:`eye-fill`:this.isSearchType?`search`:``}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}formatValueByType(e){switch(this.type){case`number`:return e.replace(/[^0-9.-]/g,``)===``?``:parseFloat(e.replace(/[^0-9.-]/g,``));case`email`:return e.toLowerCase();case`tel`:return e.replace(/[^0-9\s\-()]/g,``);case`search`:return e.trim();case`url`:return e.toLowerCase();default:return e}}onInputChange(e){if(this.isRadioType||this.isFileType)return;let t=e.target,n=this.formatValueByType(t.value);this.value=n,this.emit(`valueChange`,n)}onChangeEvent(e){this.isFileType||this.isRadioType&&e.target.checked&&this.emit(`valueChange`,this.value)}onFocusEvent(){this.touched=!1,this.emit(`focusEvent`)}onBlurEvent(){this.touched=!0,this.emit(`blurEvent`)}togglePasswordVisibility(){this.showPassword=!this.showPassword}onActionButtonClick(){if(this.isPasswordType){this.togglePasswordVisibility();return}this.isSearchType&&this.emit(`valueChange`,this.value)}getInputClasses(){let e=[`dcx-input__control`,`dcx-input__control--${this.spacing}`];return this.disabled&&e.push(`is-disabled`,`dcx-input__control--disabled`),this.isInvalid&&e.push(`is-invalid`,`dcx-input__control--invalid`),this.getInputIcon&&e.push(`has-icon`,`dcx-input__control--has-icon`),this.showActionIcon&&e.push(`has-action`,`dcx-input__control--has-action`),e.join(` `)}render(){return Ue(this)}};o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`id`,null),o([i({attribute:!1}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`value`,null),o([i({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`disabled`,null),o([i({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`readonly`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`placeholder`,null),o([i({type:String}),u(`design:type`,s===void 0?Object:s),u(`design:paramtypes`,[])],z.prototype,`type`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`name`,null),o([i({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`required`,null),o([i({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`checked`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`autocomplete`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`inputMode`,null),o([i({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`isInvalid`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`label`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`hint`,null),o([i({type:String,attribute:`aria-label`}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`ariaLabel`,null),o([i({type:String,attribute:`aria-describedby`}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`ariaDescribedBy`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`errorMessage`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`requiredMessage`,null),o([i({attribute:!1}),u(`design:type`,Array),u(`design:paramtypes`,[])],z.prototype,`errorMessages`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`errorIcon`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`spacing`,null),o([i({type:String,reflect:!0}),u(`design:type`,String),u(`design:paramtypes`,[])],z.prototype,`orientation`,null),o([i({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`multiple`,null),o([i({type:Number}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`min`,null),o([i({type:Number}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`max`,null),o([i({type:Number}),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`step`,null),o([a(),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`showPassword`,null),o([a(),u(`design:type`,Object),u(`design:paramtypes`,[])],z.prototype,`touched`,null),z=o([d(`dcx-web-input`)],z);var B=t=>e`
    <div
...
`,$e=t=>e`
  ...
  `,q=class extends r{#e=!1;get checked(){return this.#e}set checked(e){this.#e=e}#t=!1;get disabled(){return this.#t}set disabled(e){this.#t=e}#n=null;get label(){return this.#n}set label(e){this.#n=e}#r=`m`;get size(){return this.#r}set size(e){this.#r=e}#i=null;get ariaLabel(){return this.#i}set ariaLabel(e){this.#i=e}#a=`right`;get textPosition(){return this.#a}set textPosition(e){this.#a=e}static styles=Qe;get effectiveAriaLabel(){return this.ariaLabel||this.label||`Toggle`}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}toggle(){if(this.disabled)return;let e=!this.checked;this.checked=e,this.emit(`toggled`,e)}getToggleClasses(){let e=[`dcx-toggle`,this.size?`dcx-toggle--${this.size}`:``,`dcx-toggle--${this.textPosition}`];return this.disabled&&e.push(`dcx-toggle--disabled`),e.filter(Boolean).join(` `)}render(){return $e(this)}};o([i({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],q.prototype,`checked`,null),o([i({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],q.prototype,`disabled`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],q.prototype,`label`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],q.prototype,`size`,null),o([i({type:String,attribute:`aria-label`}),u(`design:type`,Object),u(`design:paramtypes`,[])],q.prototype,`ariaLabel`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],q.prototype,`textPosition`,null),q=o([d(`dcx-web-toggle`)],q);var et=t`
  :host {
    display: block;
    width: 100%;
  }
...
`,at=t=>e`
    ...
    ${t.visible&&(t.content||t.contentHtml)?e`
        ...
        `:n}
  `,ot=[`left`,`center`,`right`],st=[`default`,`primary`],ct=[`a`,`button`,`input`,`select`,`textarea`],X=class extends r{#e=`top`;get position(){return this.#e}set position(e){this.#e=e}#t=`center`;get arrowAlignment(){return this.#t}set arrowAlignment(e){this.#t=e}#n=!1;get hideTooltipOnClick(){return this.#n}set hideTooltipOnClick(e){this.#n=e}#r=``;get content(){return this.#r}set content(e){this.#r=e}#i=``;get contentHtml(){return this.#i}set contentHtml(e){this.#i=e}#a=`default`;get variant(){return this.#a}set variant(e){this.#a=e}#o=!1;get visible(){return this.#o}set visible(e){this.#o=e}#s=`top`;get actualPosition(){return this.#s}set actualPosition(e){this.#s=e}tooltipId=`dcx-tooltip-${Math.random().toString(36).substring(2,9)}`;static styles=it;get tooltipClasses(){let e=`dcx-ng-tooltip`;return[e,`${e}--${this.actualPosition}`,`${e}--arrow-${this.arrowAlignment}`,this.variant===`primary`?`${e}--primary`:``].filter(Boolean).join(` `)}get sanitizedHtml(){return this.sanitizeContent(this.contentHtml)}willUpdate(e){super.willUpdate(e),e.has(`position`)&&(this.actualPosition=this.position)}firstUpdated(){this.actualPosition=this.position,this.linkTriggerToTooltip()}linkTriggerToTooltip(){let e=((this.shadowRoot?.querySelector(`slot`))?.assignedElements({flatten:!0})??[])[0];e&&e.setAttribute(`aria-describedby`,this.tooltipId)}sanitizeContent(e){if(!e)return``;let t=new DOMParser().parseFromString(e,`text/html`);return ct.forEach(e=>{t.body.querySelectorAll(e).forEach(e=>{e.replaceWith(...Array.from(e.childNodes))})}),t.body.innerHTML}show(){this.visible||!this.content&&!this.contentHtml||(this.visible=!0)}hide(){this.visible&&=!1}onMouseEnter(){this.show()}onMouseLeave(){this.hide()}onFocusIn(){this.show()}onFocusOut(){this.hide()}onEscape(){this.hide()}onClick(){this.hideTooltipOnClick&&this.hide()}connectedCallback(){super.connectedCallback(),this.addEventListener(`mouseenter`,this.onMouseEnter),this.addEventListener(`mouseleave`,this.onMouseLeave),this.addEventListener(`focusin`,this.onFocusIn),this.addEventListener(`focusout`,this.onFocusOut),this.addEventListener(`click`,this.onClick),this.addEventListener(`keydown`,e=>{e.key===`Escape`&&this.onEscape()})}render(){return at(this)}};o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`position`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`arrowAlignment`,null),o([i({type:Boolean}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`hideTooltipOnClick`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`content`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`contentHtml`,null),o([i({type:String}),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`variant`,null),o([a(),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`visible`,null),o([a(),u(`design:type`,Object),u(`design:paramtypes`,[])],X.prototype,`actualPosition`,null),X=o([d(`dcx-web-tooltip`)],X);var lt=t=>e`
  <ul
    id="${t.id||``}"
